...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.ConvertURL2PDFRequest();
  });
  ...
  describe('ConvertURL2PDFRequest', function() {
    it('should create an instance of ConvertURL2PDFRequest', function() {
      // uncomment below and update the code to test ConvertURL2PDFRequest
      //var instance = new PDFGeneratorAPI.ConvertURL2PDFRequest();
      //expect(instance).to.be.a(PDFGeneratorAPI.ConvertURL2PDFRequest);
    });
