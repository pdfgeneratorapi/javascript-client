...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.InlineResponse422();
  });
  ...
  describe('InlineResponse422', function() {
    it('should create an instance of InlineResponse422', function() {
      ...
      //var instane = new PDFGeneratorAPI.InlineResponse422();
      //expect(instance).to.be.a(PDFGeneratorAPI.InlineResponse422);
    });

    it('should have the property error (base name: "error")', function() {
      // uncomment below and update the code to test the property error
      //var instance = new PDFGeneratorAPI.InlineResponse422();
