...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.ExtractFormFieldsRequest();
  });
  ...
  describe('ExtractFormFieldsRequest', function() {
    it('should create an instance of ExtractFormFieldsRequest', function() {
      // uncomment below and update the code to test ExtractFormFieldsRequest
      //var instance = new PDFGeneratorAPI.ExtractFormFieldsRequest();
      //expect(instance).to.be.a(PDFGeneratorAPI.ExtractFormFieldsRequest);
    });
    ...
    it('should have the property key_field (base name: "key_field")', function() {
      // uncomment below and update the code to test the property key_field
      //var instance = new PDFGeneratorAPI.ExtractFormFieldsRequest();
      //expect(instance).to.be();
    });
