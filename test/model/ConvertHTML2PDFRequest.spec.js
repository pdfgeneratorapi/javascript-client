...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.ConvertHTML2PDFRequest();
  });
  ...
  describe('ConvertHTML2PDFRequest', function() {
    it('should create an instance of ConvertHTML2PDFRequest', function() {
      // uncomment below and update the code to test ConvertHTML2PDFRequest
      //var instance = new PDFGeneratorAPI.ConvertHTML2PDFRequest();
      //expect(instance).to.be.a(PDFGeneratorAPI.ConvertHTML2PDFRequest);
    });
    ...
    it('should have the property paper_size (base name: "paper_size")', function() {
      // uncomment below and update the code to test the property paper_size
      //var instance = new PDFGeneratorAPI.ConvertHTML2PDFRequest();
      //expect(instance).to.be();
    });
