...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.TemplateDefinitionNewMargins();
  });
  ...
  describe('TemplateDefinitionNewMargins', function() {
    it('should create an instance of TemplateDefinitionNewMargins', function() {
      // uncomment below and update the code to test TemplateDefinitionNewMargins
      //var instane = new PDFGeneratorAPI.TemplateDefinitionNewMargins();
      //expect(instance).to.be.a(PDFGeneratorAPI.TemplateDefinitionNewMargins);
    });

    it('should have the property right (base name: "right")', function() {
      // uncomment below and update the code to test the property right
      //var instance = new PDFGeneratorAPI.TemplateDefinitionNewMargins();
