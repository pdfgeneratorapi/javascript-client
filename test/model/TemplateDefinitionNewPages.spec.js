...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JavascriptWrapperForPdfGeneratorApi.TemplateDefinitionNewPages();
  });
  ...
  describe('TemplateDefinitionNewPages', function() {
    it('should create an instance of TemplateDefinitionNewPages', function() {
      ...
      //var instane = new JavascriptWrapperForPdfGeneratorApi.TemplateDefinitionNewPages();
      //expect(instance).to.be.a(JavascriptWrapperForPdfGeneratorApi.TemplateDefinitionNewPages);
    });
