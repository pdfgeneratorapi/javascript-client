...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.TemplateDefinitionNewPages();
  });
  ...
  describe('TemplateDefinitionNewPages', function() {
    it('should create an instance of TemplateDefinitionNewPages', function() {
      // uncomment below and update the code to test TemplateDefinitionNewPages
      //var instane = new PDFGeneratorAPI.TemplateDefinitionNewPages();
      //expect(instance).to.be.a(PDFGeneratorAPI.TemplateDefinitionNewPages);
    });

    it('should have the property width (base name: "width")', function() {
      // uncomment below and update the code to test the property width
      //var instance = new PDFGeneratorAPI.TemplateDefinitionNewPages();
