...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.TemplateDefinitionNewLayoutRepeatLayout();
  });
  ...
  describe('TemplateDefinitionNewLayoutRepeatLayout', function() {
    it('should create an instance of TemplateDefinitionNewLayoutRepeatLayout', function() {
      // uncomment below and update the code to test TemplateDefinitionNewLayoutRepeatLayout
      //var instane = new PDFGeneratorAPI.TemplateDefinitionNewLayoutRepeatLayout();
      //expect(instance).to.be.a(PDFGeneratorAPI.TemplateDefinitionNewLayoutRepeatLayout);
    });

    it('should have the property format (base name: "format")', function() {
      // uncomment below and update the code to test the property format
      //var instance = new PDFGeneratorAPI.TemplateDefinitionNewLayoutRepeatLayout();
