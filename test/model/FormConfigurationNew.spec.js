...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.FormConfigurationNew();
  });
  ...
  describe('FormConfigurationNew', function() {
    it('should create an instance of FormConfigurationNew', function() {
      // uncomment below and update the code to test FormConfigurationNew
      //var instance = new PDFGeneratorAPI.FormConfigurationNew();
      //expect(instance).to.be.a(PDFGeneratorAPI.FormConfigurationNew);
    });
