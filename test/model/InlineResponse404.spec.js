...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.InlineResponse404();
  });
  ...
  describe('InlineResponse404', function() {
    it('should create an instance of InlineResponse404', function() {
      ...
      //var instane = new PDFGeneratorAPI.InlineResponse404();
      //expect(instance).to.be.a(PDFGeneratorAPI.InlineResponse404);
    });

    it('should have the property error (base name: "error")', function() {
      // uncomment below and update the code to test the property error
      //var instance = new PDFGeneratorAPI.InlineResponse404();
