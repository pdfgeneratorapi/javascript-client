...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.GenerateDocumentRequest();
  });
  ...
  describe('GenerateDocumentRequest', function() {
    it('should create an instance of GenerateDocumentRequest', function() {
      // uncomment below and update the code to test GenerateDocumentRequest
      //var instance = new PDFGeneratorAPI.GenerateDocumentRequest();
      //expect(instance).to.be.a(PDFGeneratorAPI.GenerateDocumentRequest);
    });
