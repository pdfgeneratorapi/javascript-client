...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.CallbackParam();
  });
  ...
  describe('CallbackParam', function() {
    it('should create an instance of CallbackParam', function() {
      // uncomment below and update the code to test CallbackParam
      //var instance = new PDFGeneratorAPI.CallbackParam();
      //expect(instance).to.be.a(PDFGeneratorAPI.CallbackParam);
    });
