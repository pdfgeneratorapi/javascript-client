...
(function(root, factory) {
  ...
  describe('Component', function() {
    it('should create an instance of Component', function() {
      ...
      //var instane = new PDFGeneratorAPI.Component();
    ...
    it('should have the property data_index (base name: "dataIndex")', function() {
      // uncomment below and update the code to test the property data_index
      //var instance = new PDFGeneratorAPI.Component();
      //expect(instance).to.be();
    });
