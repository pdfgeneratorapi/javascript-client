...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.DocumentUser();
  });
  ...
  describe('DocumentUser', function() {
    it('should create an instance of DocumentUser', function() {
      // uncomment below and update the code to test DocumentUser
      //var instance = new PDFGeneratorAPI.DocumentUser();
      //expect(instance).to.be.a(PDFGeneratorAPI.DocumentUser);
    });
