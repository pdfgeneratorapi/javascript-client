...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.MakeAccessibleUrl();
  });
  ...
  describe('MakeAccessibleUrl', function() {
    it('should create an instance of MakeAccessibleUrl', function() {
      // uncomment below and update the code to test MakeAccessibleUrl
      //var instance = new PDFGeneratorAPI.MakeAccessibleUrl();
      //expect(instance).to.be.a(PDFGeneratorAPI.MakeAccessibleUrl);
    });
