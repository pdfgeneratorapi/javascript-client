...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.InlineResponse2001();
  });
  ...
  describe('InlineResponse2001', function() {
    it('should create an instance of InlineResponse2001', function() {
      ...
      //var instane = new PDFGeneratorAPI.InlineResponse2001();
      //expect(instance).to.be.a(PDFGeneratorAPI.InlineResponse2001);
    });
    ...
    it('should have the property response (base name: "response")', function() {
      ...
      //var instance = new PDFGeneratorAPI.InlineResponse2001();
