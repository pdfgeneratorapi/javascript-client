...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.MakeAccessibleRequest();
  });
  ...
  describe('MakeAccessibleRequest', function() {
    it('should create an instance of MakeAccessibleRequest', function() {
      // uncomment below and update the code to test MakeAccessibleRequest
      //var instance = new PDFGeneratorAPI.MakeAccessibleRequest();
      //expect(instance).to.be.a(PDFGeneratorAPI.MakeAccessibleRequest);
    });
