...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.PublicTemplateLibraryItem();
  });
  ...
  describe('PublicTemplateLibraryItem', function() {
    it('should create an instance of PublicTemplateLibraryItem', function() {
      // uncomment below and update the code to test PublicTemplateLibraryItem
      //var instance = new PDFGeneratorAPI.PublicTemplateLibraryItem();
      //expect(instance).to.be.a(PDFGeneratorAPI.PublicTemplateLibraryItem);
    });
    ...
    it('should have the property preview_image_url (base name: "preview_image_url")', function() {
      // uncomment below and update the code to test the property preview_image_url
      //var instance = new PDFGeneratorAPI.PublicTemplateLibraryItem();
      //expect(instance).to.be();
    });

    it('should have the property sample_data_url (base name: "sample_data_url")', function() {
      // uncomment below and update the code to test the property sample_data_url
      //var instance = new PDFGeneratorAPI.PublicTemplateLibraryItem();
      //expect(instance).to.be();
    });
