...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.TemplateDefinitionEditor();
  });
  ...
  describe('TemplateDefinitionEditor', function() {
    it('should create an instance of TemplateDefinitionEditor', function() {
      // uncomment below and update the code to test TemplateDefinitionEditor
      //var instane = new PDFGeneratorAPI.TemplateDefinitionEditor();
      //expect(instance).to.be.a(PDFGeneratorAPI.TemplateDefinitionEditor);
    });

    it('should have the property height_multiplier (base name: "heightMultiplier")', function() {
      // uncomment below and update the code to test the property height_multiplier
      //var instance = new PDFGeneratorAPI.TemplateDefinitionEditor();
