...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.WatermarkText();
  });
  ...
  describe('WatermarkText', function() {
    it('should create an instance of WatermarkText', function() {
      // uncomment below and update the code to test WatermarkText
      //var instance = new PDFGeneratorAPI.WatermarkText();
      //expect(instance).to.be.a(PDFGeneratorAPI.WatermarkText);
    });
