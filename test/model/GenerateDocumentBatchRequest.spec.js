...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.GenerateDocumentBatchRequest();
  });
  ...
  describe('GenerateDocumentBatchRequest', function() {
    it('should create an instance of GenerateDocumentBatchRequest', function() {
      // uncomment below and update the code to test GenerateDocumentBatchRequest
      //var instance = new PDFGeneratorAPI.GenerateDocumentBatchRequest();
      //expect(instance).to.be.a(PDFGeneratorAPI.GenerateDocumentBatchRequest);
    });
