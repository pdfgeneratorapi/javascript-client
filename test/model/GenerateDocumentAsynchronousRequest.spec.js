...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.GenerateDocumentAsynchronousRequest();
  });
  ...
  describe('GenerateDocumentAsynchronousRequest', function() {
    it('should create an instance of GenerateDocumentAsynchronousRequest', function() {
      // uncomment below and update the code to test GenerateDocumentAsynchronousRequest
      //var instance = new PDFGeneratorAPI.GenerateDocumentAsynchronousRequest();
      //expect(instance).to.be.a(PDFGeneratorAPI.GenerateDocumentAsynchronousRequest);
    });
    ...
    it('should have the property make_accessible (base name: "make_accessible")', function() {
      // uncomment below and update the code to test the property make_accessible
      //var instance = new PDFGeneratorAPI.GenerateDocumentAsynchronousRequest();
      //expect(instance).to.be();
    });
