...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.GetDocument200ResponseMeta();
  });
  ...
  describe('GetDocument200ResponseMeta', function() {
    it('should create an instance of GetDocument200ResponseMeta', function() {
      // uncomment below and update the code to test GetDocument200ResponseMeta
      //var instance = new PDFGeneratorAPI.GetDocument200ResponseMeta();
      //expect(instance).to.be.a(PDFGeneratorAPI.GetDocument200ResponseMeta);
    });
