...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.StoreDocumentRequest();
  });
  ...
  describe('StoreDocumentRequest', function() {
    it('should create an instance of StoreDocumentRequest', function() {
      // uncomment below and update the code to test StoreDocumentRequest
      //var instance = new PDFGeneratorAPI.StoreDocumentRequest();
      //expect(instance).to.be.a(PDFGeneratorAPI.StoreDocumentRequest);
    });
