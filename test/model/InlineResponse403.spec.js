...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.InlineResponse403();
  });
  ...
  describe('InlineResponse403', function() {
    it('should create an instance of InlineResponse403', function() {
      ...
      //var instane = new PDFGeneratorAPI.InlineResponse403();
      //expect(instance).to.be.a(PDFGeneratorAPI.InlineResponse403);
    });

    it('should have the property error (base name: "error")', function() {
      // uncomment below and update the code to test the property error
      //var instance = new PDFGeneratorAPI.InlineResponse403();
