...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.InlineResponse2005();
  });
  ...
  describe('InlineResponse2005', function() {
    it('should create an instance of InlineResponse2005', function() {
      ...
      //var instane = new PDFGeneratorAPI.InlineResponse2005();
      //expect(instance).to.be.a(PDFGeneratorAPI.InlineResponse2005);
    });
    ...
    it('should have the property response (base name: "response")', function() {
      ...
      //var instance = new PDFGeneratorAPI.InlineResponse2005();
