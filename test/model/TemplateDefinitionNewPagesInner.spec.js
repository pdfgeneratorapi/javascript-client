...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.TemplateDefinitionNewPagesInner();
  });
  ...
  describe('TemplateDefinitionNewPagesInner', function() {
    it('should create an instance of TemplateDefinitionNewPagesInner', function() {
      // uncomment below and update the code to test TemplateDefinitionNewPagesInner
      //var instance = new PDFGeneratorAPI.TemplateDefinitionNewPagesInner();
      //expect(instance).to.be.a(PDFGeneratorAPI.TemplateDefinitionNewPagesInner);
    });
    ...
    it('should have the property conditional_formats (base name: "conditionalFormats")', function() {
      // uncomment below and update the code to test the property conditional_formats
      //var instance = new PDFGeneratorAPI.TemplateDefinitionNewPagesInner();
      //expect(instance).to.be();
    });

    it('should have the property background_image (base name: "backgroundImage")', function() {
      // uncomment below and update the code to test the property background_image
      //var instance = new PDFGeneratorAPI.TemplateDefinitionNewPagesInner();
      //expect(instance).to.be();
    });
