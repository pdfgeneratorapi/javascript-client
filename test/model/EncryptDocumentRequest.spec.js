...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.EncryptDocumentRequest();
  });
  ...
  describe('EncryptDocumentRequest', function() {
    it('should create an instance of EncryptDocumentRequest', function() {
      // uncomment below and update the code to test EncryptDocumentRequest
      //var instance = new PDFGeneratorAPI.EncryptDocumentRequest();
      //expect(instance).to.be.a(PDFGeneratorAPI.EncryptDocumentRequest);
    });
