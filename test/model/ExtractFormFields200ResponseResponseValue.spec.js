...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.ExtractFormFields200ResponseResponseValue();
  });
  ...
  describe('ExtractFormFields200ResponseResponseValue', function() {
    it('should create an instance of ExtractFormFields200ResponseResponseValue', function() {
      // uncomment below and update the code to test ExtractFormFields200ResponseResponseValue
      //var instance = new PDFGeneratorAPI.ExtractFormFields200ResponseResponseValue();
      //expect(instance).to.be.a(PDFGeneratorAPI.ExtractFormFields200ResponseResponseValue);
    });
    ...
    it('should have the property maxlen (base name: "maxlen")', function() {
