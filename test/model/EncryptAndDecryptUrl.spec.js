...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.EncryptAndDecryptUrl();
  });
  ...
  describe('EncryptAndDecryptUrl', function() {
    it('should create an instance of EncryptAndDecryptUrl', function() {
      // uncomment below and update the code to test EncryptAndDecryptUrl
      //var instance = new PDFGeneratorAPI.EncryptAndDecryptUrl();
      //expect(instance).to.be.a(PDFGeneratorAPI.EncryptAndDecryptUrl);
    });
