...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.EncryptAndDecryptBase64();
  });
  ...
  describe('EncryptAndDecryptBase64', function() {
    it('should create an instance of EncryptAndDecryptBase64', function() {
      // uncomment below and update the code to test EncryptAndDecryptBase64
      //var instance = new PDFGeneratorAPI.EncryptAndDecryptBase64();
      //expect(instance).to.be.a(PDFGeneratorAPI.EncryptAndDecryptBase64);
    });

    it('should have the property file_base64 (base name: "file_base64")', function() {
      // uncomment below and update the code to test the property file_base64
      //var instance = new PDFGeneratorAPI.EncryptAndDecryptBase64();
      //expect(instance).to.be();
    });

    it('should have the property owner_password (base name: "owner_password")', function() {
      // uncomment below and update the code to test the property owner_password
      //var instance = new PDFGeneratorAPI.EncryptAndDecryptBase64();
      //expect(instance).to.be();
    });

    it('should have the property user_password (base name: "user_password")', function() {
      // uncomment below and update the code to test the property user_password
      //var instance = new PDFGeneratorAPI.EncryptAndDecryptBase64();
      //expect(instance).to.be();
    });
