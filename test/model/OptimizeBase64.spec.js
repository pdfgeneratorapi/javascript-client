...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.OptimizeBase64();
  });
  ...
  describe('OptimizeBase64', function() {
    it('should create an instance of OptimizeBase64', function() {
      // uncomment below and update the code to test OptimizeBase64
      //var instance = new PDFGeneratorAPI.OptimizeBase64();
      //expect(instance).to.be.a(PDFGeneratorAPI.OptimizeBase64);
    });
