...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.FormConfiguration();
  });
  ...
  describe('FormConfiguration', function() {
    it('should create an instance of FormConfiguration', function() {
      // uncomment below and update the code to test FormConfiguration
      //var instance = new PDFGeneratorAPI.FormConfiguration();
      //expect(instance).to.be.a(PDFGeneratorAPI.FormConfiguration);
    });
    ...
    it('should have the property intro (base name: "intro")', function() {
      // uncomment below and update the code to test the property intro
      //var instance = new PDFGeneratorAPI.FormConfiguration();
      //expect(instance).to.be();
    });
