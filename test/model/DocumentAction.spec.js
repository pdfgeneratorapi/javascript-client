...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.DocumentAction();
  });
  ...
  describe('DocumentAction', function() {
    it('should create an instance of DocumentAction', function() {
      // uncomment below and update the code to test DocumentAction
      //var instance = new PDFGeneratorAPI.DocumentAction();
      //expect(instance).to.be.a(PDFGeneratorAPI.DocumentAction);
    });
