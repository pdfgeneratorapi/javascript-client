...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.GenerateDocumentAsyncRequest();
  });
  ...
  describe('GenerateDocumentAsyncRequest', function() {
    it('should create an instance of GenerateDocumentAsyncRequest', function() {
      // uncomment below and update the code to test GenerateDocumentAsyncRequest
      //var instance = new PDFGeneratorAPI.GenerateDocumentAsyncRequest();
      //expect(instance).to.be.a(PDFGeneratorAPI.GenerateDocumentAsyncRequest);
    });
