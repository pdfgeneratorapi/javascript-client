...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.DocumentSignatures();
  });
  ...
  describe('DocumentSignatures', function() {
    it('should create an instance of DocumentSignatures', function() {
      // uncomment below and update the code to test DocumentSignatures
      //var instance = new PDFGeneratorAPI.DocumentSignatures();
      //expect(instance).to.be.a(PDFGeneratorAPI.DocumentSignatures);
    });
    ...
    it('should have the property status_label (base name: "status_label")', function() {
      // uncomment below and update the code to test the property status_label
      //var instance = new PDFGeneratorAPI.DocumentSignatures();
      //expect(instance).to.be();
    });

    it('should have the property has_long_term_validation (base name: "has_long_term_validation")', function() {
      // uncomment below and update the code to test the property has_long_term_validation
      //var instance = new PDFGeneratorAPI.DocumentSignatures();
      //expect(instance).to.be();
    });

    it('should have the property covers_whole_document (base name: "covers_whole_document")', function() {
      // uncomment below and update the code to test the property covers_whole_document
      //var instance = new PDFGeneratorAPI.DocumentSignatures();
      //expect(instance).to.be();
    });

    it('should have the property document_timestamps (base name: "document_timestamps")', function() {
      // uncomment below and update the code to test the property document_timestamps
      //var instance = new PDFGeneratorAPI.DocumentSignatures();
      //expect(instance).to.be();
    });
