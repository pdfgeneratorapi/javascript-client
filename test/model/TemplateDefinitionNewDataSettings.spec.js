...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.TemplateDefinitionNewDataSettings();
  });
  ...
  describe('TemplateDefinitionNewDataSettings', function() {
    it('should create an instance of TemplateDefinitionNewDataSettings', function() {
      // uncomment below and update the code to test TemplateDefinitionNewDataSettings
      //var instance = new PDFGeneratorAPI.TemplateDefinitionNewDataSettings();
      //expect(instance).to.be.a(PDFGeneratorAPI.TemplateDefinitionNewDataSettings);
    });
