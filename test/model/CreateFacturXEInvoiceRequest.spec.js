...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.CreateFacturXEInvoiceRequest();
  });
  ...
  describe('CreateFacturXEInvoiceRequest', function() {
    it('should create an instance of CreateFacturXEInvoiceRequest', function() {
      // uncomment below and update the code to test CreateFacturXEInvoiceRequest
      //var instance = new PDFGeneratorAPI.CreateFacturXEInvoiceRequest();
      //expect(instance).to.be.a(PDFGeneratorAPI.CreateFacturXEInvoiceRequest);
    });
