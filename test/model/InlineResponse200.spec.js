...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.InlineResponse200();
  });
  ...
  describe('InlineResponse200', function() {
    it('should create an instance of InlineResponse200', function() {
      ...
      //var instane = new PDFGeneratorAPI.InlineResponse200();
      //expect(instance).to.be.a(PDFGeneratorAPI.InlineResponse200);
    });
    ...
    it('should have the property response (base name: "response")', function() {
      ...
      //var instance = new PDFGeneratorAPI.InlineResponse200();
