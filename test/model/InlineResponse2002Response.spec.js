...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.InlineResponse2002Response();
  });
  ...
  describe('InlineResponse2002Response', function() {
    it('should create an instance of InlineResponse2002Response', function() {
      // uncomment below and update the code to test InlineResponse2002Response
      //var instane = new PDFGeneratorAPI.InlineResponse2002Response();
      //expect(instance).to.be.a(PDFGeneratorAPI.InlineResponse2002Response);
    });

    it('should have the property success (base name: "success")', function() {
      // uncomment below and update the code to test the property success
      //var instance = new PDFGeneratorAPI.InlineResponse2002Response();
