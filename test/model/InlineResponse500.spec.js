...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.InlineResponse500();
  });
  ...
  describe('InlineResponse500', function() {
    it('should create an instance of InlineResponse500', function() {
      ...
      //var instane = new PDFGeneratorAPI.InlineResponse500();
      //expect(instance).to.be.a(PDFGeneratorAPI.InlineResponse500);
    });

    it('should have the property error (base name: "error")', function() {
      // uncomment below and update the code to test the property error
      //var instance = new PDFGeneratorAPI.InlineResponse500();
