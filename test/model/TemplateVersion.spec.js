...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.TemplateVersion();
  });
  ...
  describe('TemplateVersion', function() {
    it('should create an instance of TemplateVersion', function() {
      // uncomment below and update the code to test TemplateVersion
      //var instance = new PDFGeneratorAPI.TemplateVersion();
      //expect(instance).to.be.a(PDFGeneratorAPI.TemplateVersion);
    });
    ...
    it('should have the property is_production (base name: "is_production")', function() {
      // uncomment below and update the code to test the property is_production
      //var instance = new PDFGeneratorAPI.TemplateVersion();
      //expect(instance).to.be();
    });
