...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.PrefillParam();
  });
  ...
  describe('PrefillParam', function() {
    it('should create an instance of PrefillParam', function() {
      // uncomment below and update the code to test PrefillParam
      //var instance = new PDFGeneratorAPI.PrefillParam();
      //expect(instance).to.be.a(PDFGeneratorAPI.PrefillParam);
    });

    it('should have the property id_code (base name: "id_code")', function() {
      // uncomment below and update the code to test the property id_code
      //var instance = new PDFGeneratorAPI.PrefillParam();
    ...
    it('should have the property signature_id (base name: "signature_id")', function() {
      // uncomment below and update the code to test the property signature_id
      //var instance = new PDFGeneratorAPI.PrefillParam();
      //expect(instance).to.be();
    });
