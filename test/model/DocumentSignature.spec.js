...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.DocumentSignature();
  });
  ...
  describe('DocumentSignature', function() {
    it('should create an instance of DocumentSignature', function() {
      // uncomment below and update the code to test DocumentSignature
      //var instance = new PDFGeneratorAPI.DocumentSignature();
      //expect(instance).to.be.a(PDFGeneratorAPI.DocumentSignature);
    });

    it('should have the property field_name (base name: "field_name")', function() {
      // uncomment below and update the code to test the property field_name
      //var instance = new PDFGeneratorAPI.DocumentSignature();
      //expect(instance).to.be();
    });

    it('should have the property signer_name (base name: "signer_name")', function() {
      // uncomment below and update the code to test the property signer_name
      //var instance = new PDFGeneratorAPI.DocumentSignature();
      //expect(instance).to.be();
    });
    ...
    it('should have the property signed_at (base name: "signed_at")', function() {
      // uncomment below and update the code to test the property signed_at
      //var instance = new PDFGeneratorAPI.DocumentSignature();
      //expect(instance).to.be();
    });

    it('should have the property claimed_signed_at (base name: "claimed_signed_at")', function() {
      // uncomment below and update the code to test the property claimed_signed_at
      //var instance = new PDFGeneratorAPI.DocumentSignature();
      //expect(instance).to.be();
    });

    it('should have the property timestamp_authority (base name: "timestamp_authority")', function() {
      // uncomment below and update the code to test the property timestamp_authority
      //var instance = new PDFGeneratorAPI.DocumentSignature();
      //expect(instance).to.be();
    });

    it('should have the property intact (base name: "intact")', function() {
      // uncomment below and update the code to test the property intact
      //var instance = new PDFGeneratorAPI.DocumentSignature();
      //expect(instance).to.be();
    });
    ...
    it('should have the property ades_indication (base name: "ades_indication")', function() {
      // uncomment below and update the code to test the property ades_indication
      //var instance = new PDFGeneratorAPI.DocumentSignature();
      //expect(instance).to.be();
    });

    it('should have the property ades_sub_indication (base name: "ades_sub_indication")', function() {
      // uncomment below and update the code to test the property ades_sub_indication
      //var instance = new PDFGeneratorAPI.DocumentSignature();
      //expect(instance).to.be();
    });
