...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.TemplateDefinitionNew();
  });
  ...
  describe('TemplateDefinitionNew', function() {
    it('should create an instance of TemplateDefinitionNew', function() {
      // uncomment below and update the code to test TemplateDefinitionNew
      //var instance = new PDFGeneratorAPI.TemplateDefinitionNew();
      //expect(instance).to.be.a(PDFGeneratorAPI.TemplateDefinitionNew);
    });
    ...
    it('should have the property is_draft (base name: "isDraft")', function() {
      // uncomment below and update the code to test the property is_draft
      //var instance = new PDFGeneratorAPI.TemplateDefinitionNew();
      //expect(instance).to.be();
    });
    ...
    it('should have the property data_settings (base name: "dataSettings")', function() {
      // uncomment below and update the code to test the property data_settings
      //var instance = new PDFGeneratorAPI.TemplateDefinitionNew();
      //expect(instance).to.be();
    });
    ...
    it('should have the property font_subsetting (base name: "fontSubsetting")', function() {
      // uncomment below and update the code to test the property font_subsetting
      //var instance = new PDFGeneratorAPI.TemplateDefinitionNew();
      //expect(instance).to.be();
    });

    it('should have the property barcode_as_image (base name: "barcodeAsImage")', function() {
      // uncomment below and update the code to test the property barcode_as_image
      //var instance = new PDFGeneratorAPI.TemplateDefinitionNew();
      //expect(instance).to.be();
    });
