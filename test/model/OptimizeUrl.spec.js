...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.OptimizeUrl();
  });
  ...
  describe('OptimizeUrl', function() {
    it('should create an instance of OptimizeUrl', function() {
      // uncomment below and update the code to test OptimizeUrl
      //var instance = new PDFGeneratorAPI.OptimizeUrl();
      //expect(instance).to.be.a(PDFGeneratorAPI.OptimizeUrl);
    });
