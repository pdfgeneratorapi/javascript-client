...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.OpenEditorRequest();
  });
  ...
  describe('OpenEditorRequest', function() {
    it('should create an instance of OpenEditorRequest', function() {
      // uncomment below and update the code to test OpenEditorRequest
      //var instance = new PDFGeneratorAPI.OpenEditorRequest();
      //expect(instance).to.be.a(PDFGeneratorAPI.OpenEditorRequest);
    });
