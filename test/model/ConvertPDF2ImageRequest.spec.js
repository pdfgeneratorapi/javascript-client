...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.ConvertPDF2ImageRequest();
  });
  ...
  describe('ConvertPDF2ImageRequest', function() {
    it('should create an instance of ConvertPDF2ImageRequest', function() {
      // uncomment below and update the code to test ConvertPDF2ImageRequest
      //var instance = new PDFGeneratorAPI.ConvertPDF2ImageRequest();
      //expect(instance).to.be.a(PDFGeneratorAPI.ConvertPDF2ImageRequest);
    });
