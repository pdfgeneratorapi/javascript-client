...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.FormFillUrl();
  });
  ...
  describe('FormFillUrl', function() {
    it('should create an instance of FormFillUrl', function() {
      // uncomment below and update the code to test FormFillUrl
      //var instance = new PDFGeneratorAPI.FormFillUrl();
      //expect(instance).to.be.a(PDFGeneratorAPI.FormFillUrl);
    });
