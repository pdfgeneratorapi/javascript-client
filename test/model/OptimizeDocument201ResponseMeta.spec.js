...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.OptimizeDocument201ResponseMeta();
  });
  ...
  describe('OptimizeDocument201ResponseMeta', function() {
    it('should create an instance of OptimizeDocument201ResponseMeta', function() {
      // uncomment below and update the code to test OptimizeDocument201ResponseMeta
      //var instance = new PDFGeneratorAPI.OptimizeDocument201ResponseMeta();
      //expect(instance).to.be.a(PDFGeneratorAPI.OptimizeDocument201ResponseMeta);
    });
    ...
    it('should have the property content_type (base name: "content-type")', function() {
    ...
    it('should have the property public_id (base name: "public_id")', function() {
      // uncomment below and update the code to test the property public_id
      //var instance = new PDFGeneratorAPI.OptimizeDocument201ResponseMeta();
      //expect(instance).to.be();
    });
