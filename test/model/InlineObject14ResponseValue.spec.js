...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.InlineObject14ResponseValue();
  });
  ...
  describe('InlineObject14ResponseValue', function() {
    it('should create an instance of InlineObject14ResponseValue', function() {
      // uncomment below and update the code to test InlineObject14ResponseValue
      //var instance = new PDFGeneratorAPI.InlineObject14ResponseValue();
      //expect(instance).to.be.a(PDFGeneratorAPI.InlineObject14ResponseValue);
    });
