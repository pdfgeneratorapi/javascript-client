...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.InlineResponse2004();
  });
  ...
  describe('InlineResponse2004', function() {
    it('should create an instance of InlineResponse2004', function() {
      ...
      //var instane = new PDFGeneratorAPI.InlineResponse2004();
      //expect(instance).to.be.a(PDFGeneratorAPI.InlineResponse2004);
    });
    ...
    it('should have the property response (base name: "response")', function() {
      ...
      //var instance = new PDFGeneratorAPI.InlineResponse2004();
