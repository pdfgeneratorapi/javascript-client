...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.FillFormFieldsRequest();
  });
  ...
  describe('FillFormFieldsRequest', function() {
    it('should create an instance of FillFormFieldsRequest', function() {
      // uncomment below and update the code to test FillFormFieldsRequest
      //var instance = new PDFGeneratorAPI.FillFormFieldsRequest();
      //expect(instance).to.be.a(PDFGeneratorAPI.FillFormFieldsRequest);
    });
