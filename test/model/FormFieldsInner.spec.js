...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.FormFieldsInner();
  });
  ...
  describe('FormFieldsInner', function() {
    it('should create an instance of FormFieldsInner', function() {
      // uncomment below and update the code to test FormFieldsInner
      //var instance = new PDFGeneratorAPI.FormFieldsInner();
      //expect(instance).to.be.a(PDFGeneratorAPI.FormFieldsInner);
    });
