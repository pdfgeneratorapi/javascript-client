...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.DataBatchInner();
  });
  ...
  describe('DataBatchInner', function() {
    it('should create an instance of DataBatchInner', function() {
      // uncomment below and update the code to test DataBatchInner
      //var instance = new PDFGeneratorAPI.DataBatchInner();
      //expect(instance).to.be.a(PDFGeneratorAPI.DataBatchInner);
    });
