...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.WatermarkBase64();
  });
  ...
  describe('WatermarkBase64', function() {
    it('should create an instance of WatermarkBase64', function() {
      // uncomment below and update the code to test WatermarkBase64
      //var instance = new PDFGeneratorAPI.WatermarkBase64();
      //expect(instance).to.be.a(PDFGeneratorAPI.WatermarkBase64);
    });
