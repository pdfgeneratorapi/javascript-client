...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.AddWatermark201ResponseMeta();
  });
  ...
  describe('AddWatermark201ResponseMeta', function() {
    it('should create an instance of AddWatermark201ResponseMeta', function() {
      // uncomment below and update the code to test AddWatermark201ResponseMeta
      //var instance = new PDFGeneratorAPI.AddWatermark201ResponseMeta();
      //expect(instance).to.be.a(PDFGeneratorAPI.AddWatermark201ResponseMeta);
    });
