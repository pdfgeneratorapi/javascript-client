...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.InlineResponse401();
  });
  ...
  describe('InlineResponse401', function() {
    it('should create an instance of InlineResponse401', function() {
      ...
      //var instane = new PDFGeneratorAPI.InlineResponse401();
      //expect(instance).to.be.a(PDFGeneratorAPI.InlineResponse401);
    });

    it('should have the property error (base name: "error")', function() {
      // uncomment below and update the code to test the property error
      //var instance = new PDFGeneratorAPI.InlineResponse401();
