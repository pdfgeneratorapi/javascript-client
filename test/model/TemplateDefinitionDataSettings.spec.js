...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.TemplateDefinitionDataSettings();
  });
  ...
  describe('TemplateDefinitionDataSettings', function() {
    it('should create an instance of TemplateDefinitionDataSettings', function() {
      // uncomment below and update the code to test TemplateDefinitionDataSettings
      //var instane = new PDFGeneratorAPI.TemplateDefinitionDataSettings();
      //expect(instance).to.be.a(PDFGeneratorAPI.TemplateDefinitionDataSettings);
    });

    it('should have the property sort_by (base name: "sortBy")', function() {
      // uncomment below and update the code to test the property sort_by
      //var instance = new PDFGeneratorAPI.TemplateDefinitionDataSettings();
      //expect(instance).to.be();
    });

    it('should have the property filter_by (base name: "filterBy")', function() {
      // uncomment below and update the code to test the property filter_by
      //var instance = new PDFGeneratorAPI.TemplateDefinitionDataSettings();
      //expect(instance).to.be();
    });
