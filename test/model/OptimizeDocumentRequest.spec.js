...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.OptimizeDocumentRequest();
  });
  ...
  describe('OptimizeDocumentRequest', function() {
    it('should create an instance of OptimizeDocumentRequest', function() {
      // uncomment below and update the code to test OptimizeDocumentRequest
      //var instance = new PDFGeneratorAPI.OptimizeDocumentRequest();
      //expect(instance).to.be.a(PDFGeneratorAPI.OptimizeDocumentRequest);
    });
