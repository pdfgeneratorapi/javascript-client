...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.MergeTemplate200ResponseMeta();
  });
  ...
  describe('MergeTemplate200ResponseMeta', function() {
    it('should create an instance of MergeTemplate200ResponseMeta', function() {
      // uncomment below and update the code to test MergeTemplate200ResponseMeta
      //var instance = new PDFGeneratorAPI.MergeTemplate200ResponseMeta();
      //expect(instance).to.be.a(PDFGeneratorAPI.MergeTemplate200ResponseMeta);
    });
