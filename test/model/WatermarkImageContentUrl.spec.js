...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.WatermarkImageContentUrl();
  });
  ...
  describe('WatermarkImageContentUrl', function() {
    it('should create an instance of WatermarkImageContentUrl', function() {
      // uncomment below and update the code to test WatermarkImageContentUrl
      //var instance = new PDFGeneratorAPI.WatermarkImageContentUrl();
      //expect(instance).to.be.a(PDFGeneratorAPI.WatermarkImageContentUrl);
    });

    it('should have the property content_url (base name: "content_url")', function() {
      // uncomment below and update the code to test the property content_url
      //var instance = new PDFGeneratorAPI.WatermarkImageContentUrl();
