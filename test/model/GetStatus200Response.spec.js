...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.GetStatus200Response();
  });
  ...
  describe('GetStatus200Response', function() {
    it('should create an instance of GetStatus200Response', function() {
      ...
      //var instance = new PDFGeneratorAPI.GetStatus200Response();
      //expect(instance).to.be.a(PDFGeneratorAPI.GetStatus200Response);
    });
    ...
    it('should have the property chart_api (base name: "chart-api")', function() {
      // uncomment below and update the code to test the property chart_api
      //var instance = new PDFGeneratorAPI.GetStatus200Response();
      //expect(instance).to.be();
    });

    it('should have the property conversion_api (base name: "conversion-api")', function() {
      // uncomment below and update the code to test the property conversion_api
      //var instance = new PDFGeneratorAPI.GetStatus200Response();
      //expect(instance).to.be();
    });

    it('should have the property generator_api_sync (base name: "generator-api-sync")', function() {
      // uncomment below and update the code to test the property generator_api_sync
      //var instance = new PDFGeneratorAPI.GetStatus200Response();
      //expect(instance).to.be();
    });

    it('should have the property generator_api_async (base name: "generator-api-async")', function() {
      // uncomment below and update the code to test the property generator_api_async
      //var instance = new PDFGeneratorAPI.GetStatus200Response();
      //expect(instance).to.be();
    });

    it('should have the property e_invoice (base name: "e-invoice")', function() {
      // uncomment below and update the code to test the property e_invoice
      //var instance = new PDFGeneratorAPI.GetStatus200Response();
      //expect(instance).to.be();
    });
