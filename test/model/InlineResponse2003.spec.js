...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.InlineResponse2003();
  });
  ...
  describe('InlineResponse2003', function() {
    it('should create an instance of InlineResponse2003', function() {
      ...
      //var instane = new PDFGeneratorAPI.InlineResponse2003();
      //expect(instance).to.be.a(PDFGeneratorAPI.InlineResponse2003);
    });
    ...
    it('should have the property response (base name: "response")', function() {
      ...
      //var instance = new PDFGeneratorAPI.InlineResponse2003();
