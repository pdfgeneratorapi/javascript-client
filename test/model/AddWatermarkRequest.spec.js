...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.AddWatermarkRequest();
  });
  ...
  describe('AddWatermarkRequest', function() {
    it('should create an instance of AddWatermarkRequest', function() {
      // uncomment below and update the code to test AddWatermarkRequest
      //var instance = new PDFGeneratorAPI.AddWatermarkRequest();
      //expect(instance).to.be.a(PDFGeneratorAPI.AddWatermarkRequest);
    });
