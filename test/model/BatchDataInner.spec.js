...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.BatchDataInner();
  });
  ...
  describe('BatchDataInner', function() {
    it('should create an instance of BatchDataInner', function() {
      // uncomment below and update the code to test BatchDataInner
      //var instance = new PDFGeneratorAPI.BatchDataInner();
      //expect(instance).to.be.a(PDFGeneratorAPI.BatchDataInner);
    });
