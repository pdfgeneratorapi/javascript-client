...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.TemplateDefinitionNewLayoutMargins();
  });
  ...
  describe('TemplateDefinitionNewLayoutMargins', function() {
    it('should create an instance of TemplateDefinitionNewLayoutMargins', function() {
      // uncomment below and update the code to test TemplateDefinitionNewLayoutMargins
      //var instane = new PDFGeneratorAPI.TemplateDefinitionNewLayoutMargins();
      //expect(instance).to.be.a(PDFGeneratorAPI.TemplateDefinitionNewLayoutMargins);
    });

    it('should have the property top (base name: "top")', function() {
      // uncomment below and update the code to test the property top
      //var instance = new PDFGeneratorAPI.TemplateDefinitionNewLayoutMargins();
