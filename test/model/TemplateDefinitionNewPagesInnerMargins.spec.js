...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.TemplateDefinitionNewPagesInnerMargins();
  });
  ...
  describe('TemplateDefinitionNewPagesInnerMargins', function() {
    it('should create an instance of TemplateDefinitionNewPagesInnerMargins', function() {
      // uncomment below and update the code to test TemplateDefinitionNewPagesInnerMargins
      //var instance = new PDFGeneratorAPI.TemplateDefinitionNewPagesInnerMargins();
      //expect(instance).to.be.a(PDFGeneratorAPI.TemplateDefinitionNewPagesInnerMargins);
    });
