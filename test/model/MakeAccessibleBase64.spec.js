...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.MakeAccessibleBase64();
  });
  ...
  describe('MakeAccessibleBase64', function() {
    it('should create an instance of MakeAccessibleBase64', function() {
      // uncomment below and update the code to test MakeAccessibleBase64
      //var instance = new PDFGeneratorAPI.MakeAccessibleBase64();
      //expect(instance).to.be.a(PDFGeneratorAPI.MakeAccessibleBase64);
    });
