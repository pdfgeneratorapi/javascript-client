...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.CreateFacturXEInvoiceRequestTemplate();
  });
  ...
  describe('CreateFacturXEInvoiceRequestTemplate', function() {
    it('should create an instance of CreateFacturXEInvoiceRequestTemplate', function() {
      // uncomment below and update the code to test CreateFacturXEInvoiceRequestTemplate
      //var instance = new PDFGeneratorAPI.CreateFacturXEInvoiceRequestTemplate();
      //expect(instance).to.be.a(PDFGeneratorAPI.CreateFacturXEInvoiceRequestTemplate);
    });
    ...
    it('should have the property version_id (base name: "version_id")', function() {
      // uncomment below and update the code to test the property version_id
      //var instance = new PDFGeneratorAPI.CreateFacturXEInvoiceRequestTemplate();
      //expect(instance).to.be();
    });
