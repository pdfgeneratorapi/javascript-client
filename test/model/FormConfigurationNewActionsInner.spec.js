...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.FormConfigurationNewActionsInner();
  });
  ...
  describe('FormConfigurationNewActionsInner', function() {
    it('should create an instance of FormConfigurationNewActionsInner', function() {
      // uncomment below and update the code to test FormConfigurationNewActionsInner
      //var instance = new PDFGeneratorAPI.FormConfigurationNewActionsInner();
      //expect(instance).to.be.a(PDFGeneratorAPI.FormConfigurationNewActionsInner);
    });

    it('should have the property store_document (base name: "store_document")', function() {
      // uncomment below and update the code to test the property store_document
      //var instance = new PDFGeneratorAPI.FormConfigurationNewActionsInner();
      //expect(instance).to.be();
    });

    it('should have the property download_document (base name: "download_document")', function() {
      // uncomment below and update the code to test the property download_document
      //var instance = new PDFGeneratorAPI.FormConfigurationNewActionsInner();
      //expect(instance).to.be();
    });

    it('should have the property send_document (base name: "send_document")', function() {
      // uncomment below and update the code to test the property send_document
      //var instance = new PDFGeneratorAPI.FormConfigurationNewActionsInner();
      //expect(instance).to.be();
    });
