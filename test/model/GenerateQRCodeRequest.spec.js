...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.GenerateQRCodeRequest();
  });
  ...
  describe('GenerateQRCodeRequest', function() {
    it('should create an instance of GenerateQRCodeRequest', function() {
      // uncomment below and update the code to test GenerateQRCodeRequest
      //var instance = new PDFGeneratorAPI.GenerateQRCodeRequest();
      //expect(instance).to.be.a(PDFGeneratorAPI.GenerateQRCodeRequest);
    });
    ...
    it('should have the property logo_base64 (base name: "logo_base64")', function() {
      // uncomment below and update the code to test the property logo_base64
      //var instance = new PDFGeneratorAPI.GenerateQRCodeRequest();
      //expect(instance).to.be();
    });

    it('should have the property logo_url (base name: "logo_url")', function() {
      // uncomment below and update the code to test the property logo_url
      //var instance = new PDFGeneratorAPI.GenerateQRCodeRequest();
      //expect(instance).to.be();
    });
