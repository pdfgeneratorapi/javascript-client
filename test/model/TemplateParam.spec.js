...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.TemplateParam();
  });
  ...
  describe('TemplateParam', function() {
    it('should create an instance of TemplateParam', function() {
      // uncomment below and update the code to test TemplateParam
      //var instance = new PDFGeneratorAPI.TemplateParam();
      //expect(instance).to.be.a(PDFGeneratorAPI.TemplateParam);
    });
