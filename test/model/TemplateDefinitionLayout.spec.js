...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.TemplateDefinitionLayout();
  });
  ...
  describe('TemplateDefinitionLayout', function() {
    it('should create an instance of TemplateDefinitionLayout', function() {
      // uncomment below and update the code to test TemplateDefinitionLayout
      //var instane = new PDFGeneratorAPI.TemplateDefinitionLayout();
      //expect(instance).to.be.a(PDFGeneratorAPI.TemplateDefinitionLayout);
    });

    it('should have the property format (base name: "format")', function() {
      // uncomment below and update the code to test the property format
      //var instance = new PDFGeneratorAPI.TemplateDefinitionLayout();
