...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.WatermarkImageContentBase64();
  });
  ...
  describe('WatermarkImageContentBase64', function() {
    it('should create an instance of WatermarkImageContentBase64', function() {
      // uncomment below and update the code to test WatermarkImageContentBase64
      //var instance = new PDFGeneratorAPI.WatermarkImageContentBase64();
      //expect(instance).to.be.a(PDFGeneratorAPI.WatermarkImageContentBase64);
    });

    it('should have the property content_base64 (base name: "content_base64")', function() {
      // uncomment below and update the code to test the property content_base64
      //var instance = new PDFGeneratorAPI.WatermarkImageContentBase64();
