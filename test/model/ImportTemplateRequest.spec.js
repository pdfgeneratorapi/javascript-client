...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.ImportTemplateRequest();
  });
  ...
  describe('ImportTemplateRequest', function() {
    it('should create an instance of ImportTemplateRequest', function() {
      // uncomment below and update the code to test ImportTemplateRequest
      //var instance = new PDFGeneratorAPI.ImportTemplateRequest();
      //expect(instance).to.be.a(PDFGeneratorAPI.ImportTemplateRequest);
    });
