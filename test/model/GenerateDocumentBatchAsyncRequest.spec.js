...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.GenerateDocumentBatchAsyncRequest();
  });
  ...
  describe('GenerateDocumentBatchAsyncRequest', function() {
    it('should create an instance of GenerateDocumentBatchAsyncRequest', function() {
      // uncomment below and update the code to test GenerateDocumentBatchAsyncRequest
      //var instance = new PDFGeneratorAPI.GenerateDocumentBatchAsyncRequest();
      //expect(instance).to.be.a(PDFGeneratorAPI.GenerateDocumentBatchAsyncRequest);
    });
