...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.WatermarkImage();
  });
  ...
  describe('WatermarkImage', function() {
    it('should create an instance of WatermarkImage', function() {
      // uncomment below and update the code to test WatermarkImage
      //var instance = new PDFGeneratorAPI.WatermarkImage();
      //expect(instance).to.be.a(PDFGeneratorAPI.WatermarkImage);
    });
