...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.InlineResponse2004Meta();
  });
  ...
  describe('InlineResponse2004Meta', function() {
    it('should create an instance of InlineResponse2004Meta', function() {
      ...
      //var instane = new PDFGeneratorAPI.InlineResponse2004Meta();
      //expect(instance).to.be.a(PDFGeneratorAPI.InlineResponse2004Meta);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new PDFGeneratorAPI.InlineResponse2004Meta();
