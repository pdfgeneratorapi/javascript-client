...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.CreateEInvoiceRequest();
  });
  ...
  describe('CreateEInvoiceRequest', function() {
    it('should create an instance of CreateEInvoiceRequest', function() {
      // uncomment below and update the code to test CreateEInvoiceRequest
      //var instance = new PDFGeneratorAPI.CreateEInvoiceRequest();
      //expect(instance).to.be.a(PDFGeneratorAPI.CreateEInvoiceRequest);
    });
