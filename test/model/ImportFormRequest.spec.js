...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.ImportFormRequest();
  });
  ...
  describe('ImportFormRequest', function() {
    it('should create an instance of ImportFormRequest', function() {
      // uncomment below and update the code to test ImportFormRequest
      //var instance = new PDFGeneratorAPI.ImportFormRequest();
      //expect(instance).to.be.a(PDFGeneratorAPI.ImportFormRequest);
    });
