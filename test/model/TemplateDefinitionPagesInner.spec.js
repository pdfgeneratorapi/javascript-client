...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.TemplateDefinitionPagesInner();
  });
  ...
  describe('TemplateDefinitionPagesInner', function() {
    it('should create an instance of TemplateDefinitionPagesInner', function() {
      // uncomment below and update the code to test TemplateDefinitionPagesInner
      //var instance = new PDFGeneratorAPI.TemplateDefinitionPagesInner();
      //expect(instance).to.be.a(PDFGeneratorAPI.TemplateDefinitionPagesInner);
    });
