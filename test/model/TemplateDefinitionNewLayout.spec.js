...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.TemplateDefinitionNewLayout();
  });
  ...
  describe('TemplateDefinitionNewLayout', function() {
    it('should create an instance of TemplateDefinitionNewLayout', function() {
      // uncomment below and update the code to test TemplateDefinitionNewLayout
      //var instane = new PDFGeneratorAPI.TemplateDefinitionNewLayout();
      //expect(instance).to.be.a(PDFGeneratorAPI.TemplateDefinitionNewLayout);
    });

    it('should have the property format (base name: "format")', function() {
      // uncomment below and update the code to test the property format
      //var instance = new PDFGeneratorAPI.TemplateDefinitionNewLayout();
    ...
    it('should have the property rotaion (base name: "rotaion")', function() {
      // uncomment below and update the code to test the property rotaion
      //var instance = new PDFGeneratorAPI.TemplateDefinitionNewLayout();
      //expect(instance).to.be();
    });
    ...
    it('should have the property repeat_layout (base name: "repeatLayout")', function() {
      // uncomment below and update the code to test the property repeat_layout
      //var instance = new PDFGeneratorAPI.TemplateDefinitionNewLayout();
      //expect(instance).to.be();
    });

    it('should have the property empty_labels (base name: "emptyLabels")', function() {
      // uncomment below and update the code to test the property empty_labels
      //var instance = new PDFGeneratorAPI.TemplateDefinitionNewLayout();
      //expect(instance).to.be();
    });
