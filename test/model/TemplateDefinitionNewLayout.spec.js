...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.JavascriptWrapperForPdfGeneratorApi);
  }
}(this, function(expect, JavascriptWrapperForPdfGeneratorApi) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new JavascriptWrapperForPdfGeneratorApi.TemplateDefinitionNewLayout();
  });
  ...
  describe('TemplateDefinitionNewLayout', function() {
    it('should create an instance of TemplateDefinitionNewLayout', function() {
      ...
      //var instane = new JavascriptWrapperForPdfGeneratorApi.TemplateDefinitionNewLayout();
      //expect(instance).to.be.a(JavascriptWrapperForPdfGeneratorApi.TemplateDefinitionNewLayout);
    });
    ...
    it('should have the property roation (base name: "roation")', function() {
      // uncomment below and update the code to test the property roation
      //var instane = new JavascriptWrapperForPdfGeneratorApi.TemplateDefinitionNewLayout();
      //expect(instance).to.be();
    });
