...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.TemplateVersionCollectionMeta();
  });
  ...
  describe('TemplateVersionCollectionMeta', function() {
    it('should create an instance of TemplateVersionCollectionMeta', function() {
      // uncomment below and update the code to test TemplateVersionCollectionMeta
      //var instance = new PDFGeneratorAPI.TemplateVersionCollectionMeta();
      //expect(instance).to.be.a(PDFGeneratorAPI.TemplateVersionCollectionMeta);
    });
    ...
    it('should have the property per_page (base name: "per_page")', function() {
      // uncomment below and update the code to test the property per_page
      //var instance = new PDFGeneratorAPI.TemplateVersionCollectionMeta();
      //expect(instance).to.be();
    });

    it('should have the property last_page (base name: "last_page")', function() {
      // uncomment below and update the code to test the property last_page
      //var instance = new PDFGeneratorAPI.TemplateVersionCollectionMeta();
      //expect(instance).to.be();
    });
