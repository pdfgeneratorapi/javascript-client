...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.ServicesApi();
  });
  ...
  describe('ServicesApi', function() {
    describe('addWatermark', function() {
      it('should call addWatermark successfully', function(done) {
        //uncomment below and update the code to test addWatermark
        //instance.addWatermark(function(error) {
    ...
    describe('decryptDocument', function() {
      it('should call decryptDocument successfully', function(done) {
        //uncomment below and update the code to test decryptDocument
        //instance.decryptDocument(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('encryptDocument', function() {
      it('should call encryptDocument successfully', function(done) {
        //uncomment below and update the code to test encryptDocument
        //instance.encryptDocument(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('extractFormFields', function() {
      it('should call extractFormFields successfully', function(done) {
        //uncomment below and update the code to test extractFormFields
        //instance.extractFormFields(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('fillFormFields', function() {
      it('should call fillFormFields successfully', function(done) {
        //uncomment below and update the code to test fillFormFields
        //instance.fillFormFields(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('makeAccessible', function() {
      it('should call makeAccessible successfully', function(done) {
        //uncomment below and update the code to test makeAccessible
        //instance.makeAccessible(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('optimizeDocument', function() {
      it('should call optimizeDocument successfully', function(done) {
        //uncomment below and update the code to test optimizeDocument
        //instance.optimizeDocument(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
