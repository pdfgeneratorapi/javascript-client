...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.TemplateVersionsApi();
  });
  ...
  describe('TemplateVersionsApi', function() {
    ...
    describe('getTemplateVersion', function() {
      it('should call getTemplateVersion successfully', function(done) {
        //uncomment below and update the code to test getTemplateVersion
        //instance.getTemplateVersion(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('promoteTemplateVersion', function() {
      it('should call promoteTemplateVersion successfully', function(done) {
        //uncomment below and update the code to test promoteTemplateVersion
        //instance.promoteTemplateVersion(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
