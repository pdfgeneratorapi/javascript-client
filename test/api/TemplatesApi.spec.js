...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.TemplatesApi();
  });
  ...
  describe('TemplatesApi', function() {
    ...
    describe('getTemplateData', function() {
      it('should call getTemplateData successfully', function(done) {
        //uncomment below and update the code to test getTemplateData
        //instance.getTemplateData(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('openEditor', function() {
      it('should call openEditor successfully', function(done) {
        //uncomment below and update the code to test openEditor
        //instance.openEditor(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('validateTemplate', function() {
      it('should call validateTemplate successfully', function(done) {
        //uncomment below and update the code to test validateTemplate
        //instance.validateTemplate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
