...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.EInvoicesApi();
  });
  ...
  describe('EInvoicesApi', function() {
    describe('createEInvoice', function() {
      it('should call createEInvoice successfully', function(done) {
        //uncomment below and update the code to test createEInvoice
        //instance.createEInvoice(function(error) {
    ...
    describe('createFacturXEInvoice', function() {
      it('should call createFacturXEInvoice successfully', function(done) {
        //uncomment below and update the code to test createFacturXEInvoice
        //instance.createFacturXEInvoice(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('createXRechnungEInvoice', function() {
      it('should call createXRechnungEInvoice successfully', function(done) {
        //uncomment below and update the code to test createXRechnungEInvoice
        //instance.createXRechnungEInvoice(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getEInvoiceSchema', function() {
      it('should call getEInvoiceSchema successfully', function(done) {
        //uncomment below and update the code to test getEInvoiceSchema
        //instance.getEInvoiceSchema(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
