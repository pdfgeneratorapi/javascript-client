...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.TemplateLibraryApi();
  });
  ...
  describe('TemplateLibraryApi', function() {
    describe('getTemplateLibrary', function() {
      it('should call getTemplateLibrary successfully', function(done) {
        //uncomment below and update the code to test getTemplateLibrary
        //instance.getTemplateLibrary(function(error) {
    ...
    describe('getTemplateLibraryItem', function() {
      it('should call getTemplateLibraryItem successfully', function(done) {
        //uncomment below and update the code to test getTemplateLibraryItem
        //instance.getTemplateLibraryItem(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
