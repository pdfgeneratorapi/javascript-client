...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.ConversionApi();
  });
  ...
  describe('ConversionApi', function() {
    describe('convertHTML2PDF', function() {
      it('should call convertHTML2PDF successfully', function(done) {
        //uncomment below and update the code to test convertHTML2PDF
        //instance.convertHTML2PDF(function(error) {
    ...
    describe('convertPDF2Image', function() {
      it('should call convertPDF2Image successfully', function(done) {
        //uncomment below and update the code to test convertPDF2Image
        //instance.convertPDF2Image(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('convertURL2PDF', function() {
      it('should call convertURL2PDF successfully', function(done) {
        //uncomment below and update the code to test convertURL2PDF
        //instance.convertURL2PDF(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
