...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PDFGeneratorAPI.FormsApi();
  });
  ...
  describe('FormsApi', function() {
    ...
    describe('getForms', function() {
      it('should call getForms successfully', function(done) {
        //uncomment below and update the code to test getForms
        //instance.getForms(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('importForm', function() {
      it('should call importForm successfully', function(done) {
        //uncomment below and update the code to test importForm
        //instance.importForm(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('openFormBuilder', function() {
      it('should call openFormBuilder successfully', function(done) {
        //uncomment below and update the code to test openFormBuilder
        //instance.openFormBuilder(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('openFormBuilderForExistingForm', function() {
      it('should call openFormBuilderForExistingForm successfully', function(done) {
        //uncomment below and update the code to test openFormBuilderForExistingForm
        //instance.openFormBuilderForExistingForm(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('shareForm', function() {
      it('should call shareForm successfully', function(done) {
        //uncomment below and update the code to test shareForm
        //instance.shareForm(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
