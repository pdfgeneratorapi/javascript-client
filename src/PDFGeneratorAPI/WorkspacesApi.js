...
export default class WorkspacesApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/DeleteWorkspace204Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/DeleteWorkspace204Response}
     */
    deleteWorkspace(workspace_identifier, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = DeleteWorkspace204Response;
      return this.apiClient.callApi(
