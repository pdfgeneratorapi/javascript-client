...
export default class WorkspacesApi {
    ...
    */
     ...
     * @param {module:model/InlineObject8} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/InlineObject8}
     */
