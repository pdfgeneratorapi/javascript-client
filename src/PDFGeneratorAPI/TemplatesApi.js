...
export default class TemplatesApi {
    ...
    */
     ...
     * @callback module:PDFGeneratorAPI/TemplatesApi~getTemplateSchemaCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:PDFGeneratorAPI/TemplatesApi~getTemplateSchemaCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    getTemplateSchema(callback) {
      let postBody = null;
    ...
    /**
     * Callback function to receive the result of the importTemplate operation.
     * @callback module:PDFGeneratorAPI/TemplatesApi~importTemplateCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineObject16} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/ImportTemplateRequest} import_template_request Import a PDF via URL or base64 string as template
     * @param {module:PDFGeneratorAPI/TemplatesApi~importTemplateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineObject16}
     */
    importTemplate(import_template_request, callback) {
      let postBody = import_template_request;
      // verify the required parameter 'import_template_request' is set
      if (import_template_request === undefined || import_template_request === null) {
        throw new Error("Missing the required parameter 'import_template_request' when calling importTemplate");
      }
    ...
    /**
     * Callback function to receive the result of the validateTemplate operation.
     * @callback module:PDFGeneratorAPI/TemplatesApi~validateTemplateCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:model/TemplateDefinitionNew} template_definition_new Template configuration
     * @param {module:PDFGeneratorAPI/TemplatesApi~validateTemplateCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineObject1}
     */
    validateTemplate(template_definition_new, callback) {
      let postBody = template_definition_new;
      // verify the required parameter 'template_definition_new' is set
      if (template_definition_new === undefined || template_definition_new === null) {
        throw new Error("Missing the required parameter 'template_definition_new' when calling validateTemplate");
      }
