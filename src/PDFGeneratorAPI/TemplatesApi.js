...
export default class TemplatesApi {
    ...
    */
     ...
     * @callback module:PDFGeneratorAPI/TemplatesApi~mergeTemplateCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:model/String} opts.output Response format. (default to 'base64')
     * @param {module:PDFGeneratorAPI/TemplatesApi~mergeTemplateCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:PDFGeneratorAPI/TemplatesApi~mergeTemplatesCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineResponse2004} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/String} opts.format Document format. The zip option will return a ZIP file with PDF files. (default to 'pdf')
     * @param {module:model/String} opts.output Response format. (default to 'base64')
     * @param {module:PDFGeneratorAPI/TemplatesApi~mergeTemplatesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineResponse2004}
     */
