...
export default class TemplatesApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/ValidateTemplate200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/ValidateTemplate200Response}
     */
    validateTemplate(template_definition_new, callback) {
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = ValidateTemplate200Response;
      return this.apiClient.callApi(
