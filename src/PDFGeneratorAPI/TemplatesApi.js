...
export default class TemplatesApi {
    ...
    */
    ...
    copyTemplate(template_id, opts, callback) {
      ...
      let returnType = CreateTemplate200Response;
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/DeleteTemplate200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/DeleteTemplate200Response}
     */
    deleteTemplate(template_id, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = DeleteTemplate200Response;
      return this.apiClient.callApi(
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/GetEditorUrl200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {module:model/String} [language] Specify the editor UI language. Defaults to organization editor language.
     ...
     * data is of type: {@link module:model/GetEditorUrl200Response}
     */
    getEditorUrl(template_id, body, opts, callback) {
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = GetEditorUrl200Response;
      return this.apiClient.callApi(
