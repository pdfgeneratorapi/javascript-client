...
export default class TemplateVersionsApi {
    ...
    /**
    * Constructs a new TemplateVersionsApi. 
    * @alias module:PDFGeneratorAPI/TemplateVersionsApi
    * @class
    ...
    */
     ...
     * @callback module:PDFGeneratorAPI/TemplateVersionsApi~deleteTemplateVersionCallback
     ...
     * @param {Number} template_version Unique ID of the template version.
     * @param {module:PDFGeneratorAPI/TemplateVersionsApi~deleteTemplateVersionCallback} callback The callback function, accepting three arguments: error, data, response
     */
    deleteTemplateVersion(template_id, template_version, callback) {
      let postBody = null;
      // verify the required parameter 'template_id' is set
      if (template_id === undefined || template_id === null) {
        throw new Error("Missing the required parameter 'template_id' when calling deleteTemplateVersion");
      }
      // verify the required parameter 'template_version' is set
      if (template_version === undefined || template_version === null) {
        throw new Error("Missing the required parameter 'template_version' when calling deleteTemplateVersion");
      }
      ...
      return this.apiClient.callApi(
        '/templates/{templateId}/versions/{templateVersion}', 'DELETE',
    ...
    /**
     * Callback function to receive the result of the getTemplateVersion operation.
     * @callback module:PDFGeneratorAPI/TemplateVersionsApi~getTemplateVersionCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Number} template_id Template unique identifier
     * @param {Number} template_version Unique ID of the template version.
     * @param {module:PDFGeneratorAPI/TemplateVersionsApi~getTemplateVersionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineObject16}
     */
    getTemplateVersion(template_id, template_version, callback) {
      let postBody = null;
      // verify the required parameter 'template_id' is set
      if (template_id === undefined || template_id === null) {
        throw new Error("Missing the required parameter 'template_id' when calling getTemplateVersion");
      }
      // verify the required parameter 'template_version' is set
      if (template_version === undefined || template_version === null) {
        throw new Error("Missing the required parameter 'template_version' when calling getTemplateVersion");
      }
      ...
      return this.apiClient.callApi(
        '/templates/{templateId}/versions/{templateVersion}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * @callback module:PDFGeneratorAPI/TemplateVersionsApi~listTemplateVersionsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/TemplateVersionCollection} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:PDFGeneratorAPI/TemplateVersionsApi~listTemplateVersionsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/TemplateVersionCollection}
     */
    listTemplateVersions(template_id, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'template_id' is set
      if (template_id === undefined || template_id === null) {
        throw new Error("Missing the required parameter 'template_id' when calling listTemplateVersions");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = TemplateVersionCollection;
      return this.apiClient.callApi(
        '/templates/{templateId}/versions', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the promoteTemplateVersion operation.
     * @callback module:PDFGeneratorAPI/TemplateVersionsApi~promoteTemplateVersionCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PromoteTemplateVersion200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} template_id Template unique identifier
     * @param {Number} template_version Unique ID of the template version.
     * @param {module:PDFGeneratorAPI/TemplateVersionsApi~promoteTemplateVersionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PromoteTemplateVersion200Response}
     */
    promoteTemplateVersion(template_id, template_version, callback) {
      let postBody = null;
      // verify the required parameter 'template_id' is set
      if (template_id === undefined || template_id === null) {
        throw new Error("Missing the required parameter 'template_id' when calling promoteTemplateVersion");
      }
      // verify the required parameter 'template_version' is set
      if (template_version === undefined || template_version === null) {
        throw new Error("Missing the required parameter 'template_version' when calling promoteTemplateVersion");
      }
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = PromoteTemplateVersion200Response;
      return this.apiClient.callApi(
        '/templates/{templateId}/versions/{templateVersion}/promote', 'PUT',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
