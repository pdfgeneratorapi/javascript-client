...
export default class AssetsApi {
    ...
    * @alias module:PDFGeneratorAPI/AssetsApi
    * @class
    ...
    */
     ...
     * @callback module:PDFGeneratorAPI/AssetsApi~generateQRCodeCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GenerateQRCode201Response} data The data returned by the service call.
     ...
     * @param {module:model/GenerateQRCodeRequest} generate_qr_code_request QR Code configuration
     * @param {module:PDFGeneratorAPI/AssetsApi~generateQRCodeCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GenerateQRCode201Response}
     */
    generateQRCode(generate_qr_code_request, callback) {
      let postBody = generate_qr_code_request;
      // verify the required parameter 'generate_qr_code_request' is set
      if (generate_qr_code_request === undefined || generate_qr_code_request === null) {
        throw new Error("Missing the required parameter 'generate_qr_code_request' when calling generateQRCode");
      }
      ...
      let returnType = GenerateQRCode201Response;
