...
export default class ConversionApi {
    ...
    */
     ...
     */
    convertHTML2PDF(convert_html2_pdf_request, callback) {
      let postBody = convert_html2_pdf_request;
    ...
    /**
     * Callback function to receive the result of the convertPDF2Image operation.
     * @callback module:PDFGeneratorAPI/ConversionApi~convertPDF2ImageCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineObject10} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/ConvertPDF2ImageRequest} convert_pdf2_image_request 
     * @param {module:PDFGeneratorAPI/ConversionApi~convertPDF2ImageCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineObject10}
     */
    convertPDF2Image(convert_pdf2_image_request, callback) {
      let postBody = convert_pdf2_image_request;
      // verify the required parameter 'convert_pdf2_image_request' is set
      if (convert_pdf2_image_request === undefined || convert_pdf2_image_request === null) {
        throw new Error("Missing the required parameter 'convert_pdf2_image_request' when calling convertPDF2Image");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = InlineObject10;
      return this.apiClient.callApi(
        '/conversion/pdf2image', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
     ...
     * data is of type: {@link module:model/InlineObject9}
     */
    convertURL2PDF(convert_url2_pdf_request, callback) {
      let postBody = convert_url2_pdf_request;
