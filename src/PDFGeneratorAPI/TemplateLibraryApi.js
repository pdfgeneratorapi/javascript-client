...
export default class TemplateLibraryApi {
    ...
    /**
    * Constructs a new TemplateLibraryApi. 
    * @alias module:PDFGeneratorAPI/TemplateLibraryApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the getTemplateLibrary operation.
     * @callback module:PDFGeneratorAPI/TemplateLibraryApi~getTemplateLibraryCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetTemplateLibrary200Response} data The data returned by the service call.
     ...
     * @param {module:PDFGeneratorAPI/TemplateLibraryApi~getTemplateLibraryCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetTemplateLibrary200Response}
     */
    getTemplateLibrary(opts, callback) {
      opts = opts || {};
      let postBody = null;
      ...
      let returnType = GetTemplateLibrary200Response;
      return this.apiClient.callApi(
        '/templates/library', 'GET',
    ...
    /**
     * Callback function to receive the result of the getTemplateLibraryItem operation.
     * @callback module:PDFGeneratorAPI/TemplateLibraryApi~getTemplateLibraryItemCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:PDFGeneratorAPI/TemplateLibraryApi~getTemplateLibraryItemCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineObject16}
     */
    getTemplateLibraryItem(public_id, callback) {
      let postBody = null;
      // verify the required parameter 'public_id' is set
      if (public_id === undefined || public_id === null) {
        throw new Error("Missing the required parameter 'public_id' when calling getTemplateLibraryItem");
      }
      ...
      return this.apiClient.callApi(
        '/templates/library/{publicId}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
