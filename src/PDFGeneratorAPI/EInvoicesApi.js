...
export default class EInvoicesApi {
    ...
    * @alias module:PDFGeneratorAPI/EInvoicesApi
    * @class
    ...
    */
     ...
     * @callback module:PDFGeneratorAPI/EInvoicesApi~createEInvoiceCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineObject} data The data returned by the service call.
     ...
     * @param {module:model/CreateEInvoiceRequest} create_e_invoice_request eInvoice conversion
     * @param {module:PDFGeneratorAPI/EInvoicesApi~createEInvoiceCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineObject}
     */
    createEInvoice(create_e_invoice_request, callback) {
      let postBody = create_e_invoice_request;
      // verify the required parameter 'create_e_invoice_request' is set
      if (create_e_invoice_request === undefined || create_e_invoice_request === null) {
        throw new Error("Missing the required parameter 'create_e_invoice_request' when calling createEInvoice");
      }
    ...
    /**
     * Callback function to receive the result of the createFacturXEInvoice operation.
     * @callback module:PDFGeneratorAPI/EInvoicesApi~createFacturXEInvoiceCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:model/CreateFacturXEInvoiceRequest} create_factur_xe_invoice_request eInvoice conversion
     * @param {module:PDFGeneratorAPI/EInvoicesApi~createFacturXEInvoiceCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineObject9}
     */
    createFacturXEInvoice(create_factur_xe_invoice_request, callback) {
      let postBody = create_factur_xe_invoice_request;
      // verify the required parameter 'create_factur_xe_invoice_request' is set
      if (create_factur_xe_invoice_request === undefined || create_factur_xe_invoice_request === null) {
        throw new Error("Missing the required parameter 'create_factur_xe_invoice_request' when calling createFacturXEInvoice");
      }
    ...
    /**
     * Callback function to receive the result of the createXRechnungEInvoice operation.
     * @callback module:PDFGeneratorAPI/EInvoicesApi~createXRechnungEInvoiceCallback
     * @param {String} error Error message, if any.
     * @param {module:model/InlineObject} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/CreateEInvoiceRequest} create_e_invoice_request eInvoice conversion
     * @param {module:PDFGeneratorAPI/EInvoicesApi~createXRechnungEInvoiceCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/InlineObject}
     */
    createXRechnungEInvoice(create_e_invoice_request, callback) {
      let postBody = create_e_invoice_request;
      // verify the required parameter 'create_e_invoice_request' is set
      if (create_e_invoice_request === undefined || create_e_invoice_request === null) {
        throw new Error("Missing the required parameter 'create_e_invoice_request' when calling createXRechnungEInvoice");
      }
    ...
    /**
     * Callback function to receive the result of the getEInvoiceSchema operation.
     * @callback module:PDFGeneratorAPI/EInvoicesApi~getEInvoiceSchemaCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:PDFGeneratorAPI/EInvoicesApi~getEInvoiceSchemaCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Object}
     */
    getEInvoiceSchema(callback) {
      let postBody = null;
