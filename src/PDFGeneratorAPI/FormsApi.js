...
export default class FormsApi {
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createFrom operation.
     * @callback module:PDFGeneratorAPI/FormsApi~createFromCallback
     * @param {String} error Error message, if any.
     * @param {module:model/CreateFrom201Response} data The data returned by the service call.
     ...
     * @param {module:PDFGeneratorAPI/FormsApi~createFromCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CreateFrom201Response}
     */
    createFrom(form_configuration_new, callback) {
      ...
      if (form_configuration_new === undefined || form_configuration_new === null) {
        throw new Error("Missing the required parameter 'form_configuration_new' when calling createFrom");
      }
      ...
      let returnType = CreateFrom201Response;
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/GetForms200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/GetForms200Response}
     */
    getForms(opts, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = GetForms200Response;
      return this.apiClient.callApi(
        '/forms', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/ShareForm201Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/ShareForm201Response}
     */
    shareForm(form_id, callback) {
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = ShareForm201Response;
      return this.apiClient.callApi(
