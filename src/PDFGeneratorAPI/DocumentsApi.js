...
export default class DocumentsApi {
    ...
    */
     ...
     * @param {module:model/String} [format] Document format. The zip option will return a ZIP file with PDF files.
     * @param {module:model/String} [output] Response format. \"I\" is used to return the file inline. With the url option, the document is stored for 30 days and automatically deleted.
