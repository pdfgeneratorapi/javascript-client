...
import GenerateDocumentAsynchronous200Response from '../model/GenerateDocumentAsynchronous200Response';
...
export default class DocumentsApi {
    ...
    */
    ...
    generateDocumentAsynchronous(generate_document_asynchronous_request, callback) {
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = GenerateDocumentAsynchronous200Response;
      return this.apiClient.callApi(
