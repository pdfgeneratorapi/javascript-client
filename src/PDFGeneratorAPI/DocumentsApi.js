...
export default class DocumentsApi {
    ...
    */
     ...
     * @param {module:model/MergeTemplate200Response} data The data returned by the service call.
     ...
     * @param {Object.<String, Object>} body Data used to generate the PDF. This can be JSON encoded string or a public URL to your JSON file.
     * @param {Object} opts Optional parameters
     * @param {String} opts.name Document name, returned in the meta data.
     * @param {module:model/String} opts.format Document format. The zip option will return a ZIP file with PDF files.
     * @param {module:model/String} opts.output Response format. \"I\" is used to return the file inline. With the url option, the document is stored for 30 days and automatically deleted.
     ...
     * data is of type: {@link module:model/MergeTemplate200Response}
     */
    mergeTemplate(template_id, body, opts, callback) {
      opts = opts || {};
      let postBody = body;
      ...
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling mergeTemplate");
      }
      ...
      let returnType = MergeTemplate200Response;
     ...
     * @param {Array.<module:model/BatchDataInner>} batch_data_inner Data used to specify templates and data objects which are used to merge the template
     * @param {Object} opts Optional parameters
     * @param {String} opts.name Document name, returned in the meta data.
     * @param {module:model/String} opts.format Document format. The zip option will return a ZIP file with PDF files.
     * @param {module:model/String} opts.output Response format. \"I\" is used to return the file inline. With the url option, the document is stored for 30 days and automatically deleted.
     ...
     * data is of type: {@link module:model/MergeTemplate200Response}
     */
    mergeTemplates(batch_data_inner, opts, callback) {
      opts = opts || {};
      let postBody = batch_data_inner;
      // verify the required parameter 'batch_data_inner' is set
      if (batch_data_inner === undefined || batch_data_inner === null) {
        throw new Error("Missing the required parameter 'batch_data_inner' when calling mergeTemplates");
      }
