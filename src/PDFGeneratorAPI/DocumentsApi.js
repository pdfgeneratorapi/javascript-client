...
export default class DocumentsApi {
    ...
    */
     ...
     * @param {module:model/String} opts.output Response format. \"I\" is used to return the file inline. With the url option, the document is stored for 30 days and automatically deleted. (default to 'base64')
