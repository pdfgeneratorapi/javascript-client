...
export default class MiscApi {
    ...
    * @alias module:PDFGeneratorAPI/MiscApi
    * @class
    ...
    */
     ...
     * @callback module:PDFGeneratorAPI/MiscApi~getStatusCallback
     ...
     * @param {module:PDFGeneratorAPI/MiscApi~getStatusCallback} callback The callback function, accepting three arguments: error, data, response
