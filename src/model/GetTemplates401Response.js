...
/**
 * The GetTemplates401Response model module.
 * @module model/GetTemplates401Response
 * @version 3.1.2
 */
class GetTemplates401Response {
    /**
     * Constructs a new <code>GetTemplates401Response</code>.
     * @alias module:model/GetTemplates401Response
     */
    constructor() { 
        
        GetTemplates401Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetTemplates401Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetTemplates401Response} obj Optional instance to populate.
     * @return {module:model/GetTemplates401Response} The populated <code>GetTemplates401Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetTemplates401Response();
    ...
    /**
     * Validates the JSON data with respect to <code>GetTemplates401Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTemplates401Response</code>.
     */
...
/**
 * Error description
 * @member {module:model/GetTemplates401Response.ErrorEnum} error
 */
GetTemplates401Response.prototype['error'] = undefined;

/**
 * HTTP Error code
 * @member {Number} status
 */
GetTemplates401Response.prototype['status'] = undefined;
 ...
 * @readonly
 */
GetTemplates401Response['ErrorEnum'] = {

    /**
     * value: "Authentication failed: request expired"
     * @const
     */
    "Authentication failed: request expired": "Authentication failed: request expired",

    /**
     * value: "Authentication failed: signature or secret missing"
     * @const
     */
    "Authentication failed: signature or secret missing": "Authentication failed: signature or secret missing",

    /**
     * value: "Authentication failed: workspace missing"
     * @const
     */
    "Authentication failed: workspace missing": "Authentication failed: workspace missing",

    /**
     * value: "Authentication failed: key missing"
     * @const
     */
    "Authentication failed: key missing": "Authentication failed: key missing",

    /**
     * value: "Authentication failed: property iss (issuer) missing in JWT"
     * @const
     */
    "Authentication failed: property iss (issuer) missing in JWT": "Authentication failed: property iss (issuer) missing in JWT",

    /**
     * value: "Authentication failed: property sub (subject) missing in JWT"
     * @const
     */
    "Authentication failed: property sub (subject) missing in JWT": "Authentication failed: property sub (subject) missing in JWT",

    /**
     * value: "Authentication failed: property exp (expiration time) missing in JWT"
     * @const
     */
    "Authentication failed: property exp (expiration time) missing in JWT": "Authentication failed: property exp (expiration time) missing in JWT",

    /**
     * value: "Authentication failed: invalid iss (issuer)"
     * @const
     */
    "Authentication failed: invalid iss (issuer)": "Authentication failed: invalid iss (issuer)",

    /**
     * value: "Authentication failed: incorrect signature"
     * @const
     */
    "Authentication failed: incorrect signature": "Authentication failed: incorrect signature",
...
export default GetTemplates401Response;
