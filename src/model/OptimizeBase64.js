...
/**
 * The OptimizeBase64 model module.
 * @module model/OptimizeBase64
 * @version 8.0.26
 */
class OptimizeBase64 {
    /**
     * Constructs a new <code>OptimizeBase64</code>.
     * @alias module:model/OptimizeBase64
     * @param file_base64 {String} PDF document in base64 encoded string format
     */
    constructor(file_base64) { 
        
        OptimizeBase64.initialize(this, file_base64);
    }
    ...
    /**
     * Constructs a <code>OptimizeBase64</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OptimizeBase64} obj Optional instance to populate.
     * @return {module:model/OptimizeBase64} The populated <code>OptimizeBase64</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OptimizeBase64();
    ...
    /**
     * Validates the JSON data with respect to <code>OptimizeBase64</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OptimizeBase64</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OptimizeBase64.RequiredProperties) {
...
OptimizeBase64.RequiredProperties = ["file_base64"];

/**
 * PDF document in base64 encoded string format
 * @member {String} file_base64
 */
OptimizeBase64.prototype['file_base64'] = undefined;

/**
 * Name for the PDF file
 * @member {String} name
 */
OptimizeBase64.prototype['name'] = undefined;

/**
 * Returned document output format
 * @member {module:model/OptimizeBase64.OutputEnum} output
 * @default 'base64'
 */
OptimizeBase64.prototype['output'] = 'base64';
