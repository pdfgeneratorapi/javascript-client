    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('transform')) {
                obj['transform'] = ApiClient.convertToType(data['transform'], [Object]);
            }
        }
        return obj;
    }
...
/**
 * @member {Array.<Object>} transform
 */
TemplateDefinitionNewDataSettings.prototype['transform'] = undefined;
