...
/**
 * The GenerateViewerUrl200ResponseMeta model module.
 * @module model/GenerateViewerUrl200ResponseMeta
 * @version 8.0.29
 */
class GenerateViewerUrl200ResponseMeta {
    /**
     * Constructs a new <code>GenerateViewerUrl200ResponseMeta</code>.
     * @alias module:model/GenerateViewerUrl200ResponseMeta
     */
    constructor() { 
        
        GenerateViewerUrl200ResponseMeta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GenerateViewerUrl200ResponseMeta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateViewerUrl200ResponseMeta} obj Optional instance to populate.
     * @return {module:model/GenerateViewerUrl200ResponseMeta} The populated <code>GenerateViewerUrl200ResponseMeta</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateViewerUrl200ResponseMeta();
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateViewerUrl200ResponseMeta</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateViewerUrl200ResponseMeta</code>.
     */
 ...
 * @member {String} name
 */
GenerateViewerUrl200ResponseMeta.prototype['name'] = undefined;

/**
 * @member {String} display_name
 */
GenerateViewerUrl200ResponseMeta.prototype['display_name'] = undefined;

/**
 * @member {String} public_id
 */
GenerateViewerUrl200ResponseMeta.prototype['public_id'] = undefined;
...
export default GenerateViewerUrl200ResponseMeta;
