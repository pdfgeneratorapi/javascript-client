...
import PublicTemplateLibraryItem from './PublicTemplateLibraryItem';
...
class GetTemplateLibrary200Response {
    /**
     * Constructs a new <code>GetTemplateLibrary200Response</code>.
     * @alias module:model/GetTemplateLibrary200Response
     */
    constructor() { 
        
        GetTemplateLibrary200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetTemplateLibrary200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetTemplateLibrary200Response} obj Optional instance to populate.
     * @return {module:model/GetTemplateLibrary200Response} The populated <code>GetTemplateLibrary200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetTemplateLibrary200Response();

            if (data.hasOwnProperty('response')) {
                obj['response'] = ApiClient.convertToType(data['response'], [PublicTemplateLibraryItem]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetTemplateLibrary200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTemplateLibrary200Response</code>.
     */
    static validateJSON(data) {
        if (data['response']) { // data not null
            ...
            for (const item of data['response']) {
                PublicTemplateLibraryItem.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/PublicTemplateLibraryItem>} response
 */
GetTemplateLibrary200Response.prototype['response'] = undefined;
...
export default GetTemplateLibrary200Response;
