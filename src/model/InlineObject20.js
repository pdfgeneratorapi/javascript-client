...
import InlineObject20Meta from './InlineObject20Meta';
...
class InlineObject20 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = InlineObject20Meta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['meta']) { // data not null
          InlineObject20Meta.validateJSON(data['meta']);
        }
...
/**
 * @member {module:model/InlineObject20Meta} meta
 */
