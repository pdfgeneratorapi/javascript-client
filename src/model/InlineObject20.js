...
import InlineObject20Response from './InlineObject20Response';
...
class InlineObject20 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('response')) {
                obj['response'] = InlineObject20Response.constructFromObject(data['response']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObject20</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObject20</code>.
     */
    static validateJSON(data) {
        // validate the optional field `response`
        if (data['response']) { // data not null
          InlineObject20Response.validateJSON(data['response']);
        }
...
/**
 * @member {module:model/InlineObject20Response} response
 */
InlineObject20.prototype['response'] = undefined;
