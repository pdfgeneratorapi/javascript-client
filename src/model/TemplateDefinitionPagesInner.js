...
class TemplateDefinitionPagesInner {
    /**
     * Constructs a new <code>TemplateDefinitionPagesInner</code>.
     * @alias module:model/TemplateDefinitionPagesInner
     */
    constructor() { 
        
        TemplateDefinitionPagesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TemplateDefinitionPagesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TemplateDefinitionPagesInner} obj Optional instance to populate.
     * @return {module:model/TemplateDefinitionPagesInner} The populated <code>TemplateDefinitionPagesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TemplateDefinitionPagesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>TemplateDefinitionPagesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplateDefinitionPagesInner</code>.
     */
 ...
 * @member {Number} width
 */
TemplateDefinitionPagesInner.prototype['width'] = undefined;

/**
 * Page height in units
 * @member {Number} height
 */
TemplateDefinitionPagesInner.prototype['height'] = undefined;

/**
 * @member {module:model/TemplateDefinitionNewPagesInnerMargins} margins
 */
TemplateDefinitionPagesInner.prototype['margins'] = undefined;

/**
 * @member {Array.<Object>} components
 */
TemplateDefinitionPagesInner.prototype['components'] = undefined;
...
export default TemplateDefinitionPagesInner;
