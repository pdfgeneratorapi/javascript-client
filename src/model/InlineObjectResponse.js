...
/**
 * The InlineObjectResponse model module.
 * @module model/InlineObjectResponse
 * @version 4.0.8
 */
class InlineObjectResponse {
    /**
     * Constructs a new <code>InlineObjectResponse</code>.
     * @alias module:model/InlineObjectResponse
     */
    constructor() { 
        
        InlineObjectResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineObjectResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineObjectResponse} obj Optional instance to populate.
     * @return {module:model/InlineObjectResponse} The populated <code>InlineObjectResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineObjectResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObjectResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObjectResponse</code>.
     */
 ...
 */
InlineObjectResponse.prototype['success'] = undefined;
...
export default InlineObjectResponse;
