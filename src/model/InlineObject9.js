...
import InlineObject9Meta from './InlineObject9Meta';
...
class InlineObject9 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = InlineObject9Meta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObject9</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObject9</code>.
     */
    static validateJSON(data) {
        ...
        if (data['meta']) { // data not null
          InlineObject9Meta.validateJSON(data['meta']);
        }
 ...
 */
InlineObject9.prototype['response'] = undefined;

/**
 * @member {module:model/InlineObject9Meta} meta
 */
