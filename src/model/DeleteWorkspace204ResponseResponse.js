...
/**
 * The DeleteWorkspace204ResponseResponse model module.
 * @module model/DeleteWorkspace204ResponseResponse
 * @version 4.0.4
 */
class DeleteWorkspace204ResponseResponse {
    /**
     * Constructs a new <code>DeleteWorkspace204ResponseResponse</code>.
     * @alias module:model/DeleteWorkspace204ResponseResponse
     */
    constructor() { 
        
        DeleteWorkspace204ResponseResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteWorkspace204ResponseResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteWorkspace204ResponseResponse} obj Optional instance to populate.
     * @return {module:model/DeleteWorkspace204ResponseResponse} The populated <code>DeleteWorkspace204ResponseResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteWorkspace204ResponseResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteWorkspace204ResponseResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteWorkspace204ResponseResponse</code>.
     */
 ...
 */
DeleteWorkspace204ResponseResponse.prototype['success'] = undefined;
...
export default DeleteWorkspace204ResponseResponse;
