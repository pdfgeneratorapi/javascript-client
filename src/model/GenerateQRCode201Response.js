...
import GenerateQRCode201ResponseMeta from './GenerateQRCode201ResponseMeta';
...
class GenerateQRCode201Response {
    /**
     * Constructs a new <code>GenerateQRCode201Response</code>.
     * @alias module:model/GenerateQRCode201Response
     */
    constructor() { 
        
        GenerateQRCode201Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GenerateQRCode201Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateQRCode201Response} obj Optional instance to populate.
     * @return {module:model/GenerateQRCode201Response} The populated <code>GenerateQRCode201Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateQRCode201Response();

            if (data.hasOwnProperty('response')) {
                obj['response'] = ApiClient.convertToType(data['response'], 'String');
            }
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = GenerateQRCode201ResponseMeta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateQRCode201Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateQRCode201Response</code>.
     */
    static validateJSON(data) {
        ...
        if (data['meta']) { // data not null
          GenerateQRCode201ResponseMeta.validateJSON(data['meta']);
        }
...
/**
 * Base64 encoded image if the output=base64. Raw image string if output=file is used
 * @member {String} response
 */
GenerateQRCode201Response.prototype['response'] = undefined;

/**
 * @member {module:model/GenerateQRCode201ResponseMeta} meta
 */
GenerateQRCode201Response.prototype['meta'] = undefined;
...
export default GenerateQRCode201Response;
