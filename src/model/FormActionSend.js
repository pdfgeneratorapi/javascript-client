...
import FormActionSendSendDocument from './FormActionSendSendDocument';
...
class FormActionSend {
    /**
     * Constructs a new <code>FormActionSend</code>.
     * Sends the generated document via HTTP POST request to the specified URL.
     * @alias module:model/FormActionSend
     */
    constructor() { 
        
        FormActionSend.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FormActionSend</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FormActionSend} obj Optional instance to populate.
     * @return {module:model/FormActionSend} The populated <code>FormActionSend</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FormActionSend();

            if (data.hasOwnProperty('send_document')) {
                obj['send_document'] = FormActionSendSendDocument.constructFromObject(data['send_document']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FormActionSend</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FormActionSend</code>.
     */
    static validateJSON(data) {
        // validate the optional field `send_document`
        if (data['send_document']) { // data not null
          FormActionSendSendDocument.validateJSON(data['send_document']);
        }
...
/**
 * @member {module:model/FormActionSendSendDocument} send_document
 */
FormActionSend.prototype['send_document'] = undefined;
