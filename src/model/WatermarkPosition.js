...
* @readonly
*/
export default class WatermarkPosition {
    ...
    /**
    * Returns a <code>WatermarkPosition</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/WatermarkPosition} The enum <code>WatermarkPosition</code> value.
    */
