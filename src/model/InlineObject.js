...
import InlineObjectMeta from './InlineObjectMeta';
...
class InlineObject {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = InlineObjectMeta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['meta']) { // data not null
          InlineObjectMeta.validateJSON(data['meta']);
        }
...
/**
 * Base64 encoded XML document if the output=base64 is used.
 * @member {String} response
 */
InlineObject.prototype['response'] = undefined;

/**
 * @member {module:model/InlineObjectMeta} meta
 */
