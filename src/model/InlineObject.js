...
import InlineObjectResponse from './InlineObjectResponse';
...
class InlineObject {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('response')) {
                obj['response'] = InlineObjectResponse.constructFromObject(data['response']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['response']) { // data not null
          InlineObjectResponse.validateJSON(data['response']);
        }
...
/**
 * @member {module:model/InlineObjectResponse} response
 */
