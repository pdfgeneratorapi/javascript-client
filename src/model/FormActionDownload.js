...
/**
 * The FormActionDownload model module.
 * @module model/FormActionDownload
 * @version 4.0.8
 */
class FormActionDownload {
    /**
     * Constructs a new <code>FormActionDownload</code>.
     * Key-value pair of action configuration.
     * @alias module:model/FormActionDownload
     */
    constructor() { 
        
        FormActionDownload.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FormActionDownload</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FormActionDownload} obj Optional instance to populate.
     * @return {module:model/FormActionDownload} The populated <code>FormActionDownload</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FormActionDownload();

            if (data.hasOwnProperty('download_document')) {
                obj['download_document'] = ApiClient.convertToType(data['download_document'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FormActionDownload</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FormActionDownload</code>.
     */
...
/**
 * @member {Boolean} download_document
 */
FormActionDownload.prototype['download_document'] = undefined;
...
export default FormActionDownload;
