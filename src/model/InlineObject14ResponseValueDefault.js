...
class InlineObject14ResponseValueDefault {
    /**
     * Constructs a new <code>InlineObject14ResponseValueDefault</code>.
     * Default field value
     * @alias module:model/InlineObject14ResponseValueDefault
     * @param {(module:model/Boolean|module:model/String|module:model/[String])} instance The actual instance to initialize InlineObject14ResponseValueDefault.
     */
    constructor(instance = null) {
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `InlineObject14ResponseValueDefault` with oneOf schemas Boolean, String, [String]. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `InlineObject14ResponseValueDefault` with oneOf schemas Boolean, String, [String]. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>InlineObject14ResponseValueDefault</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineObject14ResponseValueDefault} obj Optional instance to populate.
     * @return {module:model/InlineObject14ResponseValueDefault} The populated <code>InlineObject14ResponseValueDefault</code> instance.
     */
    static constructFromObject(data, obj) {
        return new InlineObject14ResponseValueDefault(data);
    }
    ...
    setActualInstance(obj) {
       this.actualInstance = InlineObject14ResponseValueDefault.constructFromObject(obj).getActualInstance();
    }
    ...
    /**
     * Create an instance of InlineObject14ResponseValueDefault from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/InlineObject14ResponseValueDefault} An instance of InlineObject14ResponseValueDefault.
     */
    static fromJSON = function(json_string){
        return InlineObject14ResponseValueDefault.constructFromObject(JSON.parse(json_string));
    }
}


InlineObject14ResponseValueDefault.OneOf = ["Boolean", "String", "[String]"];

export default InlineObject14ResponseValueDefault;
