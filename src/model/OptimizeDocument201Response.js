...
import OptimizeDocument201ResponseMeta from './OptimizeDocument201ResponseMeta';

/**
 * The OptimizeDocument201Response model module.
 * @module model/OptimizeDocument201Response
 * @version 4.0.12
 */
class OptimizeDocument201Response {
    /**
     * Constructs a new <code>OptimizeDocument201Response</code>.
     * @alias module:model/OptimizeDocument201Response
     */
    constructor() { 
        
        OptimizeDocument201Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OptimizeDocument201Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OptimizeDocument201Response} obj Optional instance to populate.
     * @return {module:model/OptimizeDocument201Response} The populated <code>OptimizeDocument201Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OptimizeDocument201Response();

            if (data.hasOwnProperty('response')) {
                obj['response'] = ApiClient.convertToType(data['response'], 'String');
            }
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = OptimizeDocument201ResponseMeta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>OptimizeDocument201Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OptimizeDocument201Response</code>.
     */
    static validateJSON(data) {
        ...
        if (data['meta']) { // data not null
          OptimizeDocument201ResponseMeta.validateJSON(data['meta']);
        }
 ...
 */
OptimizeDocument201Response.prototype['response'] = undefined;

/**
 * @member {module:model/OptimizeDocument201ResponseMeta} meta
 */
OptimizeDocument201Response.prototype['meta'] = undefined;
...
export default OptimizeDocument201Response;
