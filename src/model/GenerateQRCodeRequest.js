...
/**
 * The GenerateQRCodeRequest model module.
 * @module model/GenerateQRCodeRequest
 * @version 4.0.25
 */
class GenerateQRCodeRequest {
    /**
     * Constructs a new <code>GenerateQRCodeRequest</code>.
     * @alias module:model/GenerateQRCodeRequest
     * @param content {String} The content which is used to generate QR code
     */
    constructor(content) { 
        
        GenerateQRCodeRequest.initialize(this, content);
    }
    ...
    /**
     * Constructs a <code>GenerateQRCodeRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateQRCodeRequest} obj Optional instance to populate.
     * @return {module:model/GenerateQRCodeRequest} The populated <code>GenerateQRCodeRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateQRCodeRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateQRCodeRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateQRCodeRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GenerateQRCodeRequest.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['logo_base64'] && !(typeof data['logo_base64'] === 'string' || data['logo_base64'] instanceof String)) {
            throw new Error("Expected the field `logo_base64` to be a primitive type in the JSON string but got " + data['logo_base64']);
        }
        // ensure the json data is a string
...
GenerateQRCodeRequest.RequiredProperties = ["content"];

/**
 * The content which is used to generate QR code
 * @member {String} content
 */
GenerateQRCodeRequest.prototype['content'] = undefined;

/**
 * QR code in hexadecimal format
 * @member {String} color
 * @default '#000000'
 */
GenerateQRCodeRequest.prototype['color'] = '#000000';

/**
 * A logo as a base64 image string to add on the QR code
 * @member {String} logo_base64
 */
GenerateQRCodeRequest.prototype['logo_base64'] = undefined;

/**
 * A logo URL to an image to add on the QR code
 * @member {String} logo_url
 */
GenerateQRCodeRequest.prototype['logo_url'] = undefined;

/**
 * Response format
 * @member {module:model/GenerateQRCodeRequest.OutputEnum} output
 * @default 'base64'
 */
GenerateQRCodeRequest.prototype['output'] = 'base64';
 ...
 * @readonly
 */
GenerateQRCodeRequest['OutputEnum'] = {
...
export default GenerateQRCodeRequest;
