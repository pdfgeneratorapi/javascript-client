...
import ExtractFormFields200ResponseResponseValue from './ExtractFormFields200ResponseResponseValue';

/**
 * The ExtractFormFields200Response model module.
 * @module model/ExtractFormFields200Response
 * @version 4.0.12
 */
class ExtractFormFields200Response {
    /**
     * Constructs a new <code>ExtractFormFields200Response</code>.
     * @alias module:model/ExtractFormFields200Response
     */
    constructor() { 
        
        ExtractFormFields200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ExtractFormFields200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExtractFormFields200Response} obj Optional instance to populate.
     * @return {module:model/ExtractFormFields200Response} The populated <code>ExtractFormFields200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExtractFormFields200Response();

            if (data.hasOwnProperty('response')) {
                obj['response'] = ApiClient.convertToType(data['response'], {'String': ExtractFormFields200ResponseResponseValue});
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ExtractFormFields200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ExtractFormFields200Response</code>.
     */
...
/**
 * Form fields extracted from the PDF document
 * @member {Object.<String, module:model/ExtractFormFields200ResponseResponseValue>} response
 */
ExtractFormFields200Response.prototype['response'] = undefined;
...
export default ExtractFormFields200Response;
