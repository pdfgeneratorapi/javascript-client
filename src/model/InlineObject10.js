...
import InlineObject10Meta from './InlineObject10Meta';
...
class InlineObject10 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = InlineObject10Meta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObject10</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObject10</code>.
     */
    static validateJSON(data) {
        ...
        if (data['meta']) { // data not null
          InlineObject10Meta.validateJSON(data['meta']);
        }
...
/**
 * Array of base64 encoded images, one per converted page.
 * @member {Array.<String>} response
 */
InlineObject10.prototype['response'] = undefined;

/**
 * @member {module:model/InlineObject10Meta} meta
 */
