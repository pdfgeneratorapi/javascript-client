...
import InlineObject12MetaStats from './InlineObject12MetaStats';

/**
 * The InlineObject12Meta model module.
 * @module model/InlineObject12Meta
 * @version 4.0.25
 */
class InlineObject12Meta {
    /**
     * Constructs a new <code>InlineObject12Meta</code>.
     * @alias module:model/InlineObject12Meta
     */
    constructor() { 
        
        InlineObject12Meta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineObject12Meta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineObject12Meta} obj Optional instance to populate.
     * @return {module:model/InlineObject12Meta} The populated <code>InlineObject12Meta</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineObject12Meta();
            ...
            if (data.hasOwnProperty('stats')) {
                obj['stats'] = InlineObject12MetaStats.constructFromObject(data['stats']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObject12Meta</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObject12Meta</code>.
     */
    static validateJSON(data) {
        ...
        if (data['stats']) { // data not null
          InlineObject12MetaStats.validateJSON(data['stats']);
        }
        // ensure the json data is a string
 ...
 * @member {String} name
 */
InlineObject12Meta.prototype['name'] = undefined;

/**
 * Document name without the file extension.
 * @member {String} display_name
 */
InlineObject12Meta.prototype['display_name'] = undefined;

/**
 * Document encoding
 * @member {String} encoding
 */
InlineObject12Meta.prototype['encoding'] = undefined;

/**
 * Document content type.
 * @member {String} content-type
 */
InlineObject12Meta.prototype['content-type'] = undefined;

/**
 * @member {module:model/InlineObject12MetaStats} stats
 */
InlineObject12Meta.prototype['stats'] = undefined;

/**
 * Document public id, if output=url was used for document storage
 * @member {String} public_id
 */
InlineObject12Meta.prototype['public_id'] = undefined;
...
export default InlineObject12Meta;
