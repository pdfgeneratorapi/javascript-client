...
import GetDocument200ResponseMeta from './GetDocument200ResponseMeta';

/**
 * The GetDocument200Response model module.
 * @module model/GetDocument200Response
 * @version 4.0.8
 */
class GetDocument200Response {
    /**
     * Constructs a new <code>GetDocument200Response</code>.
     * @alias module:model/GetDocument200Response
     */
    constructor() { 
        
        GetDocument200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetDocument200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetDocument200Response} obj Optional instance to populate.
     * @return {module:model/GetDocument200Response} The populated <code>GetDocument200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetDocument200Response();

            if (data.hasOwnProperty('response')) {
                obj['response'] = ApiClient.convertToType(data['response'], 'String');
            }
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = GetDocument200ResponseMeta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetDocument200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetDocument200Response</code>.
     */
    static validateJSON(data) {
        ...
        if (data['meta']) { // data not null
          GetDocument200ResponseMeta.validateJSON(data['meta']);
        }
 ...
 */
GetDocument200Response.prototype['response'] = undefined;

/**
 * @member {module:model/GetDocument200ResponseMeta} meta
 */
GetDocument200Response.prototype['meta'] = undefined;
...
export default GetDocument200Response;
