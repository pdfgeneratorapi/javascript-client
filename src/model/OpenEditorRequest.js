...
import OpenEditorRequestData from './OpenEditorRequestData';
...
class OpenEditorRequest {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = OpenEditorRequestData.constructFromObject(data['data']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
          OpenEditorRequestData.validateJSON(data['data']);
        }
...
export default OpenEditorRequest;
