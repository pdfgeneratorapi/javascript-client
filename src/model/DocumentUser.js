...
class DocumentUser {
    ...
    /**
     * Validates the JSON data with respect to <code>DocumentUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DocumentUser</code>.
     */
 ...
 */
DocumentUser.prototype['first_name'] = undefined;

/**
 * @member {String} last_name
 */
DocumentUser.prototype['last_name'] = undefined;

/**
 * @member {String} email
 */
DocumentUser.prototype['email'] = undefined;

/**
 * National identification code, when provided.
 * @member {String} id_code
 */
DocumentUser.prototype['id_code'] = undefined;

/**
 * IP address captured when the action was performed.
 * @member {String} ip
 */
DocumentUser.prototype['ip'] = undefined;
