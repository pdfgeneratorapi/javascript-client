...
/**
 * The FormFieldsUrl model module.
 * @module model/FormFieldsUrl
 * @version 8.0.26
 */
class FormFieldsUrl {
    /**
     * Constructs a new <code>FormFieldsUrl</code>.
     * @alias module:model/FormFieldsUrl
     * @param file_url {String} Public URL to a PDF document
     */
    constructor(file_url) { 
        
        FormFieldsUrl.initialize(this, file_url);
    }
    ...
    /**
     * Constructs a <code>FormFieldsUrl</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FormFieldsUrl} obj Optional instance to populate.
     * @return {module:model/FormFieldsUrl} The populated <code>FormFieldsUrl</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FormFieldsUrl();
    ...
    /**
     * Validates the JSON data with respect to <code>FormFieldsUrl</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FormFieldsUrl</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FormFieldsUrl.RequiredProperties) {
...
FormFieldsUrl.RequiredProperties = ["file_url"];

/**
 * Public URL to a PDF document
 * @member {String} file_url
 */
FormFieldsUrl.prototype['file_url'] = undefined;

/**
 * @member {module:model/KeyFieldParam} key_field
 */
FormFieldsUrl.prototype['key_field'] = undefined;
