...
/**
 * The GetTemplates500Response model module.
 * @module model/GetTemplates500Response
 * @version 3.1.1
 */
class GetTemplates500Response {
    /**
     * Constructs a new <code>GetTemplates500Response</code>.
     * @alias module:model/GetTemplates500Response
     */
    constructor() { 
        
        GetTemplates500Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetTemplates500Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetTemplates500Response} obj Optional instance to populate.
     * @return {module:model/GetTemplates500Response} The populated <code>GetTemplates500Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetTemplates500Response();
    ...
    /**
     * Validates the JSON data with respect to <code>GetTemplates500Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTemplates500Response</code>.
     */
 ...
 * @member {String} error
 */
GetTemplates500Response.prototype['error'] = undefined;

/**
 * HTTP Error code
 * @member {Number} status
 */
GetTemplates500Response.prototype['status'] = undefined;
...
export default GetTemplates500Response;
