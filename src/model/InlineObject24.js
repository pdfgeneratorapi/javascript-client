...
class InlineObject24 {
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObject24</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObject24</code>.
     */
...
/**
 * Error description
 * @member {module:model/InlineObject24.MessageEnum} message
 */
InlineObject24.prototype['message'] = undefined;
