...
class InlineObject5 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('response')) {
                obj['response'] = ApiClient.convertToType(data['response'], [Workspace]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObject5</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObject5</code>.
     */
...
/**
 * @member {Array.<module:model/Workspace>} response
 */
InlineObject5.prototype['response'] = undefined;
