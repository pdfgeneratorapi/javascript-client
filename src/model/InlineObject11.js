...
import InlineObject11Meta from './InlineObject11Meta';
...
class InlineObject11 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = InlineObject11Meta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObject11</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObject11</code>.
     */
    static validateJSON(data) {
        ...
        if (data['meta']) { // data not null
          InlineObject11Meta.validateJSON(data['meta']);
        }
 ...
 */
InlineObject11.prototype['response'] = undefined;

/**
 * @member {module:model/InlineObject11Meta} meta
 */
