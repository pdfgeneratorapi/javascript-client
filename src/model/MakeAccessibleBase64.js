...
class MakeAccessibleBase64 {
    /**
     * Constructs a new <code>MakeAccessibleBase64</code>.
     * @alias module:model/MakeAccessibleBase64
     * @param file_base64 {String} PDF document in base64 encoded string format
     */
    constructor(file_base64) { 
        
        MakeAccessibleBase64.initialize(this, file_base64);
    }
     ...
     */
    static initialize(obj, file_base64) { 
        obj['file_base64'] = file_base64;
        obj['output'] = 'base64';
    }

    /**
     * Constructs a <code>MakeAccessibleBase64</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MakeAccessibleBase64} obj Optional instance to populate.
     * @return {module:model/MakeAccessibleBase64} The populated <code>MakeAccessibleBase64</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MakeAccessibleBase64();

            if (data.hasOwnProperty('file_base64')) {
                obj['file_base64'] = ApiClient.convertToType(data['file_base64'], 'String');
            }
            if (data.hasOwnProperty('options')) {
                obj['options'] = ApiClient.convertToType(data['options'], [AccessibilityOption]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>MakeAccessibleBase64</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MakeAccessibleBase64</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MakeAccessibleBase64.RequiredProperties) {
...
MakeAccessibleBase64.RequiredProperties = ["file_base64"];

/**
 * PDF document in base64 encoded string format
 * @member {String} file_base64
 */
MakeAccessibleBase64.prototype['file_base64'] = undefined;

/**
 * Accessibility processing options
 * @member {Array.<module:model/AccessibilityOption>} options
 */
MakeAccessibleBase64.prototype['options'] = undefined;

/**
 * Name for the PDF file
 * @member {String} name
 */
MakeAccessibleBase64.prototype['name'] = undefined;

/**
 * Returned document output format
 * @member {module:model/MakeAccessibleBase64.OutputEnum} output
 * @default 'base64'
 */
MakeAccessibleBase64.prototype['output'] = 'base64';

/**
 * @member {module:model/MetadataParam} metadata
 */
MakeAccessibleBase64.prototype['metadata'] = undefined;
 ...
 * @readonly
 */
MakeAccessibleBase64['OutputEnum'] = {
...
export default MakeAccessibleBase64;
