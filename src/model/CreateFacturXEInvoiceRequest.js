...
import CreateFacturXEInvoiceRequestTemplate from './CreateFacturXEInvoiceRequestTemplate';
...
class CreateFacturXEInvoiceRequest {
    /**
     * Constructs a new <code>CreateFacturXEInvoiceRequest</code>.
     * @alias module:model/CreateFacturXEInvoiceRequest
     * @param template {module:model/CreateFacturXEInvoiceRequestTemplate} 
     */
    constructor(template) { 
        
        CreateFacturXEInvoiceRequest.initialize(this, template);
    }
    ...
    /**
     * Constructs a <code>CreateFacturXEInvoiceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFacturXEInvoiceRequest} obj Optional instance to populate.
     * @return {module:model/CreateFacturXEInvoiceRequest} The populated <code>CreateFacturXEInvoiceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFacturXEInvoiceRequest();

            if (data.hasOwnProperty('template')) {
                obj['template'] = CreateFacturXEInvoiceRequestTemplate.constructFromObject(data['template']);
            }
            if (data.hasOwnProperty('profile')) {
                obj['profile'] = ApiClient.convertToType(data['profile'], 'String');
            }
            if (data.hasOwnProperty('output')) {
                obj['output'] = OutputParam.constructFromObject(data['output']);
            }
            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('metadata')) {
                obj['metadata'] = MetadataParam.constructFromObject(data['metadata']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFacturXEInvoiceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFacturXEInvoiceRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateFacturXEInvoiceRequest.RequiredProperties) {
        ...
        if (data['template']) { // data not null
          CreateFacturXEInvoiceRequestTemplate.validateJSON(data['template']);
        }
        ...
        if (data['metadata']) { // data not null
          MetadataParam.validateJSON(data['metadata']);
        }
...
CreateFacturXEInvoiceRequest.RequiredProperties = ["template"];

/**
 * @member {module:model/CreateFacturXEInvoiceRequestTemplate} template
 */
CreateFacturXEInvoiceRequest.prototype['template'] = undefined;

/**
 * Factur-X conformance level.
 * @member {module:model/CreateFacturXEInvoiceRequest.ProfileEnum} profile
 * @default 'basic'
 */
CreateFacturXEInvoiceRequest.prototype['profile'] = 'basic';

/**
 * @member {module:model/OutputParam} output
 */
CreateFacturXEInvoiceRequest.prototype['output'] = undefined;
 ...
 * @default ''
 */
CreateFacturXEInvoiceRequest.prototype['name'] = '';

/**
 * @member {module:model/MetadataParam} metadata
 */
CreateFacturXEInvoiceRequest.prototype['metadata'] = undefined;
 ...
 * @readonly
 */
CreateFacturXEInvoiceRequest['ProfileEnum'] = {
...
export default CreateFacturXEInvoiceRequest;
