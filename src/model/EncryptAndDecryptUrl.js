...
class EncryptAndDecryptUrl {
    /**
     * Constructs a new <code>EncryptAndDecryptUrl</code>.
     * @alias module:model/EncryptAndDecryptUrl
     * @param file_url {String} Public URL to a PDF document
     * @param owner_password {String} An owner password to open the encrypted document
     */
    constructor(file_url, owner_password) { 
        
        EncryptAndDecryptUrl.initialize(this, file_url, owner_password);
    }
     ...
     */
    static initialize(obj, file_url, owner_password) { 
    ...
    /**
     * Constructs a <code>EncryptAndDecryptUrl</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/EncryptAndDecryptUrl} obj Optional instance to populate.
     * @return {module:model/EncryptAndDecryptUrl} The populated <code>EncryptAndDecryptUrl</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new EncryptAndDecryptUrl();
    ...
    /**
     * Validates the JSON data with respect to <code>EncryptAndDecryptUrl</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EncryptAndDecryptUrl</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EncryptAndDecryptUrl.RequiredProperties) {
...
EncryptAndDecryptUrl.RequiredProperties = ["file_url", "owner_password"];

/**
 * Public URL to a PDF document
 * @member {String} file_url
 */
EncryptAndDecryptUrl.prototype['file_url'] = undefined;

/**
 * An owner password to open the encrypted document
 * @member {String} owner_password
 */
EncryptAndDecryptUrl.prototype['owner_password'] = undefined;

/**
 * An user password to open the encrypted document
 * @member {String} user_password
 */
EncryptAndDecryptUrl.prototype['user_password'] = undefined;

/**
 * Name for the PDF file
 * @member {String} name
 */
EncryptAndDecryptUrl.prototype['name'] = undefined;

/**
 * Returned document output format
 * @member {module:model/EncryptAndDecryptUrl.OutputEnum} output
 * @default 'base64'
 */
EncryptAndDecryptUrl.prototype['output'] = 'base64';
 ...
 * @readonly
 */
EncryptAndDecryptUrl['OutputEnum'] = {
...
export default EncryptAndDecryptUrl;
