...
import ValidateTemplate200ResponseResponse from './ValidateTemplate200ResponseResponse';

/**
 * The ValidateTemplate200Response model module.
 * @module model/ValidateTemplate200Response
 * @version 4.0.12
 */
class ValidateTemplate200Response {
    /**
     * Constructs a new <code>ValidateTemplate200Response</code>.
     * @alias module:model/ValidateTemplate200Response
     */
    constructor() { 
        
        ValidateTemplate200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ValidateTemplate200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ValidateTemplate200Response} obj Optional instance to populate.
     * @return {module:model/ValidateTemplate200Response} The populated <code>ValidateTemplate200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ValidateTemplate200Response();

            if (data.hasOwnProperty('response')) {
                obj['response'] = ValidateTemplate200ResponseResponse.constructFromObject(data['response']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ValidateTemplate200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidateTemplate200Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `response`
        if (data['response']) { // data not null
          ValidateTemplate200ResponseResponse.validateJSON(data['response']);
        }
...
/**
 * @member {module:model/ValidateTemplate200ResponseResponse} response
 */
ValidateTemplate200Response.prototype['response'] = undefined;
...
export default ValidateTemplate200Response;
