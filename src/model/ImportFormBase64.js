...
class ImportFormBase64 {
    /**
     * Constructs a new <code>ImportFormBase64</code>.
     * @alias module:model/ImportFormBase64
     * @param file_base64 {String} PDF file from base64 string to import
     */
    constructor(file_base64) { 
        
        ImportFormBase64.initialize(this, file_base64);
    }
    ...
    /**
     * Constructs a <code>ImportFormBase64</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImportFormBase64} obj Optional instance to populate.
     * @return {module:model/ImportFormBase64} The populated <code>ImportFormBase64</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImportFormBase64();

            if (data.hasOwnProperty('file_base64')) {
                obj['file_base64'] = ApiClient.convertToType(data['file_base64'], 'String');
            }
            if (data.hasOwnProperty('form')) {
                obj['form'] = FormConfigurationNew.constructFromObject(data['form']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ImportFormBase64</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImportFormBase64</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ImportFormBase64.RequiredProperties) {
        ...
        if (data['form']) { // data not null
          FormConfigurationNew.validateJSON(data['form']);
        }
...
ImportFormBase64.RequiredProperties = ["file_base64"];

/**
 * PDF file from base64 string to import
 * @member {String} file_base64
 */
ImportFormBase64.prototype['file_base64'] = undefined;

/**
 * @member {module:model/FormConfigurationNew} form
 */
ImportFormBase64.prototype['form'] = undefined;
...
export default ImportFormBase64;
