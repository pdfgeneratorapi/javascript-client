...
class PublicTemplateLibraryItem {
    /**
     * Constructs a new <code>PublicTemplateLibraryItem</code>.
     * @alias module:model/PublicTemplateLibraryItem
     */
    constructor() { 
        
        PublicTemplateLibraryItem.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PublicTemplateLibraryItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PublicTemplateLibraryItem} obj Optional instance to populate.
     * @return {module:model/PublicTemplateLibraryItem} The populated <code>PublicTemplateLibraryItem</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PublicTemplateLibraryItem();
            ...
            if (data.hasOwnProperty('sample_data_url')) {
                obj['sample_data_url'] = ApiClient.convertToType(data['sample_data_url'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PublicTemplateLibraryItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PublicTemplateLibraryItem</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['sample_data_url'] && !(typeof data['sample_data_url'] === 'string' || data['sample_data_url'] instanceof String)) {
            throw new Error("Expected the field `sample_data_url` to be a primitive type in the JSON string but got " + data['sample_data_url']);
        }
...
/**
 * Unique public identifier of the template
 * @member {String} id
 */
PublicTemplateLibraryItem.prototype['id'] = undefined;

/**
 * Template name
 * @member {String} name
 */
PublicTemplateLibraryItem.prototype['name'] = undefined;

/**
 * A list of tags assigned to a public template
 * @member {Array.<String>} tags
 */
PublicTemplateLibraryItem.prototype['tags'] = undefined;

/**
 * URL to the template preview image
 * @member {String} preview_image_url
 */
PublicTemplateLibraryItem.prototype['preview_image_url'] = undefined;

/**
 * URL to the template sample data
 * @member {String} sample_data_url
 */
PublicTemplateLibraryItem.prototype['sample_data_url'] = undefined;
...
export default PublicTemplateLibraryItem;
