...
import AddWatermark201ResponseMeta from './AddWatermark201ResponseMeta';

/**
 * The AddWatermark201Response model module.
 * @module model/AddWatermark201Response
 * @version 4.0.12
 */
class AddWatermark201Response {
    /**
     * Constructs a new <code>AddWatermark201Response</code>.
     * @alias module:model/AddWatermark201Response
     */
    constructor() { 
        
        AddWatermark201Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddWatermark201Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddWatermark201Response} obj Optional instance to populate.
     * @return {module:model/AddWatermark201Response} The populated <code>AddWatermark201Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddWatermark201Response();

            if (data.hasOwnProperty('response')) {
                obj['response'] = ApiClient.convertToType(data['response'], 'String');
            }
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = AddWatermark201ResponseMeta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AddWatermark201Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddWatermark201Response</code>.
     */
    static validateJSON(data) {
        ...
        if (data['meta']) { // data not null
          AddWatermark201ResponseMeta.validateJSON(data['meta']);
        }
 ...
 */
AddWatermark201Response.prototype['response'] = undefined;

/**
 * @member {module:model/AddWatermark201ResponseMeta} meta
 */
AddWatermark201Response.prototype['meta'] = undefined;
...
export default AddWatermark201Response;
