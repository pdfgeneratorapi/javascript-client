...
import GenerateViewerUrl200ResponseMeta from './GenerateViewerUrl200ResponseMeta';

/**
 * The GenerateViewerUrl200Response model module.
 * @module model/GenerateViewerUrl200Response
 * @version 8.0.27
 */
class GenerateViewerUrl200Response {
    /**
     * Constructs a new <code>GenerateViewerUrl200Response</code>.
     * @alias module:model/GenerateViewerUrl200Response
     */
    constructor() { 
        
        GenerateViewerUrl200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GenerateViewerUrl200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateViewerUrl200Response} obj Optional instance to populate.
     * @return {module:model/GenerateViewerUrl200Response} The populated <code>GenerateViewerUrl200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateViewerUrl200Response();

            if (data.hasOwnProperty('response')) {
                obj['response'] = ApiClient.convertToType(data['response'], 'String');
            }
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = GenerateViewerUrl200ResponseMeta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateViewerUrl200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateViewerUrl200Response</code>.
     */
    static validateJSON(data) {
        ...
        if (data['meta']) { // data not null
          GenerateViewerUrl200ResponseMeta.validateJSON(data['meta']);
        }
...
/**
 * Public URL to the PDF viewer.
 * @member {String} response
 */
GenerateViewerUrl200Response.prototype['response'] = undefined;

/**
 * @member {module:model/GenerateViewerUrl200ResponseMeta} meta
 */
GenerateViewerUrl200Response.prototype['meta'] = undefined;
...
export default GenerateViewerUrl200Response;
