...
import TemplateDefinitionDataSettings from './TemplateDefinitionDataSettings';
import TemplateDefinitionEditor from './TemplateDefinitionEditor';
import TemplateDefinitionLayout from './TemplateDefinitionLayout';
...
class TemplateDefinition {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('layout')) {
                obj['layout'] = TemplateDefinitionLayout.constructFromObject(data['layout']);
            }
            if (data.hasOwnProperty('pages')) {
                obj['pages'] = ApiClient.convertToType(data['pages'], [TemplateDefinitionNewPagesInner]);
            }
            if (data.hasOwnProperty('dataSettings')) {
                obj['dataSettings'] = TemplateDefinitionDataSettings.constructFromObject(data['dataSettings']);
            }
            if (data.hasOwnProperty('editor')) {
                obj['editor'] = TemplateDefinitionEditor.constructFromObject(data['editor']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['layout']) { // data not null
          TemplateDefinitionLayout.validateJSON(data['layout']);
        }
        if (data['pages']) { // data not null
            ...
            for (const item of data['pages']) {
                TemplateDefinitionNewPagesInner.validateJsonObject(item);
            };
        }
        // validate the optional field `dataSettings`
        if (data['dataSettings']) { // data not null
          TemplateDefinitionDataSettings.validateJSON(data['dataSettings']);
        }
        // validate the optional field `editor`
        if (data['editor']) { // data not null
          TemplateDefinitionEditor.validateJSON(data['editor']);
        }
