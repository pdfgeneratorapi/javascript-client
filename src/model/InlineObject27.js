...
class InlineObject27 {
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObject27</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObject27</code>.
     */
...
/**
 * Error description
 * @member {module:model/InlineObject27.MessageEnum} message
 */
InlineObject27.prototype['message'] = undefined;
