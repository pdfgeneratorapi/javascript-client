...
class ImportTemplateBase64 {
    /**
     * Constructs a new <code>ImportTemplateBase64</code>.
     * @alias module:model/ImportTemplateBase64
     * @param template {module:model/ImportTemplateUrlTemplate} 
     * @param file_base64 {String} PDF file from base64 string to import
     */
    constructor(template, file_base64) { 
        
        ImportTemplateBase64.initialize(this, template, file_base64);
    }
     ...
     */
    static initialize(obj, template, file_base64) { 
        obj['template'] = template;
        obj['file_base64'] = file_base64;
    }

    /**
     * Constructs a <code>ImportTemplateBase64</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImportTemplateBase64} obj Optional instance to populate.
     * @return {module:model/ImportTemplateBase64} The populated <code>ImportTemplateBase64</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImportTemplateBase64();

            if (data.hasOwnProperty('template')) {
                obj['template'] = ImportTemplateUrlTemplate.constructFromObject(data['template']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ImportTemplateBase64</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImportTemplateBase64</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ImportTemplateBase64.RequiredProperties) {
        ...
        if (data['template']) { // data not null
          ImportTemplateUrlTemplate.validateJSON(data['template']);
        }
...
ImportTemplateBase64.RequiredProperties = ["template", "file_base64"];

/**
 * @member {module:model/ImportTemplateUrlTemplate} template
 */
ImportTemplateBase64.prototype['template'] = undefined;

/**
 * PDF file from base64 string to import
 * @member {String} file_base64
 */
ImportTemplateBase64.prototype['file_base64'] = undefined;
...
export default ImportTemplateBase64;
