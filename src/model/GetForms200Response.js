...
/**
 * The GetForms200Response model module.
 * @module model/GetForms200Response
 * @version 4.0.12
 */
class GetForms200Response {
    /**
     * Constructs a new <code>GetForms200Response</code>.
     * @alias module:model/GetForms200Response
     */
    constructor() { 
        
        GetForms200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetForms200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetForms200Response} obj Optional instance to populate.
     * @return {module:model/GetForms200Response} The populated <code>GetForms200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetForms200Response();

            if (data.hasOwnProperty('response')) {
                obj['response'] = ApiClient.convertToType(data['response'], [FormConfiguration]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetForms200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetForms200Response</code>.
     */
    static validateJSON(data) {
        if (data['response']) { // data not null
            ...
            for (const item of data['response']) {
                FormConfiguration.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/FormConfiguration>} response
 */
GetForms200Response.prototype['response'] = undefined;

/**
 * @member {module:model/PaginationMeta} meta
 */
GetForms200Response.prototype['meta'] = undefined;
...
export default GetForms200Response;
