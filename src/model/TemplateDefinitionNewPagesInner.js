...
import TemplateDefinitionNewPagesInnerMargins from './TemplateDefinitionNewPagesInnerMargins';

/**
 * The TemplateDefinitionNewPagesInner model module.
 * @module model/TemplateDefinitionNewPagesInner
 * @version 8.0.26
 */
class TemplateDefinitionNewPagesInner {
    /**
     * Constructs a new <code>TemplateDefinitionNewPagesInner</code>.
     * @alias module:model/TemplateDefinitionNewPagesInner
     */
    constructor() { 
        
        TemplateDefinitionNewPagesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TemplateDefinitionNewPagesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TemplateDefinitionNewPagesInner} obj Optional instance to populate.
     * @return {module:model/TemplateDefinitionNewPagesInner} The populated <code>TemplateDefinitionNewPagesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TemplateDefinitionNewPagesInner();
            ...
            if (data.hasOwnProperty('margins')) {
                obj['margins'] = TemplateDefinitionNewPagesInnerMargins.constructFromObject(data['margins']);
            }
            if (data.hasOwnProperty('border')) {
                obj['border'] = ApiClient.convertToType(data['border'], 'Boolean');
            }
            ...
            if (data.hasOwnProperty('conditionalFormats')) {
                obj['conditionalFormats'] = ApiClient.convertToType(data['conditionalFormats'], [Object]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>TemplateDefinitionNewPagesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplateDefinitionNewPagesInner</code>.
     */
    static validateJSON(data) {
        // validate the optional field `margins`
        if (data['margins']) { // data not null
          TemplateDefinitionNewPagesInnerMargins.validateJSON(data['margins']);
        }
 ...
 * @member {Number} width
 */
TemplateDefinitionNewPagesInner.prototype['width'] = undefined;

/**
 * Page height in units
 * @member {Number} height
 */
TemplateDefinitionNewPagesInner.prototype['height'] = undefined;

/**
 * @member {module:model/TemplateDefinitionNewPagesInnerMargins} margins
 */
TemplateDefinitionNewPagesInner.prototype['margins'] = undefined;

/**
 * @member {Boolean} border
 * @default false
 */
TemplateDefinitionNewPagesInner.prototype['border'] = false;

/**
 * @member {Array.<Object>} components
 */
TemplateDefinitionNewPagesInner.prototype['components'] = undefined;

/**
 * Defines page specific layout which can differ from the main template layout (e.g page format, margins).
 * @member {Object} layout
 */
TemplateDefinitionNewPagesInner.prototype['layout'] = undefined;

/**
 * @member {Array.<Object>} conditionalFormats
 */
TemplateDefinitionNewPagesInner.prototype['conditionalFormats'] = undefined;

/**
 * Defines background image for the page.
 * @member {String} backgroundImage
 */
TemplateDefinitionNewPagesInner.prototype['backgroundImage'] = undefined;
...
export default TemplateDefinitionNewPagesInner;
