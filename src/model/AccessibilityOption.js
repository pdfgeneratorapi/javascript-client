...
/**
* Enum class AccessibilityOption.
* @enum {}
* @readonly
*/
export default class AccessibilityOption {
    
        /**
         * value: "clear_structure"
         * @const
         */
        ...
        /**
         * value: "add_missing_unicode"
         * @const
         */
        "add_missing_unicode" = "add_missing_unicode";
        ...
        /**
         * value: "set_display_doc_title"
         * @const
         */
        "set_display_doc_title" = "set_display_doc_title";

    
        /**
         * value: "set_pdf_ua_standard"
         * @const
         */
        "set_pdf_ua_standard" = "set_pdf_ua_standard";

    

    /**
    * Returns a <code>AccessibilityOption</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/AccessibilityOption} The enum <code>AccessibilityOption</code> value.
    */
