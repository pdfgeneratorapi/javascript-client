...
import TemplateVersionCollectionMeta from './TemplateVersionCollectionMeta';

/**
 * The TemplateVersionCollection model module.
 * @module model/TemplateVersionCollection
 * @version 4.0.25
 */
class TemplateVersionCollection {
    /**
     * Constructs a new <code>TemplateVersionCollection</code>.
     * @alias module:model/TemplateVersionCollection
     */
    constructor() { 
        
        TemplateVersionCollection.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TemplateVersionCollection</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TemplateVersionCollection} obj Optional instance to populate.
     * @return {module:model/TemplateVersionCollection} The populated <code>TemplateVersionCollection</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TemplateVersionCollection();

            if (data.hasOwnProperty('response')) {
                obj['response'] = ApiClient.convertToType(data['response'], [TemplateVersion]);
            }
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = TemplateVersionCollectionMeta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TemplateVersionCollection</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplateVersionCollection</code>.
     */
    static validateJSON(data) {
        if (data['response']) { // data not null
            ...
            for (const item of data['response']) {
                TemplateVersion.validateJSON(item);
            };
        }
        // validate the optional field `meta`
        if (data['meta']) { // data not null
          TemplateVersionCollectionMeta.validateJSON(data['meta']);
        }
...
/**
 * @member {Array.<module:model/TemplateVersion>} response
 */
TemplateVersionCollection.prototype['response'] = undefined;

/**
 * @member {module:model/TemplateVersionCollectionMeta} meta
 */
TemplateVersionCollection.prototype['meta'] = undefined;
...
export default TemplateVersionCollection;
