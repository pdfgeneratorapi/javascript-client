...
/**
 * The CallbackParam model module.
 * @module model/CallbackParam
 * @version 4.0.1
 */
class CallbackParam {
    /**
     * Constructs a new <code>CallbackParam</code>.
     * Callback URL and optional headers
     * @alias module:model/CallbackParam
     */
    constructor() { 
        
        CallbackParam.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CallbackParam</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CallbackParam} obj Optional instance to populate.
     * @return {module:model/CallbackParam} The populated <code>CallbackParam</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CallbackParam();
    ...
    /**
     * Validates the JSON data with respect to <code>CallbackParam</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CallbackParam</code>.
     */
...
/**
 * Public callback URL that is used to make a POST request when the document is generated.
 * @member {String} url
 */
CallbackParam.prototype['url'] = undefined;

/**
 * A key-value pairs of header values sent with the POST request.
 * @member {Object} headers
 */
CallbackParam.prototype['headers'] = undefined;
