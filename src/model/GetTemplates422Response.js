...
/**
 * The GetTemplates422Response model module.
 * @module model/GetTemplates422Response
 * @version 3.1.1
 */
class GetTemplates422Response {
    /**
     * Constructs a new <code>GetTemplates422Response</code>.
     * @alias module:model/GetTemplates422Response
     */
    constructor() { 
        
        GetTemplates422Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetTemplates422Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetTemplates422Response} obj Optional instance to populate.
     * @return {module:model/GetTemplates422Response} The populated <code>GetTemplates422Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetTemplates422Response();
    ...
    /**
     * Validates the JSON data with respect to <code>GetTemplates422Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTemplates422Response</code>.
     */
...
/**
 * Error description
 * @member {module:model/GetTemplates422Response.ErrorEnum} error
 */
GetTemplates422Response.prototype['error'] = undefined;

/**
 * HTTP Error code
 * @member {Number} status
 */
GetTemplates422Response.prototype['status'] = undefined;
 ...
 * @readonly
 */
GetTemplates422Response['ErrorEnum'] = {
...
export default GetTemplates422Response;
