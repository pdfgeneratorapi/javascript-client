...
/**
 * The InlineObject20Response model module.
 * @module model/InlineObject20Response
 * @version 4.0.25
 */
class InlineObject20Response {
    /**
     * Constructs a new <code>InlineObject20Response</code>.
     * @alias module:model/InlineObject20Response
     */
    constructor() { 
        
        InlineObject20Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineObject20Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineObject20Response} obj Optional instance to populate.
     * @return {module:model/InlineObject20Response} The populated <code>InlineObject20Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineObject20Response();
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObject20Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObject20Response</code>.
     */
 ...
 */
InlineObject20Response.prototype['job_id'] = undefined;
...
export default InlineObject20Response;
