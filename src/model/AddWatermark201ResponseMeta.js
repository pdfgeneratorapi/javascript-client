...
/**
 * The AddWatermark201ResponseMeta model module.
 * @module model/AddWatermark201ResponseMeta
 * @version 4.0.12
 */
class AddWatermark201ResponseMeta {
    /**
     * Constructs a new <code>AddWatermark201ResponseMeta</code>.
     * @alias module:model/AddWatermark201ResponseMeta
     */
    constructor() { 
        
        AddWatermark201ResponseMeta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddWatermark201ResponseMeta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddWatermark201ResponseMeta} obj Optional instance to populate.
     * @return {module:model/AddWatermark201ResponseMeta} The populated <code>AddWatermark201ResponseMeta</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddWatermark201ResponseMeta();
    ...
    /**
     * Validates the JSON data with respect to <code>AddWatermark201ResponseMeta</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddWatermark201ResponseMeta</code>.
     */
 ...
 * @member {String} name
 */
AddWatermark201ResponseMeta.prototype['name'] = undefined;

/**
 * Document name without the file extension.
 * @member {String} display_name
 */
AddWatermark201ResponseMeta.prototype['display_name'] = undefined;

/**
 * Document encoding
 * @member {String} encoding
 */
AddWatermark201ResponseMeta.prototype['encoding'] = undefined;

/**
 * Document content type.
 * @member {String} content-type
 */
AddWatermark201ResponseMeta.prototype['content-type'] = undefined;

/**
 * Document public id, if output=url was used for document storage
 * @member {String} public_id
 */
AddWatermark201ResponseMeta.prototype['public_id'] = undefined;
...
export default AddWatermark201ResponseMeta;
