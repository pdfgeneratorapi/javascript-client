...
class ImportFormUrl {
    /**
     * Constructs a new <code>ImportFormUrl</code>.
     * @alias module:model/ImportFormUrl
     * @param file_url {String} PDF file from remote URL to import
     */
    constructor(file_url) { 
        
        ImportFormUrl.initialize(this, file_url);
    }
    ...
    /**
     * Constructs a <code>ImportFormUrl</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImportFormUrl} obj Optional instance to populate.
     * @return {module:model/ImportFormUrl} The populated <code>ImportFormUrl</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImportFormUrl();
    ...
    /**
     * Validates the JSON data with respect to <code>ImportFormUrl</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImportFormUrl</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ImportFormUrl.RequiredProperties) {
...
ImportFormUrl.RequiredProperties = ["file_url"];

/**
 * PDF file from remote URL to import
 * @member {String} file_url
 */
ImportFormUrl.prototype['file_url'] = undefined;

/**
 * @member {module:model/FormConfigurationNew} form
 */
ImportFormUrl.prototype['form'] = undefined;
