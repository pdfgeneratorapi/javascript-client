...
import InlineObject22Response from './InlineObject22Response';
...
class InlineObject22 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('response')) {
                obj['response'] = InlineObject22Response.constructFromObject(data['response']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObject22</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObject22</code>.
     */
    static validateJSON(data) {
        // validate the optional field `response`
        if (data['response']) { // data not null
          InlineObject22Response.validateJSON(data['response']);
        }
...
/**
 * @member {module:model/InlineObject22Response} response
 */
InlineObject22.prototype['response'] = undefined;
