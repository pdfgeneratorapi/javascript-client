...
/**
 * The GenerateViewerUrlRequest model module.
 * @module model/GenerateViewerUrlRequest
 * @version 8.0.28
 */
class GenerateViewerUrlRequest {
    /**
     * Constructs a new <code>GenerateViewerUrlRequest</code>.
     * @alias module:model/GenerateViewerUrlRequest
     */
    constructor() { 
        
        GenerateViewerUrlRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GenerateViewerUrlRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateViewerUrlRequest} obj Optional instance to populate.
     * @return {module:model/GenerateViewerUrlRequest} The populated <code>GenerateViewerUrlRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateViewerUrlRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateViewerUrlRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateViewerUrlRequest</code>.
     */
 ...
 * @member {module:model/GenerateViewerUrlRequest.OutputEnum} output
 * @default 'url'
 */
GenerateViewerUrlRequest.prototype['output'] = 'url';

/**
 * @member {module:model/PrefillParam} prefill
 */
GenerateViewerUrlRequest.prototype['prefill'] = undefined;
 ...
 * @readonly
 */
GenerateViewerUrlRequest['OutputEnum'] = {
...
export default GenerateViewerUrlRequest;
