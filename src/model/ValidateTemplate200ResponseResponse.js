...
/**
 * The ValidateTemplate200ResponseResponse model module.
 * @module model/ValidateTemplate200ResponseResponse
 * @version 4.0.12
 */
class ValidateTemplate200ResponseResponse {
    /**
     * Constructs a new <code>ValidateTemplate200ResponseResponse</code>.
     * @alias module:model/ValidateTemplate200ResponseResponse
     */
    constructor() { 
        
        ValidateTemplate200ResponseResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ValidateTemplate200ResponseResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ValidateTemplate200ResponseResponse} obj Optional instance to populate.
     * @return {module:model/ValidateTemplate200ResponseResponse} The populated <code>ValidateTemplate200ResponseResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ValidateTemplate200ResponseResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>ValidateTemplate200ResponseResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidateTemplate200ResponseResponse</code>.
     */
...
/**
 * True if template configuration was valid
 * @member {Boolean} valid
 * @default true
 */
ValidateTemplate200ResponseResponse.prototype['valid'] = true;
...
export default ValidateTemplate200ResponseResponse;
