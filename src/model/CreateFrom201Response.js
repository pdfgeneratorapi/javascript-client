...
/**
 * The CreateFrom201Response model module.
 * @module model/CreateFrom201Response
 * @version 4.0.8
 */
class CreateFrom201Response {
    /**
     * Constructs a new <code>CreateFrom201Response</code>.
     * @alias module:model/CreateFrom201Response
     */
    constructor() { 
        
        CreateFrom201Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateFrom201Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFrom201Response} obj Optional instance to populate.
     * @return {module:model/CreateFrom201Response} The populated <code>CreateFrom201Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFrom201Response();

            if (data.hasOwnProperty('response')) {
                obj['response'] = FormConfiguration.constructFromObject(data['response']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFrom201Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFrom201Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `response`
        if (data['response']) { // data not null
          FormConfiguration.validateJSON(data['response']);
        }
...
/**
 * @member {module:model/FormConfiguration} response
 */
CreateFrom201Response.prototype['response'] = undefined;
...
export default CreateFrom201Response;
