...
import TemplateDefinitionNewMargins from './TemplateDefinitionNewMargins';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('margins')) {
                obj['margins'] = TemplateDefinitionNewMargins.constructFromObject(data['margins']);
            }
...
export default TemplateDefinitionNewPages;
