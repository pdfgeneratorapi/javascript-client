...
/**
 * The InlineObject9Meta model module.
 * @module model/InlineObject9Meta
 * @version 8.0.25
 */
class InlineObject9Meta {
    /**
     * Constructs a new <code>InlineObject9Meta</code>.
     * @alias module:model/InlineObject9Meta
     */
    constructor() { 
        
        InlineObject9Meta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineObject9Meta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineObject9Meta} obj Optional instance to populate.
     * @return {module:model/InlineObject9Meta} The populated <code>InlineObject9Meta</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineObject9Meta();
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObject9Meta</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObject9Meta</code>.
     */
 ...
 * @member {String} name
 */
InlineObject9Meta.prototype['name'] = undefined;

/**
 * Document name without the file extension.
 * @member {String} display_name
 */
InlineObject9Meta.prototype['display_name'] = undefined;

/**
 * Document encoding
 * @member {String} encoding
 */
InlineObject9Meta.prototype['encoding'] = undefined;

/**
 * Document content type.
 * @member {String} content-type
 */
InlineObject9Meta.prototype['content-type'] = undefined;

/**
 * Document public id, if output=url was used for document storage
 * @member {String} public_id
 */
InlineObject9Meta.prototype['public_id'] = undefined;
...
export default InlineObject9Meta;
