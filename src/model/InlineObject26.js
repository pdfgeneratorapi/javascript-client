...
class InlineObject26 {
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObject26</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObject26</code>.
     */
...
/**
 * Error description
 * @member {module:model/InlineObject26.MessageEnum} message
 */
InlineObject26.prototype['message'] = undefined;
