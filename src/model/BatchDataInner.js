...
/**
 * The BatchDataInner model module.
 * @module model/BatchDataInner
 * @version 3.1.1
 */
class BatchDataInner {
    /**
     * Constructs a new <code>BatchDataInner</code>.
     * @alias module:model/BatchDataInner
     */
    constructor() { 
        
        BatchDataInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>BatchDataInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BatchDataInner} obj Optional instance to populate.
     * @return {module:model/BatchDataInner} The populated <code>BatchDataInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new BatchDataInner();
    ...
    /**
     * Validates the JSON data with respect to <code>BatchDataInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BatchDataInner</code>.
     */
 ...
 */
BatchDataInner.prototype['template'] = undefined;

/**
 * @member {Object} data
 */
BatchDataInner.prototype['data'] = undefined;
