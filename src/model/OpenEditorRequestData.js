...
/**
 * The OpenEditorRequestData model module.
 * @module model/OpenEditorRequestData
 * @version 4.0.1
 */
class OpenEditorRequestData {
    /**
     * Constructs a new <code>OpenEditorRequestData</code>.
     * Data used to generate the document. This can be an object or array of objects.
     * @alias module:model/OpenEditorRequestData
     * @param {(module:model/Object|module:model/[Object])} instance The actual instance to initialize OpenEditorRequestData.
     */
    constructor(instance = null) {
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `OpenEditorRequestData` with oneOf schemas Object, [Object]. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `OpenEditorRequestData` with oneOf schemas Object, [Object]. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>OpenEditorRequestData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OpenEditorRequestData} obj Optional instance to populate.
     * @return {module:model/OpenEditorRequestData} The populated <code>OpenEditorRequestData</code> instance.
     */
    static constructFromObject(data, obj) {
        return new OpenEditorRequestData(data);
    }

    /**
     * Gets the actaul instance, which can be <code>Object</code>, <code>[Object]</code>.
    ...
    /**
     * Sets the actaul instance, which can be <code>Object</code>, <code>[Object]</code>.
     * @param {(module:model/Object|module:model/[Object])} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = OpenEditorRequestData.constructFromObject(obj).getActualInstance();
    }
     ...
     * @return {module:model/OpenEditorRequestData} An instance of OpenEditorRequestData.
     */
    static fromJSON = function(json_string){
        return OpenEditorRequestData.constructFromObject(JSON.parse(json_string));
    }
}


OpenEditorRequestData.OneOf = ["Object", "[Object]"];

export default OpenEditorRequestData;
