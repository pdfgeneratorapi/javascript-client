...
/**
 * The CopyTemplateRequest model module.
 * @module model/CopyTemplateRequest
 * @version 4.0.4
 */
class CopyTemplateRequest {
    /**
     * Constructs a new <code>CopyTemplateRequest</code>.
     * @alias module:model/CopyTemplateRequest
     */
    constructor() { 
        
        CopyTemplateRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CopyTemplateRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CopyTemplateRequest} obj Optional instance to populate.
     * @return {module:model/CopyTemplateRequest} The populated <code>CopyTemplateRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CopyTemplateRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CopyTemplateRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CopyTemplateRequest</code>.
     */
 ...
 * @member {String} name
 */
CopyTemplateRequest.prototype['name'] = undefined;
...
export default CopyTemplateRequest;
