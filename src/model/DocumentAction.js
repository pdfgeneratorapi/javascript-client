...
/**
 * The DocumentAction model module.
 * @module model/DocumentAction
 * @version 8.0.26
 */
class DocumentAction {
    /**
     * Constructs a new <code>DocumentAction</code>.
     * @alias module:model/DocumentAction
     */
    constructor() { 
        
        DocumentAction.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DocumentAction</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DocumentAction} obj Optional instance to populate.
     * @return {module:model/DocumentAction} The populated <code>DocumentAction</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DocumentAction();

            if (data.hasOwnProperty('action')) {
                obj['action'] = ApiClient.convertToType(data['action'], 'String');
            }
            if (data.hasOwnProperty('person')) {
                obj['person'] = DocumentUser.constructFromObject(data['person']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>DocumentAction</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DocumentAction</code>.
     */
    static validateJSON(data) {
        ...
        if (data['person']) { // data not null
          DocumentUser.validateJSON(data['person']);
        }
        // ensure the json data is a string
...
/**
 * The action performed on the document.
 * @member {module:model/DocumentAction.ActionEnum} action
 */
DocumentAction.prototype['action'] = undefined;

/**
 * @member {module:model/DocumentUser} person
 */
DocumentAction.prototype['person'] = undefined;

/**
 * Action timestamp (Y-m-d H:i:s).
 * @member {String} created_at
 */
DocumentAction.prototype['created_at'] = undefined;
