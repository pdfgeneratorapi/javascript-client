...
import PrefillParam from './PrefillParam';

/**
 * The StoreDocumentRequest model module.
 * @module model/StoreDocumentRequest
 * @version 8.0.27
 */
class StoreDocumentRequest {
    /**
     * Constructs a new <code>StoreDocumentRequest</code>.
     * @alias module:model/StoreDocumentRequest
     */
    constructor() { 
        
        StoreDocumentRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StoreDocumentRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StoreDocumentRequest} obj Optional instance to populate.
     * @return {module:model/StoreDocumentRequest} The populated <code>StoreDocumentRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StoreDocumentRequest();
            ...
            if (data.hasOwnProperty('prefill')) {
                obj['prefill'] = PrefillParam.constructFromObject(data['prefill']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>StoreDocumentRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>StoreDocumentRequest</code>.
     */
    static validateJSON(data) {
        ...
        if (data['prefill']) { // data not null
          PrefillParam.validateJSON(data['prefill']);
        }
        // ensure the json data is a string
 ...
 */
StoreDocumentRequest.prototype['file_base64'] = undefined;

/**
 * Public HTTPS URL to a PDF file. Required if file_base64 is not provided.
 * @member {String} file_url
 */
StoreDocumentRequest.prototype['file_url'] = undefined;

/**
 * @member {module:model/PrefillParam} prefill
 */
StoreDocumentRequest.prototype['prefill'] = undefined;
 ...
 * @default ''
 */
StoreDocumentRequest.prototype['name'] = '';

/**
 * Response format. `url` returns a public URL to the stored document; `viewer` returns a public URL to the PDF viewer.
 * @member {module:model/StoreDocumentRequest.OutputEnum} output
 * @default 'url'
 */
StoreDocumentRequest.prototype['output'] = 'url';
 ...
 * @readonly
 */
StoreDocumentRequest['OutputEnum'] = {
...
export default StoreDocumentRequest;
