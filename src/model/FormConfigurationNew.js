...
import FormConfigurationNewActionsInner from './FormConfigurationNewActionsInner';
import FormFieldsInner from './FormFieldsInner';
...
class FormConfigurationNew {
    /**
     * Constructs a new <code>FormConfigurationNew</code>.
     * @alias module:model/FormConfigurationNew
     */
    constructor() { 
        
        FormConfigurationNew.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FormConfigurationNew</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FormConfigurationNew} obj Optional instance to populate.
     * @return {module:model/FormConfigurationNew} The populated <code>FormConfigurationNew</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FormConfigurationNew();
            ...
            if (data.hasOwnProperty('actions')) {
                obj['actions'] = ApiClient.convertToType(data['actions'], [FormConfigurationNewActionsInner]);
            }
            if (data.hasOwnProperty('fields')) {
                obj['fields'] = ApiClient.convertToType(data['fields'], [FormFieldsInner]);
            }
            if (data.hasOwnProperty('configuration')) {
                obj['configuration'] = FormConfiguration.constructFromObject(data['configuration']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FormConfigurationNew</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FormConfigurationNew</code>.
     */
    static validateJSON(data) {
        ...
        if (data['actions']) { // data not null
            ...
            for (const item of data['actions']) {
                FormConfigurationNewActionsInner.validateJSON(item);
            };
        }
        if (data['fields']) { // data not null
            ...
            for (const item of data['fields']) {
                FormFieldsInner.validateJSON(item);
            };
        }
        // validate the optional field `configuration`
        if (data['configuration']) { // data not null
          FormConfiguration.validateJSON(data['configuration']);
        }
...
/**
 * Template ID which is connected to the form
 * @member {Number} template_id
 */
FormConfigurationNew.prototype['template_id'] = undefined;

/**
 * Form name
 * @member {String} name
 */
FormConfigurationNew.prototype['name'] = undefined;

/**
 * Array of action configurations
 * @member {Array.<module:model/FormConfigurationNewActionsInner>} actions
 */
FormConfigurationNew.prototype['actions'] = undefined;

/**
 * A list of form field objects
 * @member {Array.<module:model/FormFieldsInner>} fields
 */
FormConfigurationNew.prototype['fields'] = undefined;

/**
 * @member {module:model/FormConfiguration} configuration
 */
FormConfigurationNew.prototype['configuration'] = undefined;
...
export default FormConfigurationNew;
