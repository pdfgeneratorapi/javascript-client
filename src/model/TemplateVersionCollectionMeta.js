...
class TemplateVersionCollectionMeta {
    /**
     * Constructs a new <code>TemplateVersionCollectionMeta</code>.
     * @alias module:model/TemplateVersionCollectionMeta
     */
    constructor() { 
        
        TemplateVersionCollectionMeta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TemplateVersionCollectionMeta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TemplateVersionCollectionMeta} obj Optional instance to populate.
     * @return {module:model/TemplateVersionCollectionMeta} The populated <code>TemplateVersionCollectionMeta</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TemplateVersionCollectionMeta();
    ...
    /**
     * Validates the JSON data with respect to <code>TemplateVersionCollectionMeta</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplateVersionCollectionMeta</code>.
     */
 ...
 */
TemplateVersionCollectionMeta.prototype['current_page'] = undefined;

/**
 * @member {Number} per_page
 */
TemplateVersionCollectionMeta.prototype['per_page'] = undefined;

/**
 * @member {Number} last_page
 */
TemplateVersionCollectionMeta.prototype['last_page'] = undefined;
...
export default TemplateVersionCollectionMeta;
