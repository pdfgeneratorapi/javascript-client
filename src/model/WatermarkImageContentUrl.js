...
/**
 * The WatermarkImageContentUrl model module.
 * @module model/WatermarkImageContentUrl
 * @version 4.0.12
 */
class WatermarkImageContentUrl {
    /**
     * Constructs a new <code>WatermarkImageContentUrl</code>.
     * @alias module:model/WatermarkImageContentUrl
     * @param content_url {String} URL to an image
     */
    constructor(content_url) { 
        
        WatermarkImageContentUrl.initialize(this, content_url);
    }
     ...
     */
    static initialize(obj, content_url) { 
    ...
    /**
     * Constructs a <code>WatermarkImageContentUrl</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WatermarkImageContentUrl} obj Optional instance to populate.
     * @return {module:model/WatermarkImageContentUrl} The populated <code>WatermarkImageContentUrl</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WatermarkImageContentUrl();

            if (data.hasOwnProperty('content_url')) {
                obj['content_url'] = ApiClient.convertToType(data['content_url'], 'String');
            }
            if (data.hasOwnProperty('position')) {
                obj['position'] = WatermarkPosition.constructFromObject(data['position']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>WatermarkImageContentUrl</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WatermarkImageContentUrl</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WatermarkImageContentUrl.RequiredProperties) {
...
WatermarkImageContentUrl.RequiredProperties = ["content_url"];

/**
 * URL to an image
 * @member {String} content_url
 */
WatermarkImageContentUrl.prototype['content_url'] = undefined;

/**
 * @member {module:model/WatermarkPosition} position
 */
WatermarkImageContentUrl.prototype['position'] = undefined;
 ...
 * @default 0
 */
WatermarkImageContentUrl.prototype['rotation'] = 0;
 ...
 * @default 1
 */
WatermarkImageContentUrl.prototype['scale'] = 1;
...
export default WatermarkImageContentUrl;
