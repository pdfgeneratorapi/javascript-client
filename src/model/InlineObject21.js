...
import InlineObject21Meta from './InlineObject21Meta';
...
class InlineObject21 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = InlineObject21Meta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['meta']) { // data not null
          InlineObject21Meta.validateJSON(data['meta']);
        }
 ...
 */
InlineObject21.prototype['response'] = undefined;

/**
 * @member {module:model/InlineObject21Meta} meta
 */
