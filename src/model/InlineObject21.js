...
class InlineObject21 {
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObject21</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObject21</code>.
     */
...
/**
 * Error description
 * @member {module:model/InlineObject21.MessageEnum} message
 */
InlineObject21.prototype['message'] = undefined;
