...
class InlineObject25 {
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObject25</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObject25</code>.
     */
...
/**
 * Error description
 * @member {module:model/InlineObject25.MessageEnum} message
 */
InlineObject25.prototype['message'] = undefined;
