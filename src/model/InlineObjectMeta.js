...
class InlineObjectMeta {
    /**
     * Constructs a new <code>InlineObjectMeta</code>.
     * @alias module:model/InlineObjectMeta
     */
    constructor() { 
        
        InlineObjectMeta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineObjectMeta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineObjectMeta} obj Optional instance to populate.
     * @return {module:model/InlineObjectMeta} The populated <code>InlineObjectMeta</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineObjectMeta();
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObjectMeta</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObjectMeta</code>.
     */
 ...
 */
InlineObjectMeta.prototype['encoding'] = undefined;

/**
 * Document content type.
 * @member {String} content-type
 */
InlineObjectMeta.prototype['content-type'] = undefined;
...
export default InlineObjectMeta;
