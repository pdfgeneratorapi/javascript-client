...
/**
 * The CreateFacturXEInvoiceRequestTemplate model module.
 * @module model/CreateFacturXEInvoiceRequestTemplate
 * @version 8.0.26
 */
class CreateFacturXEInvoiceRequestTemplate {
    /**
     * Constructs a new <code>CreateFacturXEInvoiceRequestTemplate</code>.
     * Template id, version, version id and data
     * @alias module:model/CreateFacturXEInvoiceRequestTemplate
     */
    constructor() { 
        
        CreateFacturXEInvoiceRequestTemplate.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CreateFacturXEInvoiceRequestTemplate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateFacturXEInvoiceRequestTemplate} obj Optional instance to populate.
     * @return {module:model/CreateFacturXEInvoiceRequestTemplate} The populated <code>CreateFacturXEInvoiceRequestTemplate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateFacturXEInvoiceRequestTemplate();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFacturXEInvoiceRequestTemplate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFacturXEInvoiceRequestTemplate</code>.
     */
 ...
 * @member {Number} id
 */
CreateFacturXEInvoiceRequestTemplate.prototype['id'] = undefined;

/**
 * Template version ID
 * @member {Number} version_id
 */
CreateFacturXEInvoiceRequestTemplate.prototype['version_id'] = undefined;
 ...
 * @member {Object} data
 */
CreateFacturXEInvoiceRequestTemplate.prototype['data'] = undefined;
...
export default CreateFacturXEInvoiceRequestTemplate;
