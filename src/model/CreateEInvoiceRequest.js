...
class CreateEInvoiceRequest {
    /**
     * Constructs a new <code>CreateEInvoiceRequest</code>.
     * @alias module:model/CreateEInvoiceRequest
     * @param data {Object} JSON payload that represents the Peppol BIS Billing 3.0 UBL Invoice (https://docs.peppol.eu/poacc/billing/3.0/) Use the Get schema endpoint to see the detailed payload structure.
     */
    constructor(data) { 
        
        CreateEInvoiceRequest.initialize(this, data);
    }
    ...
    /**
     * Constructs a <code>CreateEInvoiceRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CreateEInvoiceRequest} obj Optional instance to populate.
     * @return {module:model/CreateEInvoiceRequest} The populated <code>CreateEInvoiceRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateEInvoiceRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>CreateEInvoiceRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateEInvoiceRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateEInvoiceRequest.RequiredProperties) {
...
CreateEInvoiceRequest.RequiredProperties = ["data"];

/**
 * JSON payload that represents the Peppol BIS Billing 3.0 UBL Invoice (https://docs.peppol.eu/poacc/billing/3.0/) Use the Get schema endpoint to see the detailed payload structure.
 * @member {Object} data
 */
CreateEInvoiceRequest.prototype['data'] = undefined;

/**
 * Formatting type.
 * @member {module:model/CreateEInvoiceRequest.TypeEnum} type
 * @default 'UBL'
 */
CreateEInvoiceRequest.prototype['type'] = 'UBL';

/**
 * Response format. When the \"file\" option is used the API returns the file inline.
 * @member {module:model/CreateEInvoiceRequest.OutputEnum} output
 * @default 'base64'
 */
CreateEInvoiceRequest.prototype['output'] = 'base64';
 ...
 * @readonly
 */
CreateEInvoiceRequest['TypeEnum'] = {
 ...
 * @readonly
 */
CreateEInvoiceRequest['OutputEnum'] = {
...
export default CreateEInvoiceRequest;
