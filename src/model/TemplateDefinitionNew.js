...
import TemplateDefinitionNewDataSettings from './TemplateDefinitionNewDataSettings';
import TemplateDefinitionNewEditor from './TemplateDefinitionNewEditor';
import TemplateDefinitionNewLayout from './TemplateDefinitionNewLayout';
import TemplateDefinitionNewPagesInner from './TemplateDefinitionNewPagesInner';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('pages')) {
                obj['pages'] = ApiClient.convertToType(data['pages'], [TemplateDefinitionNewPagesInner]);
            }
            if (data.hasOwnProperty('dataSettings')) {
                obj['dataSettings'] = TemplateDefinitionNewDataSettings.constructFromObject(data['dataSettings']);
            }
            if (data.hasOwnProperty('editor')) {
                obj['editor'] = TemplateDefinitionNewEditor.constructFromObject(data['editor']);
            }
            if (data.hasOwnProperty('fontSubsetting')) {
                obj['fontSubsetting'] = ApiClient.convertToType(data['fontSubsetting'], 'Boolean');
            }
            if (data.hasOwnProperty('barcodeAsImage')) {
                obj['barcodeAsImage'] = ApiClient.convertToType(data['barcodeAsImage'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['pages']) { // data not null
            ...
            for (const item of data['pages']) {
                TemplateDefinitionNewPagesInner.validateJSON(item);
            };
        }
        // validate the optional field `dataSettings`
        if (data['dataSettings']) { // data not null
          TemplateDefinitionNewDataSettings.validateJSON(data['dataSettings']);
        }
        // validate the optional field `editor`
        if (data['editor']) { // data not null
          TemplateDefinitionNewEditor.validateJSON(data['editor']);
        }
