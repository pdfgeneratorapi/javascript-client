...
class WatermarkText {
    /**
     * Constructs a new <code>WatermarkText</code>.
     * @alias module:model/WatermarkText
     * @param content {String} Watermark text
     */
    constructor(content) { 
        
        WatermarkText.initialize(this, content);
    }
    ...
    /**
     * Constructs a <code>WatermarkText</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WatermarkText} obj Optional instance to populate.
     * @return {module:model/WatermarkText} The populated <code>WatermarkText</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WatermarkText();
    ...
    /**
     * Validates the JSON data with respect to <code>WatermarkText</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WatermarkText</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WatermarkText.RequiredProperties) {
...
WatermarkText.RequiredProperties = ["content"];

/**
 * Watermark text
 * @member {String} content
 */
WatermarkText.prototype['content'] = undefined;

/**
 * Watermark text color in hexadecimal format
 * @member {String} color
 * @default '#000000'
 */
WatermarkText.prototype['color'] = '#000000';

/**
 * Watermark text font size in px
 * @member {Number} size
 * @default 48
 */
WatermarkText.prototype['size'] = 48;

/**
 * Watermark text opaxity
 * @member {Number} opacity
 * @default 0.5
 */
WatermarkText.prototype['opacity'] = 0.5;

/**
 * @member {module:model/WatermarkPosition} position
 */
WatermarkText.prototype['position'] = undefined;
 ...
 * @default 0
 */
WatermarkText.prototype['rotation'] = 0;
