...
/**
 * The OptimizeUrl model module.
 * @module model/OptimizeUrl
 * @version 8.0.25
 */
class OptimizeUrl {
    /**
     * Constructs a new <code>OptimizeUrl</code>.
     * @alias module:model/OptimizeUrl
     * @param file_url {String} Public URL to a PDF document
     */
    constructor(file_url) { 
        
        OptimizeUrl.initialize(this, file_url);
    }
    ...
    /**
     * Constructs a <code>OptimizeUrl</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OptimizeUrl} obj Optional instance to populate.
     * @return {module:model/OptimizeUrl} The populated <code>OptimizeUrl</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OptimizeUrl();
    ...
    /**
     * Validates the JSON data with respect to <code>OptimizeUrl</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OptimizeUrl</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of OptimizeUrl.RequiredProperties) {
...
OptimizeUrl.RequiredProperties = ["file_url"];

/**
 * Public URL to a PDF document
 * @member {String} file_url
 */
OptimizeUrl.prototype['file_url'] = undefined;

/**
 * Name for the PDF file
 * @member {String} name
 */
OptimizeUrl.prototype['name'] = undefined;

/**
 * Returned document output format
 * @member {module:model/OptimizeUrl.OutputEnum} output
 * @default 'base64'
 */
OptimizeUrl.prototype['output'] = 'base64';
