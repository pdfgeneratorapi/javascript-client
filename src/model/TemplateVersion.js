...
/**
 * The TemplateVersion model module.
 * @module model/TemplateVersion
 * @version 4.0.25
 */
class TemplateVersion {
    /**
     * Constructs a new <code>TemplateVersion</code>.
     * @alias module:model/TemplateVersion
     */
    constructor() { 
        
        TemplateVersion.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TemplateVersion</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TemplateVersion} obj Optional instance to populate.
     * @return {module:model/TemplateVersion} The populated <code>TemplateVersion</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TemplateVersion();
    ...
    /**
     * Validates the JSON data with respect to <code>TemplateVersion</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplateVersion</code>.
     */
 ...
 * @member {Number} id
 */
TemplateVersion.prototype['id'] = undefined;

/**
 * @member {Number} template_id
 */
TemplateVersion.prototype['template_id'] = undefined;

/**
 * @member {String} template_name
 */
TemplateVersion.prototype['template_name'] = undefined;

/**
 * @member {String} name
 */
TemplateVersion.prototype['name'] = undefined;

/**
 * @member {String} checksum
 */
TemplateVersion.prototype['checksum'] = undefined;

/**
 * @member {Number} user_id
 */
TemplateVersion.prototype['user_id'] = undefined;

/**
 * @member {String} user_name
 */
TemplateVersion.prototype['user_name'] = undefined;

/**
 * @member {Boolean} is_production
 */
TemplateVersion.prototype['is_production'] = undefined;

/**
 * @member {String} created_at
 */
TemplateVersion.prototype['created_at'] = undefined;

/**
 * @member {String} updated_at
 */
TemplateVersion.prototype['updated_at'] = undefined;
