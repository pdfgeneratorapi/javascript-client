...
class FormFillBase64 {
    /**
     * Constructs a new <code>FormFillBase64</code>.
     * @alias module:model/FormFillBase64
     * @param file_base64 {String} PDF document in base64 encoded string format
     * @param data {Object} Form field data to fill in the PDF
     */
    constructor(file_base64, data) { 
        
        FormFillBase64.initialize(this, file_base64, data);
    }
     ...
     */
    static initialize(obj, file_base64, data) { 
    ...
    /**
     * Constructs a <code>FormFillBase64</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FormFillBase64} obj Optional instance to populate.
     * @return {module:model/FormFillBase64} The populated <code>FormFillBase64</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FormFillBase64();
    ...
    /**
     * Validates the JSON data with respect to <code>FormFillBase64</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FormFillBase64</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FormFillBase64.RequiredProperties) {
...
FormFillBase64.RequiredProperties = ["file_base64", "data"];

/**
 * PDF document in base64 encoded string format
 * @member {String} file_base64
 */
FormFillBase64.prototype['file_base64'] = undefined;

/**
 * Form field data to fill in the PDF
 * @member {Object} data
 */
FormFillBase64.prototype['data'] = undefined;

/**
 * Returned document output format
 * @member {module:model/FormFillBase64.OutputEnum} output
 * @default 'base64'
 */
FormFillBase64.prototype['output'] = 'base64';

/**
 * Name for the PDF file
 * @member {String} name
 */
FormFillBase64.prototype['name'] = undefined;
