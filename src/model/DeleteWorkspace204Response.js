...
import DeleteWorkspace204ResponseResponse from './DeleteWorkspace204ResponseResponse';

/**
 * The DeleteWorkspace204Response model module.
 * @module model/DeleteWorkspace204Response
 * @version 4.0.4
 */
class DeleteWorkspace204Response {
    /**
     * Constructs a new <code>DeleteWorkspace204Response</code>.
     * @alias module:model/DeleteWorkspace204Response
     */
    constructor() { 
        
        DeleteWorkspace204Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>DeleteWorkspace204Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DeleteWorkspace204Response} obj Optional instance to populate.
     * @return {module:model/DeleteWorkspace204Response} The populated <code>DeleteWorkspace204Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new DeleteWorkspace204Response();

            if (data.hasOwnProperty('response')) {
                obj['response'] = DeleteWorkspace204ResponseResponse.constructFromObject(data['response']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteWorkspace204Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteWorkspace204Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `response`
        if (data['response']) { // data not null
          DeleteWorkspace204ResponseResponse.validateJSON(data['response']);
        }
...
/**
 * @member {module:model/DeleteWorkspace204ResponseResponse} response
 */
DeleteWorkspace204Response.prototype['response'] = undefined;
...
export default DeleteWorkspace204Response;
