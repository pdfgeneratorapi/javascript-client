...
/**
 * The ExtractFormFields200ResponseResponseValueDefault model module.
 * @module model/ExtractFormFields200ResponseResponseValueDefault
 * @version 4.0.12
 */
class ExtractFormFields200ResponseResponseValueDefault {
    /**
     * Constructs a new <code>ExtractFormFields200ResponseResponseValueDefault</code>.
     * Default field value
     * @alias module:model/ExtractFormFields200ResponseResponseValueDefault
     * @param {(module:model/Boolean|module:model/String|module:model/[String])} instance The actual instance to initialize ExtractFormFields200ResponseResponseValueDefault.
     */
    constructor(instance = null) {
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `ExtractFormFields200ResponseResponseValueDefault` with oneOf schemas Boolean, String, [String]. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `ExtractFormFields200ResponseResponseValueDefault` with oneOf schemas Boolean, String, [String]. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>ExtractFormFields200ResponseResponseValueDefault</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExtractFormFields200ResponseResponseValueDefault} obj Optional instance to populate.
     * @return {module:model/ExtractFormFields200ResponseResponseValueDefault} The populated <code>ExtractFormFields200ResponseResponseValueDefault</code> instance.
     */
    static constructFromObject(data, obj) {
        return new ExtractFormFields200ResponseResponseValueDefault(data);
    }

    /**
     * Gets the actual instance, which can be <code>Boolean</code>, <code>String</code>, <code>[String]</code>.
     * @return {(module:model/Boolean|module:model/String|module:model/[String])} The actual instance.
     */
    getActualInstance() {
    ...
    /**
     * Sets the actual instance, which can be <code>Boolean</code>, <code>String</code>, <code>[String]</code>.
     * @param {(module:model/Boolean|module:model/String|module:model/[String])} obj The actual instance.
     */
    setActualInstance(obj) {
       this.actualInstance = ExtractFormFields200ResponseResponseValueDefault.constructFromObject(obj).getActualInstance();
    }
     ...
     * @return {module:model/ExtractFormFields200ResponseResponseValueDefault} An instance of ExtractFormFields200ResponseResponseValueDefault.
     */
    static fromJSON = function(json_string){
        return ExtractFormFields200ResponseResponseValueDefault.constructFromObject(JSON.parse(json_string));
    }
}


ExtractFormFields200ResponseResponseValueDefault.OneOf = ["Boolean", "String", "[String]"];

export default ExtractFormFields200ResponseResponseValueDefault;
