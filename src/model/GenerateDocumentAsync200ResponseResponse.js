...
/**
 * The GenerateDocumentAsync200ResponseResponse model module.
 * @module model/GenerateDocumentAsync200ResponseResponse
 * @version 4.0.1
 */
class GenerateDocumentAsync200ResponseResponse {
    /**
     * Constructs a new <code>GenerateDocumentAsync200ResponseResponse</code>.
     * @alias module:model/GenerateDocumentAsync200ResponseResponse
     */
    constructor() { 
        
        GenerateDocumentAsync200ResponseResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GenerateDocumentAsync200ResponseResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateDocumentAsync200ResponseResponse} obj Optional instance to populate.
     * @return {module:model/GenerateDocumentAsync200ResponseResponse} The populated <code>GenerateDocumentAsync200ResponseResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateDocumentAsync200ResponseResponse();
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateDocumentAsync200ResponseResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateDocumentAsync200ResponseResponse</code>.
     */
 ...
 */
GenerateDocumentAsync200ResponseResponse.prototype['job_id'] = undefined;
...
export default GenerateDocumentAsync200ResponseResponse;
