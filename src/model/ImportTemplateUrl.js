...
/**
 * The ImportTemplateUrl model module.
 * @module model/ImportTemplateUrl
 * @version 8.0.25
 */
class ImportTemplateUrl {
    /**
     * Constructs a new <code>ImportTemplateUrl</code>.
     * @alias module:model/ImportTemplateUrl
     * @param template {module:model/ImportTemplateUrlTemplate} 
     * @param file_url {String} PDF file from remote URL to import
     */
    constructor(template, file_url) { 
        
        ImportTemplateUrl.initialize(this, template, file_url);
    }
     ...
     */
    static initialize(obj, template, file_url) { 
        obj['template'] = template;
        obj['file_url'] = file_url;
    }

    /**
     * Constructs a <code>ImportTemplateUrl</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImportTemplateUrl} obj Optional instance to populate.
     * @return {module:model/ImportTemplateUrl} The populated <code>ImportTemplateUrl</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImportTemplateUrl();
    ...
    /**
     * Validates the JSON data with respect to <code>ImportTemplateUrl</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImportTemplateUrl</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ImportTemplateUrl.RequiredProperties) {
...
ImportTemplateUrl.RequiredProperties = ["template", "file_url"];

/**
 * @member {module:model/ImportTemplateUrlTemplate} template
 */
ImportTemplateUrl.prototype['template'] = undefined;

/**
 * PDF file from remote URL to import
 * @member {String} file_url
 */
ImportTemplateUrl.prototype['file_url'] = undefined;
...
export default ImportTemplateUrl;
