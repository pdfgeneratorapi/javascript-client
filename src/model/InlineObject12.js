...
import InlineObject12Meta from './InlineObject12Meta';
...
class InlineObject12 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = InlineObject12Meta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObject12</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObject12</code>.
     */
    static validateJSON(data) {
        ...
        if (data['meta']) { // data not null
          InlineObject12Meta.validateJSON(data['meta']);
        }
 ...
 */
InlineObject12.prototype['response'] = undefined;

/**
 * @member {module:model/InlineObject12Meta} meta
 */
InlineObject12.prototype['meta'] = undefined;
