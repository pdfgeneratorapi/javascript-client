...
/**
 * The OptimizeDocument201ResponseMetaStats model module.
 * @module model/OptimizeDocument201ResponseMetaStats
 * @version 4.0.12
 */
class OptimizeDocument201ResponseMetaStats {
    /**
     * Constructs a new <code>OptimizeDocument201ResponseMetaStats</code>.
     * @alias module:model/OptimizeDocument201ResponseMetaStats
     */
    constructor() { 
        
        OptimizeDocument201ResponseMetaStats.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OptimizeDocument201ResponseMetaStats</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OptimizeDocument201ResponseMetaStats} obj Optional instance to populate.
     * @return {module:model/OptimizeDocument201ResponseMetaStats} The populated <code>OptimizeDocument201ResponseMetaStats</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OptimizeDocument201ResponseMetaStats();

            if (data.hasOwnProperty('original_size')) {
                obj['original_size'] = ApiClient.convertToType(data['original_size'], 'Number');
            }
            if (data.hasOwnProperty('optimized_size')) {
                obj['optimized_size'] = ApiClient.convertToType(data['optimized_size'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>OptimizeDocument201ResponseMetaStats</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OptimizeDocument201ResponseMetaStats</code>.
     */
 ...
 */
OptimizeDocument201ResponseMetaStats.prototype['original_size'] = undefined;

/**
 * Document size after optimization
 * @member {Number} optimized_size
 */
OptimizeDocument201ResponseMetaStats.prototype['optimized_size'] = undefined;
...
export default OptimizeDocument201ResponseMetaStats;
