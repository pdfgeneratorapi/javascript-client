...
/**
 * The InlineObject10Meta model module.
 * @module model/InlineObject10Meta
 * @version 4.0.25
 */
class InlineObject10Meta {
    /**
     * Constructs a new <code>InlineObject10Meta</code>.
     * @alias module:model/InlineObject10Meta
     */
    constructor() { 
        
        InlineObject10Meta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineObject10Meta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineObject10Meta} obj Optional instance to populate.
     * @return {module:model/InlineObject10Meta} The populated <code>InlineObject10Meta</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineObject10Meta();
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObject10Meta</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObject10Meta</code>.
     */
...
/**
 * File name with extension. Auto-generated if not provided in request.
 * @member {String} name
 */
InlineObject10Meta.prototype['name'] = undefined;

/**
 * File name without extension.
 * @member {String} display_name
 */
InlineObject10Meta.prototype['display_name'] = undefined;

/**
 * Encoding of the response data.
 * @member {String} encoding
 */
InlineObject10Meta.prototype['encoding'] = undefined;

/**
 * Image content type.
 * @member {String} content-type
 */
InlineObject10Meta.prototype['content-type'] = undefined;
...
export default InlineObject10Meta;
