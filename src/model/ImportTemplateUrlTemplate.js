...
/**
 * The ImportTemplateUrlTemplate model module.
 * @module model/ImportTemplateUrlTemplate
 * @version 8.0.25
 */
class ImportTemplateUrlTemplate {
    /**
     * Constructs a new <code>ImportTemplateUrlTemplate</code>.
     * @alias module:model/ImportTemplateUrlTemplate
     * @param name {String} Template name
     */
    constructor(name) { 
        
        ImportTemplateUrlTemplate.initialize(this, name);
    }
    ...
    /**
     * Constructs a <code>ImportTemplateUrlTemplate</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ImportTemplateUrlTemplate} obj Optional instance to populate.
     * @return {module:model/ImportTemplateUrlTemplate} The populated <code>ImportTemplateUrlTemplate</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ImportTemplateUrlTemplate();
    ...
    /**
     * Validates the JSON data with respect to <code>ImportTemplateUrlTemplate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ImportTemplateUrlTemplate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ImportTemplateUrlTemplate.RequiredProperties) {
...
ImportTemplateUrlTemplate.RequiredProperties = ["name"];

/**
 * Template name
 * @member {String} name
 */
ImportTemplateUrlTemplate.prototype['name'] = undefined;
...
export default ImportTemplateUrlTemplate;
