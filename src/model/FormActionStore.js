...
/**
 * The FormActionStore model module.
 * @module model/FormActionStore
 * @version 8.0.25
 */
class FormActionStore {
    /**
     * Constructs a new <code>FormActionStore</code>.
     * Key-value pair of action configuration.
     * @alias module:model/FormActionStore
     */
    constructor() { 
        
        FormActionStore.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FormActionStore</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FormActionStore} obj Optional instance to populate.
     * @return {module:model/FormActionStore} The populated <code>FormActionStore</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FormActionStore();

            if (data.hasOwnProperty('store_document')) {
                obj['store_document'] = ApiClient.convertToType(data['store_document'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FormActionStore</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FormActionStore</code>.
     */
...
/**
 * @member {Boolean} store_document
 */
FormActionStore.prototype['store_document'] = undefined;
...
export default FormActionStore;
