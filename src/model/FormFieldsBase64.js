...
class FormFieldsBase64 {
    /**
     * Constructs a new <code>FormFieldsBase64</code>.
     * @alias module:model/FormFieldsBase64
     * @param file_base64 {String} PDF document in base64 encoded string format
     */
    constructor(file_base64) { 
        
        FormFieldsBase64.initialize(this, file_base64);
    }
    ...
    /**
     * Constructs a <code>FormFieldsBase64</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FormFieldsBase64} obj Optional instance to populate.
     * @return {module:model/FormFieldsBase64} The populated <code>FormFieldsBase64</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FormFieldsBase64();

            if (data.hasOwnProperty('file_base64')) {
                obj['file_base64'] = ApiClient.convertToType(data['file_base64'], 'String');
            }
            if (data.hasOwnProperty('key_field')) {
                obj['key_field'] = KeyFieldParam.constructFromObject(data['key_field']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FormFieldsBase64</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FormFieldsBase64</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FormFieldsBase64.RequiredProperties) {
...
FormFieldsBase64.RequiredProperties = ["file_base64"];

/**
 * PDF document in base64 encoded string format
 * @member {String} file_base64
 */
FormFieldsBase64.prototype['file_base64'] = undefined;

/**
 * @member {module:model/KeyFieldParam} key_field
 */
FormFieldsBase64.prototype['key_field'] = undefined;
...
export default FormFieldsBase64;
