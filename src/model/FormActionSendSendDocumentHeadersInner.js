...
/**
 * The FormActionSendSendDocumentHeadersInner model module.
 * @module model/FormActionSendSendDocumentHeadersInner
 * @version 8.0.25
 */
class FormActionSendSendDocumentHeadersInner {
    /**
     * Constructs a new <code>FormActionSendSendDocumentHeadersInner</code>.
     * @alias module:model/FormActionSendSendDocumentHeadersInner
     * @param name {String} Header name
     * @param value {String} Header value
     */
    constructor(name, value) { 
        
        FormActionSendSendDocumentHeadersInner.initialize(this, name, value);
    }
    ...
    /**
     * Constructs a <code>FormActionSendSendDocumentHeadersInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FormActionSendSendDocumentHeadersInner} obj Optional instance to populate.
     * @return {module:model/FormActionSendSendDocumentHeadersInner} The populated <code>FormActionSendSendDocumentHeadersInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FormActionSendSendDocumentHeadersInner();
    ...
    /**
     * Validates the JSON data with respect to <code>FormActionSendSendDocumentHeadersInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FormActionSendSendDocumentHeadersInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FormActionSendSendDocumentHeadersInner.RequiredProperties) {
...
FormActionSendSendDocumentHeadersInner.RequiredProperties = ["name", "value"];

/**
 * Header name
 * @member {String} name
 */
FormActionSendSendDocumentHeadersInner.prototype['name'] = undefined;

/**
 * Header value
 * @member {String} value
 */
FormActionSendSendDocumentHeadersInner.prototype['value'] = undefined;
...
export default FormActionSendSendDocumentHeadersInner;
