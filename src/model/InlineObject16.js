...
class InlineObject16 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('response')) {
                obj['response'] = ApiClient.convertToType(data['response'], [DocumentVersion]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObject16</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObject16</code>.
     */
    static validateJSON(data) {
        if (data['response']) { // data not null
            ...
            for (const item of data['response']) {
                DocumentVersion.validateJSON(item);
            };
        }
...
/**
 * @member {Array.<module:model/DocumentVersion>} response
 */
InlineObject16.prototype['response'] = undefined;
