...
class PromoteTemplateVersion200Response {
    /**
     * Constructs a new <code>PromoteTemplateVersion200Response</code>.
     * @alias module:model/PromoteTemplateVersion200Response
     */
    constructor() { 
        
        PromoteTemplateVersion200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PromoteTemplateVersion200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PromoteTemplateVersion200Response} obj Optional instance to populate.
     * @return {module:model/PromoteTemplateVersion200Response} The populated <code>PromoteTemplateVersion200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PromoteTemplateVersion200Response();

            if (data.hasOwnProperty('response')) {
                obj['response'] = TemplateVersion.constructFromObject(data['response']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PromoteTemplateVersion200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PromoteTemplateVersion200Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `response`
        if (data['response']) { // data not null
          TemplateVersion.validateJSON(data['response']);
        }
...
/**
 * @member {module:model/TemplateVersion} response
 */
PromoteTemplateVersion200Response.prototype['response'] = undefined;
...
export default PromoteTemplateVersion200Response;
