...
/**
 * The PrefillParam model module.
 * @module model/PrefillParam
 * @version 8.0.29
 */
class PrefillParam {
    /**
     * Constructs a new <code>PrefillParam</code>.
     * Viewer prefill data, encrypted into the viewer URL. Only applied when &#x60;output&#x60; is &#x60;viewer&#x60;.
     * @alias module:model/PrefillParam
     */
    constructor() { 
        
        PrefillParam.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PrefillParam</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PrefillParam} obj Optional instance to populate.
     * @return {module:model/PrefillParam} The populated <code>PrefillParam</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PrefillParam();
            ...
            if (data.hasOwnProperty('signature_id')) {
                obj['signature_id'] = ApiClient.convertToType(data['signature_id'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PrefillParam</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PrefillParam</code>.
     */
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['signature_id'] && !(typeof data['signature_id'] === 'string' || data['signature_id'] instanceof String)) {
            throw new Error("Expected the field `signature_id` to be a primitive type in the JSON string but got " + data['signature_id']);
        }
 ...
 */
PrefillParam.prototype['id_code'] = undefined;

/**
 * @member {String} first_name
 */
PrefillParam.prototype['first_name'] = undefined;

/**
 * @member {String} last_name
 */
PrefillParam.prototype['last_name'] = undefined;

/**
 * @member {String} email
 */
PrefillParam.prototype['email'] = undefined;

/**
 * @member {String} signature_id
 */
PrefillParam.prototype['signature_id'] = undefined;

/**
 * @member {Boolean} editable
 * @default true
 */
PrefillParam.prototype['editable'] = true;
