...
/**
 * The GenerateDocumentAsyncRequest model module.
 * @module model/GenerateDocumentAsyncRequest
 * @version 4.0.1
 */
class GenerateDocumentAsyncRequest {
    /**
     * Constructs a new <code>GenerateDocumentAsyncRequest</code>.
     * @alias module:model/GenerateDocumentAsyncRequest
     */
    constructor() { 
        
        GenerateDocumentAsyncRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GenerateDocumentAsyncRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateDocumentAsyncRequest} obj Optional instance to populate.
     * @return {module:model/GenerateDocumentAsyncRequest} The populated <code>GenerateDocumentAsyncRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateDocumentAsyncRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateDocumentAsyncRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateDocumentAsyncRequest</code>.
     */
 ...
 */
GenerateDocumentAsyncRequest.prototype['template'] = undefined;

/**
 * @member {module:model/CallbackParam} callback
 */
GenerateDocumentAsyncRequest.prototype['callback'] = undefined;

/**
 * @member {module:model/FormatParam} format
 */
GenerateDocumentAsyncRequest.prototype['format'] = undefined;

/**
 * @member {module:model/AsyncOutputParam} output
 */
GenerateDocumentAsyncRequest.prototype['output'] = undefined;
 ...
 * @default ''
 */
GenerateDocumentAsyncRequest.prototype['name'] = '';
...
export default GenerateDocumentAsyncRequest;
