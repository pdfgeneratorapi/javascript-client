...
/**
 * The GenerateQRCode201ResponseMeta model module.
 * @module model/GenerateQRCode201ResponseMeta
 * @version 4.0.25
 */
class GenerateQRCode201ResponseMeta {
    /**
     * Constructs a new <code>GenerateQRCode201ResponseMeta</code>.
     * @alias module:model/GenerateQRCode201ResponseMeta
     */
    constructor() { 
        
        GenerateQRCode201ResponseMeta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GenerateQRCode201ResponseMeta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateQRCode201ResponseMeta} obj Optional instance to populate.
     * @return {module:model/GenerateQRCode201ResponseMeta} The populated <code>GenerateQRCode201ResponseMeta</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateQRCode201ResponseMeta();
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateQRCode201ResponseMeta</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateQRCode201ResponseMeta</code>.
     */
 ...
 */
GenerateQRCode201ResponseMeta.prototype['encoding'] = undefined;

/**
 * Response content type.
 * @member {String} content-type
 */
GenerateQRCode201ResponseMeta.prototype['content-type'] = undefined;
...
export default GenerateQRCode201ResponseMeta;
