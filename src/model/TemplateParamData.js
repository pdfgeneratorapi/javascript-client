...
class TemplateParamData {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `TemplateParamData` with oneOf schemas Object, [Object]. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/TemplateParamData} An instance of TemplateParamData.
     */
...
export default TemplateParamData;
