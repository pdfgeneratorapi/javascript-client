...
import InlineObject18Meta from './InlineObject18Meta';
...
class InlineObject18 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = InlineObject18Meta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObject18</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObject18</code>.
     */
    static validateJSON(data) {
        ...
        if (data['meta']) { // data not null
          InlineObject18Meta.validateJSON(data['meta']);
        }
 ...
 */
InlineObject18.prototype['response'] = undefined;

/**
 * @member {module:model/InlineObject18Meta} meta
 */
