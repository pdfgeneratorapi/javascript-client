...
/**
 * The GetTemplates200Response model module.
 * @module model/GetTemplates200Response
 * @version 4.0.4
 */
class GetTemplates200Response {
    /**
     * Constructs a new <code>GetTemplates200Response</code>.
     * @alias module:model/GetTemplates200Response
     */
    constructor() { 
        
        GetTemplates200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetTemplates200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetTemplates200Response} obj Optional instance to populate.
     * @return {module:model/GetTemplates200Response} The populated <code>GetTemplates200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetTemplates200Response();

            if (data.hasOwnProperty('response')) {
                obj['response'] = ApiClient.convertToType(data['response'], [Template]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>GetTemplates200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTemplates200Response</code>.
     */
...
/**
 * @member {Array.<module:model/Template>} response
 */
GetTemplates200Response.prototype['response'] = undefined;

/**
 * @member {module:model/PaginationMeta} meta
 */
GetTemplates200Response.prototype['meta'] = undefined;
...
export default GetTemplates200Response;
