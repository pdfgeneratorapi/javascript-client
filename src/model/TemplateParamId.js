...
/**
 * The TemplateParamId model module.
 * @module model/TemplateParamId
 * @version 4.0.25
 */
class TemplateParamId {
    /**
     * Constructs a new <code>TemplateParamId</code>.
     * Template ID or Public template ID
     * @alias module:model/TemplateParamId
     * @param {(module:model/Number|module:model/String)} instance The actual instance to initialize TemplateParamId.
     */
    constructor(instance = null) {
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `TemplateParamId` with oneOf schemas Number, String. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `TemplateParamId` with oneOf schemas Number, String. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>TemplateParamId</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TemplateParamId} obj Optional instance to populate.
     * @return {module:model/TemplateParamId} The populated <code>TemplateParamId</code> instance.
     */
    static constructFromObject(data, obj) {
        return new TemplateParamId(data);
    }
    ...
    setActualInstance(obj) {
       this.actualInstance = TemplateParamId.constructFromObject(obj).getActualInstance();
    }
     ...
     * @return {module:model/TemplateParamId} An instance of TemplateParamId.
     */
    static fromJSON = function(json_string){
        return TemplateParamId.constructFromObject(JSON.parse(json_string));
    }
}


TemplateParamId.OneOf = ["Number", "String"];

export default TemplateParamId;
