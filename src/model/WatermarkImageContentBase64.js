...
class WatermarkImageContentBase64 {
    /**
     * Constructs a new <code>WatermarkImageContentBase64</code>.
     * @alias module:model/WatermarkImageContentBase64
     * @param content_base64 {String} Base64 image string
     */
    constructor(content_base64) { 
        
        WatermarkImageContentBase64.initialize(this, content_base64);
    }
     ...
     */
    static initialize(obj, content_base64) { 
    ...
    /**
     * Constructs a <code>WatermarkImageContentBase64</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WatermarkImageContentBase64} obj Optional instance to populate.
     * @return {module:model/WatermarkImageContentBase64} The populated <code>WatermarkImageContentBase64</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WatermarkImageContentBase64();
    ...
    /**
     * Validates the JSON data with respect to <code>WatermarkImageContentBase64</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WatermarkImageContentBase64</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WatermarkImageContentBase64.RequiredProperties) {
...
WatermarkImageContentBase64.RequiredProperties = ["content_base64"];

/**
 * Base64 image string
 * @member {String} content_base64
 */
WatermarkImageContentBase64.prototype['content_base64'] = undefined;

/**
 * @member {module:model/WatermarkPosition} position
 */
WatermarkImageContentBase64.prototype['position'] = undefined;
 ...
 * @default 0
 */
WatermarkImageContentBase64.prototype['rotation'] = 0;
 ...
 * @default 1
 */
WatermarkImageContentBase64.prototype['scale'] = 1;
...
export default WatermarkImageContentBase64;
