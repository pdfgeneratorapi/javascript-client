...
class FormConfiguration {
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['intro'] && !(typeof data['intro'] === 'string' || data['intro'] instanceof String)) {
            throw new Error("Expected the field `intro` to be a primitive type in the JSON string but got " + data['intro']);
        }
        // ensure the json data is a string
 ...
 * @member {String} title
 */
FormConfiguration.prototype['title'] = undefined;

/**
 * Introductory text displayed above the form fields. Supports rich text.
 * @member {String} intro
 */
FormConfiguration.prototype['intro'] = undefined;

/**
 * Closing text displayed below the form fields. Supports rich text.
 * @member {String} outro
 */
FormConfiguration.prototype['outro'] = undefined;
