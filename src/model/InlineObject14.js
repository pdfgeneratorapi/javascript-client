...
import InlineObject14ResponseValue from './InlineObject14ResponseValue';
...
class InlineObject14 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('response')) {
                obj['response'] = ApiClient.convertToType(data['response'], {'String': InlineObject14ResponseValue});
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObject14</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObject14</code>.
     */
 ...
 * @member {Object.<String, module:model/InlineObject14ResponseValue>} response
 */
InlineObject14.prototype['response'] = undefined;
