...
/**
 * The InlineObject23Response model module.
 * @module model/InlineObject23Response
 * @version 8.0.29
 */
class InlineObject23Response {
    /**
     * Constructs a new <code>InlineObject23Response</code>.
     * @alias module:model/InlineObject23Response
     */
    constructor() { 
        
        InlineObject23Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineObject23Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineObject23Response} obj Optional instance to populate.
     * @return {module:model/InlineObject23Response} The populated <code>InlineObject23Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineObject23Response();
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObject23Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObject23Response</code>.
     */
 ...
 */
InlineObject23Response.prototype['job_id'] = undefined;
...
export default InlineObject23Response;
