...
import InlineObject1Response from './InlineObject1Response';
...
class InlineObject1 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('response')) {
                obj['response'] = InlineObject1Response.constructFromObject(data['response']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObject1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObject1</code>.
     */
    static validateJSON(data) {
        // validate the optional field `response`
        if (data['response']) { // data not null
          InlineObject1Response.validateJSON(data['response']);
        }
...
/**
 * @member {module:model/InlineObject1Response} response
 */
InlineObject1.prototype['response'] = undefined;
