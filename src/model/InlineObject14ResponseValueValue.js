...
/**
 * The InlineObject14ResponseValueValue model module.
 * @module model/InlineObject14ResponseValueValue
 * @version 8.0.26
 */
class InlineObject14ResponseValueValue {
    /**
     * Constructs a new <code>InlineObject14ResponseValueValue</code>.
     * Current field value
     * @alias module:model/InlineObject14ResponseValueValue
     * @param {(module:model/Boolean|module:model/String|module:model/[String])} instance The actual instance to initialize InlineObject14ResponseValueValue.
     */
    constructor(instance = null) {
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `InlineObject14ResponseValueValue` with oneOf schemas Boolean, String, [String]. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `InlineObject14ResponseValueValue` with oneOf schemas Boolean, String, [String]. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>InlineObject14ResponseValueValue</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineObject14ResponseValueValue} obj Optional instance to populate.
     * @return {module:model/InlineObject14ResponseValueValue} The populated <code>InlineObject14ResponseValueValue</code> instance.
     */
    static constructFromObject(data, obj) {
        return new InlineObject14ResponseValueValue(data);
    }
    ...
    setActualInstance(obj) {
       this.actualInstance = InlineObject14ResponseValueValue.constructFromObject(obj).getActualInstance();
    }
     ...
     * @return {module:model/InlineObject14ResponseValueValue} An instance of InlineObject14ResponseValueValue.
     */
    static fromJSON = function(json_string){
        return InlineObject14ResponseValueValue.constructFromObject(JSON.parse(json_string));
    }
}


InlineObject14ResponseValueValue.OneOf = ["Boolean", "String", "[String]"];

export default InlineObject14ResponseValueValue;
