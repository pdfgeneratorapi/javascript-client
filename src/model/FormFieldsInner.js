...
/**
 * The FormFieldsInner model module.
 * @module model/FormFieldsInner
 * @version 4.0.8
 */
class FormFieldsInner {
    /**
     * Constructs a new <code>FormFieldsInner</code>.
     * Form field definition
     * @alias module:model/FormFieldsInner
     */
    constructor() { 
        
        FormFieldsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>FormFieldsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FormFieldsInner} obj Optional instance to populate.
     * @return {module:model/FormFieldsInner} The populated <code>FormFieldsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FormFieldsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>FormFieldsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FormFieldsInner</code>.
     */
 ...
 * @member {String} label
 */
FormFieldsInner.prototype['label'] = undefined;

/**
 * Data field name. For example \"name\" can be used as \"{name}\" in the document as placeholder.
 * @member {String} name
 */
FormFieldsInner.prototype['name'] = undefined;

/**
 * Field type
 * @member {module:model/FormFieldsInner.TypeEnum} type
 */
FormFieldsInner.prototype['type'] = undefined;

/**
 * Specifies if the field is required or not
 * @member {Boolean} required
 */
FormFieldsInner.prototype['required'] = undefined;
...
export default FormFieldsInner;
