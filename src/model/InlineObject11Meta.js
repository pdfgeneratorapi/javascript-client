...
/**
 * The InlineObject11Meta model module.
 * @module model/InlineObject11Meta
 * @version 4.0.25
 */
class InlineObject11Meta {
    /**
     * Constructs a new <code>InlineObject11Meta</code>.
     * @alias module:model/InlineObject11Meta
     */
    constructor() { 
        
        InlineObject11Meta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineObject11Meta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineObject11Meta} obj Optional instance to populate.
     * @return {module:model/InlineObject11Meta} The populated <code>InlineObject11Meta</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineObject11Meta();
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObject11Meta</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObject11Meta</code>.
     */
 ...
 * @member {String} name
 */
InlineObject11Meta.prototype['name'] = undefined;

/**
 * Document name without the file extension.
 * @member {String} display_name
 */
InlineObject11Meta.prototype['display_name'] = undefined;

/**
 * Document encoding
 * @member {String} encoding
 */
InlineObject11Meta.prototype['encoding'] = undefined;

/**
 * Document content type.
 * @member {String} content-type
 */
InlineObject11Meta.prototype['content-type'] = undefined;

/**
 * Document public id
 * @member {String} public_id
 */
InlineObject11Meta.prototype['public_id'] = undefined;
...
export default InlineObject11Meta;
