...
class MakeAccessibleUrl {
    /**
     * Constructs a new <code>MakeAccessibleUrl</code>.
     * @alias module:model/MakeAccessibleUrl
     * @param file_url {String} Public URL to a PDF document
     */
    constructor(file_url) { 
        
        MakeAccessibleUrl.initialize(this, file_url);
    }
     ...
     */
    static initialize(obj, file_url) { 
        obj['file_url'] = file_url;
        obj['output'] = 'base64';
    }

    /**
     * Constructs a <code>MakeAccessibleUrl</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MakeAccessibleUrl} obj Optional instance to populate.
     * @return {module:model/MakeAccessibleUrl} The populated <code>MakeAccessibleUrl</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MakeAccessibleUrl();
    ...
    /**
     * Validates the JSON data with respect to <code>MakeAccessibleUrl</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MakeAccessibleUrl</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of MakeAccessibleUrl.RequiredProperties) {
...
MakeAccessibleUrl.RequiredProperties = ["file_url"];

/**
 * Public URL to a PDF document
 * @member {String} file_url
 */
MakeAccessibleUrl.prototype['file_url'] = undefined;

/**
 * Accessibility processing options
 * @member {Array.<module:model/AccessibilityOption>} options
 */
MakeAccessibleUrl.prototype['options'] = undefined;

/**
 * Name for the PDF file
 * @member {String} name
 */
MakeAccessibleUrl.prototype['name'] = undefined;

/**
 * Returned document output format
 * @member {module:model/MakeAccessibleUrl.OutputEnum} output
 * @default 'base64'
 */
MakeAccessibleUrl.prototype['output'] = 'base64';

/**
 * @member {module:model/MetadataParam} metadata
 */
MakeAccessibleUrl.prototype['metadata'] = undefined;
...
export default MakeAccessibleUrl;
