...
import StatusParam from './StatusParam';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('api')) {
                obj['api'] = StatusParam.constructFromObject(data['api']);
            }
            if (data.hasOwnProperty('chart-api')) {
                obj['chart-api'] = StatusParam.constructFromObject(data['chart-api']);
            }
            if (data.hasOwnProperty('conversion-api')) {
                obj['conversion-api'] = StatusParam.constructFromObject(data['conversion-api']);
            }
            if (data.hasOwnProperty('generator-api-sync')) {
                obj['generator-api-sync'] = StatusParam.constructFromObject(data['generator-api-sync']);
            }
            if (data.hasOwnProperty('generator-api-async')) {
                obj['generator-api-async'] = StatusParam.constructFromObject(data['generator-api-async']);
            }
            if (data.hasOwnProperty('e-invoice')) {
                obj['e-invoice'] = StatusParam.constructFromObject(data['e-invoice']);
            }
        }
        return obj;
    }
...
/**
 * @member {module:model/StatusParam} api
 */
GetStatus200Response.prototype['api'] = undefined;

/**
 * @member {module:model/StatusParam} chart-api
 */
GetStatus200Response.prototype['chart-api'] = undefined;

/**
 * @member {module:model/StatusParam} conversion-api
 */
GetStatus200Response.prototype['conversion-api'] = undefined;

/**
 * @member {module:model/StatusParam} generator-api-sync
 */
GetStatus200Response.prototype['generator-api-sync'] = undefined;

/**
 * @member {module:model/StatusParam} generator-api-async
 */
GetStatus200Response.prototype['generator-api-async'] = undefined;

/**
 * @member {module:model/StatusParam} e-invoice
 */
GetStatus200Response.prototype['e-invoice'] = undefined;
