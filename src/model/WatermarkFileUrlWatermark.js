...
class WatermarkFileUrlWatermark {
    /**
     * Constructs a new <code>WatermarkFileUrlWatermark</code>.
     * @alias module:model/WatermarkFileUrlWatermark
     */
    constructor() { 
        
        WatermarkFileUrlWatermark.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WatermarkFileUrlWatermark</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WatermarkFileUrlWatermark} obj Optional instance to populate.
     * @return {module:model/WatermarkFileUrlWatermark} The populated <code>WatermarkFileUrlWatermark</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WatermarkFileUrlWatermark();

            if (data.hasOwnProperty('image')) {
                obj['image'] = WatermarkImage.constructFromObject(data['image']);
            }
            if (data.hasOwnProperty('text')) {
                obj['text'] = WatermarkText.constructFromObject(data['text']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>WatermarkFileUrlWatermark</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WatermarkFileUrlWatermark</code>.
     */
    static validateJSON(data) {
        // validate the optional field `image`
        if (data['image']) { // data not null
          WatermarkImage.validateJSON(data['image']);
        }
        // validate the optional field `text`
        if (data['text']) { // data not null
          WatermarkText.validateJSON(data['text']);
        }
...
/**
 * @member {module:model/WatermarkImage} image
 */
WatermarkFileUrlWatermark.prototype['image'] = undefined;

/**
 * @member {module:model/WatermarkText} text
 */
WatermarkFileUrlWatermark.prototype['text'] = undefined;
...
export default WatermarkFileUrlWatermark;
