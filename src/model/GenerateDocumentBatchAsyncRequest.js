...
/**
 * The GenerateDocumentBatchAsyncRequest model module.
 * @module model/GenerateDocumentBatchAsyncRequest
 * @version 4.0.1
 */
class GenerateDocumentBatchAsyncRequest {
    /**
     * Constructs a new <code>GenerateDocumentBatchAsyncRequest</code>.
     * @alias module:model/GenerateDocumentBatchAsyncRequest
     */
    constructor() { 
        
        GenerateDocumentBatchAsyncRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GenerateDocumentBatchAsyncRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateDocumentBatchAsyncRequest} obj Optional instance to populate.
     * @return {module:model/GenerateDocumentBatchAsyncRequest} The populated <code>GenerateDocumentBatchAsyncRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateDocumentBatchAsyncRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateDocumentBatchAsyncRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateDocumentBatchAsyncRequest</code>.
     */
    static validateJSON(data) {
        if (data['template']) { // data not null
            ...
            for (const item of data['template']) {
                TemplateParam.validateJsonObject(item);
            };
        }
 ...
 */
GenerateDocumentBatchAsyncRequest.prototype['template'] = undefined;

/**
 * @member {module:model/CallbackParam} callback
 */
GenerateDocumentBatchAsyncRequest.prototype['callback'] = undefined;

/**
 * @member {module:model/FormatParam} format
 */
GenerateDocumentBatchAsyncRequest.prototype['format'] = undefined;

/**
 * @member {module:model/AsyncOutputParam} output
 */
GenerateDocumentBatchAsyncRequest.prototype['output'] = undefined;
 ...
 * @default ''
 */
GenerateDocumentBatchAsyncRequest.prototype['name'] = '';
...
export default GenerateDocumentBatchAsyncRequest;
