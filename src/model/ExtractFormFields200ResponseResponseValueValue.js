...
/**
 * The ExtractFormFields200ResponseResponseValueValue model module.
 * @module model/ExtractFormFields200ResponseResponseValueValue
 * @version 4.0.12
 */
class ExtractFormFields200ResponseResponseValueValue {
    /**
     * Constructs a new <code>ExtractFormFields200ResponseResponseValueValue</code>.
     * Current field value
     * @alias module:model/ExtractFormFields200ResponseResponseValueValue
     * @param {(module:model/Boolean|module:model/String|module:model/[String])} instance The actual instance to initialize ExtractFormFields200ResponseResponseValueValue.
     */
    constructor(instance = null) {
        ...
        if (match > 1) {
            throw new Error("Multiple matches found constructing `ExtractFormFields200ResponseResponseValueValue` with oneOf schemas Boolean, String, [String]. Input: " + JSON.stringify(instance));
        } else if (match === 0) {
            this.actualInstance = null; // clear the actual instance in case there are multiple matches
            throw new Error("No match found constructing `ExtractFormFields200ResponseResponseValueValue` with oneOf schemas Boolean, String, [String]. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Constructs a <code>ExtractFormFields200ResponseResponseValueValue</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExtractFormFields200ResponseResponseValueValue} obj Optional instance to populate.
     * @return {module:model/ExtractFormFields200ResponseResponseValueValue} The populated <code>ExtractFormFields200ResponseResponseValueValue</code> instance.
     */
    static constructFromObject(data, obj) {
        return new ExtractFormFields200ResponseResponseValueValue(data);
    }
    ...
    setActualInstance(obj) {
       this.actualInstance = ExtractFormFields200ResponseResponseValueValue.constructFromObject(obj).getActualInstance();
    }
     ...
     * @return {module:model/ExtractFormFields200ResponseResponseValueValue} An instance of ExtractFormFields200ResponseResponseValueValue.
     */
    static fromJSON = function(json_string){
        return ExtractFormFields200ResponseResponseValueValue.constructFromObject(JSON.parse(json_string));
    }
}


ExtractFormFields200ResponseResponseValueValue.OneOf = ["Boolean", "String", "[String]"];

export default ExtractFormFields200ResponseResponseValueValue;
