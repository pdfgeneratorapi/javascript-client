...
import OptimizeDocument201ResponseMetaStats from './OptimizeDocument201ResponseMetaStats';

/**
 * The OptimizeDocument201ResponseMeta model module.
 * @module model/OptimizeDocument201ResponseMeta
 * @version 4.0.12
 */
class OptimizeDocument201ResponseMeta {
    /**
     * Constructs a new <code>OptimizeDocument201ResponseMeta</code>.
     * @alias module:model/OptimizeDocument201ResponseMeta
     */
    constructor() { 
        
        OptimizeDocument201ResponseMeta.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OptimizeDocument201ResponseMeta</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OptimizeDocument201ResponseMeta} obj Optional instance to populate.
     * @return {module:model/OptimizeDocument201ResponseMeta} The populated <code>OptimizeDocument201ResponseMeta</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OptimizeDocument201ResponseMeta();
            ...
            if (data.hasOwnProperty('stats')) {
                obj['stats'] = OptimizeDocument201ResponseMetaStats.constructFromObject(data['stats']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>OptimizeDocument201ResponseMeta</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OptimizeDocument201ResponseMeta</code>.
     */
    static validateJSON(data) {
        ...
        if (data['stats']) { // data not null
          OptimizeDocument201ResponseMetaStats.validateJSON(data['stats']);
        }
        // ensure the json data is a string
 ...
 * @member {String} name
 */
OptimizeDocument201ResponseMeta.prototype['name'] = undefined;

/**
 * Document name without the file extension.
 * @member {String} display_name
 */
OptimizeDocument201ResponseMeta.prototype['display_name'] = undefined;

/**
 * Document encoding
 * @member {String} encoding
 */
OptimizeDocument201ResponseMeta.prototype['encoding'] = undefined;

/**
 * Document content type.
 * @member {String} content-type
 */
OptimizeDocument201ResponseMeta.prototype['content-type'] = undefined;

/**
 * @member {module:model/OptimizeDocument201ResponseMetaStats} stats
 */
OptimizeDocument201ResponseMeta.prototype['stats'] = undefined;

/**
 * Document public id, if output=url was used for document storage
 * @member {String} public_id
 */
OptimizeDocument201ResponseMeta.prototype['public_id'] = undefined;
...
export default OptimizeDocument201ResponseMeta;
