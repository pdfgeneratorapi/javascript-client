...
/**
 * The FormFillUrl model module.
 * @module model/FormFillUrl
 * @version 4.0.25
 */
class FormFillUrl {
    /**
     * Constructs a new <code>FormFillUrl</code>.
     * @alias module:model/FormFillUrl
     * @param file_url {String} Public URL to a PDF document
     * @param data {Object} Form field data to fill in the PDF
     */
    constructor(file_url, data) { 
        
        FormFillUrl.initialize(this, file_url, data);
    }
     ...
     */
    static initialize(obj, file_url, data) { 
    ...
    /**
     * Constructs a <code>FormFillUrl</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FormFillUrl} obj Optional instance to populate.
     * @return {module:model/FormFillUrl} The populated <code>FormFillUrl</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FormFillUrl();
    ...
    /**
     * Validates the JSON data with respect to <code>FormFillUrl</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FormFillUrl</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FormFillUrl.RequiredProperties) {
...
FormFillUrl.RequiredProperties = ["file_url", "data"];

/**
 * Public URL to a PDF document
 * @member {String} file_url
 */
FormFillUrl.prototype['file_url'] = undefined;

/**
 * Form field data to fill in the PDF
 * @member {Object} data
 */
FormFillUrl.prototype['data'] = undefined;

/**
 * Returned document output format
 * @member {module:model/FormFillUrl.OutputEnum} output
 * @default 'base64'
 */
FormFillUrl.prototype['output'] = 'base64';

/**
 * Name for the PDF file
 * @member {String} name
 */
FormFillUrl.prototype['name'] = undefined;
