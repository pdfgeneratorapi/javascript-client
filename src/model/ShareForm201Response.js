...
import ShareForm201ResponseMeta from './ShareForm201ResponseMeta';

/**
 * The ShareForm201Response model module.
 * @module model/ShareForm201Response
 * @version 4.0.8
 */
class ShareForm201Response {
    /**
     * Constructs a new <code>ShareForm201Response</code>.
     * @alias module:model/ShareForm201Response
     */
    constructor() { 
        
        ShareForm201Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ShareForm201Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ShareForm201Response} obj Optional instance to populate.
     * @return {module:model/ShareForm201Response} The populated <code>ShareForm201Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ShareForm201Response();

            if (data.hasOwnProperty('response')) {
                obj['response'] = ApiClient.convertToType(data['response'], 'String');
            }
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = ShareForm201ResponseMeta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ShareForm201Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ShareForm201Response</code>.
     */
    static validateJSON(data) {
        ...
        if (data['meta']) { // data not null
          ShareForm201ResponseMeta.validateJSON(data['meta']);
        }
...
/**
 * Public URL for form data collection
 * @member {String} response
 */
ShareForm201Response.prototype['response'] = undefined;

/**
 * @member {module:model/ShareForm201ResponseMeta} meta
 */
ShareForm201Response.prototype['meta'] = undefined;
...
export default ShareForm201Response;
