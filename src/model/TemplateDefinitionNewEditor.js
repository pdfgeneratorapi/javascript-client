...
/**
 * The TemplateDefinitionNewEditor model module.
 * @module model/TemplateDefinitionNewEditor
 * @version 4.0.4
 */
class TemplateDefinitionNewEditor {
    /**
     * Constructs a new <code>TemplateDefinitionNewEditor</code>.
     * Configuration preferences for the editor
     * @alias module:model/TemplateDefinitionNewEditor
     */
    constructor() { 
        
        TemplateDefinitionNewEditor.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TemplateDefinitionNewEditor</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TemplateDefinitionNewEditor} obj Optional instance to populate.
     * @return {module:model/TemplateDefinitionNewEditor} The populated <code>TemplateDefinitionNewEditor</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TemplateDefinitionNewEditor();

            if (data.hasOwnProperty('heightMultiplier')) {
                obj['heightMultiplier'] = ApiClient.convertToType(data['heightMultiplier'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TemplateDefinitionNewEditor</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TemplateDefinitionNewEditor</code>.
     */
 ...
 */
TemplateDefinitionNewEditor.prototype['heightMultiplier'] = undefined;
...
export default TemplateDefinitionNewEditor;
