...
import FormActionSendSendDocumentHeadersInner from './FormActionSendSendDocumentHeadersInner';
...
class FormActionSendSendDocument {
    /**
     * Constructs a new <code>FormActionSendSendDocument</code>.
     * @alias module:model/FormActionSendSendDocument
     * @param url {String} HTTPS URL where the generated document will be delivered.
     */
    constructor(url) { 
        
        FormActionSendSendDocument.initialize(this, url);
    }
    ...
    /**
     * Constructs a <code>FormActionSendSendDocument</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FormActionSendSendDocument} obj Optional instance to populate.
     * @return {module:model/FormActionSendSendDocument} The populated <code>FormActionSendSendDocument</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new FormActionSendSendDocument();

            if (data.hasOwnProperty('url')) {
                obj['url'] = ApiClient.convertToType(data['url'], 'String');
            }
            if (data.hasOwnProperty('headers')) {
                obj['headers'] = ApiClient.convertToType(data['headers'], [FormActionSendSendDocumentHeadersInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>FormActionSendSendDocument</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>FormActionSendSendDocument</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of FormActionSendSendDocument.RequiredProperties) {
        ...
        if (data['headers']) { // data not null
            ...
            for (const item of data['headers']) {
                FormActionSendSendDocumentHeadersInner.validateJSON(item);
            };
        }
...
FormActionSendSendDocument.RequiredProperties = ["url"];

/**
 * HTTPS URL where the generated document will be delivered.
 * @member {String} url
 */
FormActionSendSendDocument.prototype['url'] = undefined;

/**
 * Optional HTTP headers to include with the delivery request.
 * @member {Array.<module:model/FormActionSendSendDocumentHeadersInner>} headers
 */
FormActionSendSendDocument.prototype['headers'] = undefined;
...
export default FormActionSendSendDocument;
