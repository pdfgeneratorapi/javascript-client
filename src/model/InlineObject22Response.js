...
/**
 * The InlineObject22Response model module.
 * @module model/InlineObject22Response
 * @version 8.0.26
 */
class InlineObject22Response {
    /**
     * Constructs a new <code>InlineObject22Response</code>.
     * @alias module:model/InlineObject22Response
     */
    constructor() { 
        
        InlineObject22Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>InlineObject22Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/InlineObject22Response} obj Optional instance to populate.
     * @return {module:model/InlineObject22Response} The populated <code>InlineObject22Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineObject22Response();
    ...
    /**
     * Validates the JSON data with respect to <code>InlineObject22Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InlineObject22Response</code>.
     */
 ...
 */
InlineObject22Response.prototype['job_id'] = undefined;
...
export default InlineObject22Response;
