...
import InlineObject23Response from './InlineObject23Response';
...
class InlineObject23 {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('response')) {
                obj['response'] = InlineObject23Response.constructFromObject(data['response']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['response']) { // data not null
          InlineObject23Response.validateJSON(data['response']);
        }
...
/**
 * @member {module:model/InlineObject23Response} response
 */
InlineObject23.prototype['response'] = undefined;
