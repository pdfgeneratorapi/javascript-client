...
import GenerateDocument200ResponseMeta from './GenerateDocument200ResponseMeta';

/**
 * The GenerateDocument200Response model module.
 * @module model/GenerateDocument200Response
 * @version 4.0.1
 */
class GenerateDocument200Response {
    /**
     * Constructs a new <code>GenerateDocument200Response</code>.
     * @alias module:model/GenerateDocument200Response
     */
    constructor() { 
        
        GenerateDocument200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GenerateDocument200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GenerateDocument200Response} obj Optional instance to populate.
     * @return {module:model/GenerateDocument200Response} The populated <code>GenerateDocument200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GenerateDocument200Response();

            if (data.hasOwnProperty('response')) {
                obj['response'] = ApiClient.convertToType(data['response'], 'String');
            }
            if (data.hasOwnProperty('meta')) {
                obj['meta'] = GenerateDocument200ResponseMeta.constructFromObject(data['meta']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GenerateDocument200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GenerateDocument200Response</code>.
     */
    static validateJSON(data) {
        ...
        if (data['meta']) { // data not null
          GenerateDocument200ResponseMeta.validateJSON(data['meta']);
        }
 ...
 */
GenerateDocument200Response.prototype['response'] = undefined;

/**
 * @member {module:model/GenerateDocument200ResponseMeta} meta
 */
GenerateDocument200Response.prototype['meta'] = undefined;
...
export default GenerateDocument200Response;
