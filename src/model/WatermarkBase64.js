...
class WatermarkBase64 {
    /**
     * Constructs a new <code>WatermarkBase64</code>.
     * @alias module:model/WatermarkBase64
     * @param file_base64 {String} PDF file from base64 string to add the watermark to
     * @param watermark {module:model/WatermarkFileUrlWatermark} 
     */
    constructor(file_base64, watermark) { 
        
        WatermarkBase64.initialize(this, file_base64, watermark);
    }
     ...
     */
    static initialize(obj, file_base64, watermark) { 
    ...
    /**
     * Constructs a <code>WatermarkBase64</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WatermarkBase64} obj Optional instance to populate.
     * @return {module:model/WatermarkBase64} The populated <code>WatermarkBase64</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WatermarkBase64();
            ...
            if (data.hasOwnProperty('watermark')) {
                obj['watermark'] = WatermarkFileUrlWatermark.constructFromObject(data['watermark']);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>WatermarkBase64</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WatermarkBase64</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WatermarkBase64.RequiredProperties) {
        ...
        if (data['watermark']) { // data not null
          WatermarkFileUrlWatermark.validateJSON(data['watermark']);
        }
        // ensure the json data is a string
...
WatermarkBase64.RequiredProperties = ["file_base64", "watermark"];

/**
 * PDF file from base64 string to add the watermark to
 * @member {String} file_base64
 */
WatermarkBase64.prototype['file_base64'] = undefined;

/**
 * @member {module:model/WatermarkFileUrlWatermark} watermark
 */
WatermarkBase64.prototype['watermark'] = undefined;

/**
 * Returned document output
 * @member {module:model/WatermarkBase64.OutputEnum} output
 * @default 'base64'
 */
WatermarkBase64.prototype['output'] = 'base64';

/**
 * File name of the returned document
 * @member {String} name
 */
WatermarkBase64.prototype['name'] = undefined;
